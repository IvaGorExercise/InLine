...
namespace InLine.Repository.Data
{
    ...
    public partial interface ISubjektTablica
    {
    		...
    		void Delete(Model.Data.Item.SubjektTablicaItem item);
    
    			
    		ObjectResult<int?> DeleteResult(Model.Data.Item.SubjektTablicaItem item);
            								
    		void Insert(Model.Data.Item.SubjektTablicaItem item);
    
    		ObjectResult<Model.Data.SubjektTablica> InsertResult(Model.Data.Item.SubjektTablicaItem item);
    										
    			
    		void Select(Nullable<int> IDSubjektTablica);
    
    			ObjectResult<Model.Data.SubjektTablica> SelectResult(Nullable<int> IDSubjektTablica);
            				
    			
    		void Update(Model.Data.Item.SubjektTablicaItem item);
    
    				
    		ObjectResult<Model.Data.SubjektTablica> UpdateResult (Model.Data.Item.SubjektTablicaItem item);
