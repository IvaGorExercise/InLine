...
namespace InLine.Repository.Data
{
    ...
    public partial class KriterijSt : CRUD.KriterijSt, IKriterijSt
    {
    	...
    	#region Methods
           ...
           // {
              //  return _context.KriterijSt.SingleOrDefault(p => p.ID_KriterijSt == id);
            //}
    		...
    		public Model.Data.KriterijSt FindID(long id)
            {
    			...
    			string filter = Repository.Data.Helper.QueryBulider.CreateWhereKeyValue("ID_KriterijSt", id.ToString());
    			querybilder.Append("SELECT * FROM " + "fik" + "." + "KriterijSt");
    			querybilder.Append(" WHERE " + filter);
    			query = querybilder.ToString();
                return _context.Database.SqlQuery<Model.Data.KriterijSt>(query).SingleOrDefault();
            }
    		
    
    
    		public IEnumerable <Model.Data.KriterijSt> GetGridDataEF(string filter, string sort, long? start, long? count)
    		{
    		   if (!String.IsNullOrEmpty(filter))
                    return _context.KriterijSt
                        .Where(filter)
                        .OrderBy(sort)
                        .Skip((int)start)
                        .Take((int)count);
    		...
    		public long GetCountEF(string filter)
    		{
    			if (!String.IsNullOrEmpty(filter))
                    ...
                    return _context.KriterijSt.Where(filter).Count();
    
                else
                    return _context.KriterijSt.Count();
    		}
    		...
    		{
    		    string query = String.Empty;
    			string entity = "fik" + "." + "KriterijSt";
    			string model = "InLine.Model.Data.KriterijSt";
                ...
                return _context.Database.SqlQuery<Model.Data.KriterijSt>(query);
    		...
    		public long GetCount(string filter, string key, string value, bool customserach = false)
            {
                ...
                query = querybilder.ToString();
                return _context.Database.SqlQuery<Model.Data.KriterijSt>(query).Count();
            }
