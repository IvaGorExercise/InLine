...
namespace InLine.Repository.Data
{
    ...
    public partial class HUBNalogVrsta2013A : CRUD.HUBNalogVrsta2013A, IHUBNalogVrsta2013A
    {
    	...
    	#region Methods
    		...
    		public IEnumerable <Model.Data.HUBNalogVrsta2013A> GetGridDataEF(string filter, string sort, long? start, long? count)
    		{
    		   if (!String.IsNullOrEmpty(filter))
                    return _context.HUBNalogVrsta2013A
                        .Where(filter)
                        .OrderBy(sort)
                        .Skip((int)start)
                        .Take((int)count);
    		...
    		public long GetCountEF(string filter)
    		{
    			if (!String.IsNullOrEmpty(filter))
                    ...
                    return _context.HUBNalogVrsta2013A.Where(filter).Count();
    
                else
                    return _context.HUBNalogVrsta2013A.Count();
    		}
    		...
    		public IEnumerable <Model.Data.HUBNalogVrsta2013A> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customserach = false)
    		{
    			...
    			string entity = "sis" + "." + "HUBNalogVrsta2013A";
    			string model = "InLine.Model.Data.HUBNalogVrsta2013A";
                ...
                return _context.Database.SqlQuery<Model.Data.HUBNalogVrsta2013A>(query);
    		...
    		public long GetCount(string filter, string key, string value, bool customserach = false)
            {
                ...
                if (!String.IsNullOrEmpty(filter) && String.IsNullOrEmpty(key) && String.IsNullOrEmpty(value))
                {
                    ...
                    {
                        filter = Repository.Data.Helper.QueryBulider.CreateWhere(model, filter);
    					querybilder.Append("SELECT * FROM " + "sis" + "." + "HUBNalogVrsta2013A");
                ...
                return _context.Database.SqlQuery<Model.Data.HUBNalogVrsta2013A>(query).Count();
            }
