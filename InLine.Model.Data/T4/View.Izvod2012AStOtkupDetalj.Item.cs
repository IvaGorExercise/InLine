...
namespace InLine.Model.Data.Item.View
{
    ...
    public partial class Izvod2012AStOtkupDetaljItem 
    {
    
    	public Izvod2012AStOtkupDetaljItem() {}
    	public Izvod2012AStOtkupDetaljItem(long? id_Izvod2012ASt)
    	{
    	...
    	public Izvod2012AStOtkupDetaljItem(Model.Data.View.Izvod2012AStOtkupDetalj item)
    	{
    	...
    	public Izvod2012AStOtkupDetaljItem(dynamic item)
    	{
    	    this.ID_Izvod = item.ID_Izvod;
        this.ID_Izvod2012ASt = item.ID_Izvod2012ASt;
        this.ID_IzvodSt = item.ID_IzvodSt;
