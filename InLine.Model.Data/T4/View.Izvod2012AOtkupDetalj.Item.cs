...
namespace InLine.Model.Data.Item.View
{
    ...
    public partial class Izvod2012AOtkupDetaljItem 
    {
    
    	public Izvod2012AOtkupDetaljItem() {}
    	public Izvod2012AOtkupDetaljItem(long? id_Izvod2012A, int? idIzvodVerzija)
    	{
    	...
    	public Izvod2012AOtkupDetaljItem(Model.Data.View.Izvod2012AOtkupDetalj item)
    	{
    	...
    	public Izvod2012AOtkupDetaljItem(dynamic item)
    	{
    	    this.ID_Izvod2012A = item.ID_Izvod2012A;
        this.ID_Izvod = item.ID_Izvod;
        this.BankaVBDI = item.BankaVBDI;
