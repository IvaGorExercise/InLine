...
namespace InLine.Model.Data.Filter
{
    ...
    public class UgovorStanOtkupObrokUplata
    {
        ...
        public UgovorStanOtkupObrokUplata(Model.Data.Field.UgovorStanOtkupObrokUplata field, dynamic value, ERelationalOperator operator_ = ERelationalOperator.Equal, bool tip_ = false)
        {
            this.Field = field;
            this.Value = value;
