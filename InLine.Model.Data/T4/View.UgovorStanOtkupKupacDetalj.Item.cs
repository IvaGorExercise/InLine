...
namespace InLine.Model.Data.Item.View
{
    ...
    public partial class UgovorStanOtkupKupacDetaljItem 
    {
    
    	public UgovorStanOtkupKupacDetaljItem() {}
    	public UgovorStanOtkupKupacDetaljItem(long? id_Kupac, long? id_UgovorStanOtkupKupac, long? id_UgovorStanOtkup)
    	{
    		ID_Kupac = id_Kupac;
    	...
    	public UgovorStanOtkupKupacDetaljItem(Model.Data.View.UgovorStanOtkupKupacDetalj item)
    	{
    	...
    	public UgovorStanOtkupKupacDetaljItem(dynamic item)
    	{
    	    this.ID_Kupac = item.ID_Kupac;
        this.Oznaka = item.Oznaka;
        this.Naziv = item.Naziv;
