...
namespace InLine.Model.Data.Item.View
{
    ...
    public partial class StanItem 
    {
    
    	public StanItem() {}
    	public StanItem(long? id_Stan, string oznaka, string naziv, string nazivKr, string kratica)
    	{
    		ID_Stan = id_Stan;
    		Oznaka = oznaka;
    		Naziv = naziv;
    	...
    	public StanItem(Model.Data.View.Stan item)
    	{
