...
namespace InLine.Model.Data.Filter
{
    ...
    public class TransakcijskiRacun
    {
        ...
        public TransakcijskiRacun(Model.Data.Field.TransakcijskiRacun field, dynamic value, ERelationalOperator operator_ = ERelationalOperator.Equal, bool tip_ = false)
        {
            this.Field = field;
            this.Value = value;
