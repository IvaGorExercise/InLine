...
namespace InLine.Model.Data.Item.View
{
    ...
    public partial class KriterijStKriterijStKriterijStItem 
    {
    
    	public KriterijStKriterijStKriterijStItem() {}
    	public KriterijStKriterijStKriterijStItem(long? id_KriterijSt, long? id_Kriterij, string oznaka, string naziv, string nazivKr, string kratica, long? id_KriterijKSKS, long? id_KriterijStKSKS, long? id_KriterijStNad, int? nivo)
    	{
    	...
    	public KriterijStKriterijStKriterijStItem(Model.Data.View.KriterijStKriterijStKriterijSt item)
    	{
        ...
        this.Nivo = item.Nivo;
        this.Put = item.Put;
        this.KriterijNaziv = item.KriterijNaziv;
        this.RedniBroj = item.RedniBroj;
    	}
    
    	public KriterijStKriterijStKriterijStItem(dynamic item)
    	{
    	    this.ID_KriterijSt = item.ID_KriterijSt;
        this.ID_Kriterij = item.ID_Kriterij;
        this.Oznaka = item.Oznaka;
