...
namespace InLine.Model.Data.Filter.View
{
    ...
    public class PoslovnaGodinaDetalj
    {
        ...
        public PoslovnaGodinaDetalj(Model.Data.Field.View.PoslovnaGodinaDetalj field, dynamic value, ERelationalOperator operator_ = ERelationalOperator.Equal, bool tip_ = false)
        {
            this.Field = field;
            this.Value = value;
