...
namespace InLine.Model.Data.Item.View
{
    ...
    public partial class Izvod2012AOtkupItem 
    {
    
    	public Izvod2012AOtkupItem() {}
    	public Izvod2012AOtkupItem(long? id_Izvod, long? id_Izvod2012A, int? idIzvodVerzija)
    	{
    		ID_Izvod = id_Izvod;
    	...
    	public Izvod2012AOtkupItem(Model.Data.View.Izvod2012AOtkup item)
    	{
        ...
        this.Izvod2012AID_Izvod = item.Izvod2012AID_Izvod;
    	...
    	public Izvod2012AOtkupItem(dynamic item)
    	{
    	    this.ID_Izvod = item.ID_Izvod;
        this.ID_Izvod2012A = item.ID_Izvod2012A;
        this.ID_Zapis = item.ID_Zapis;
