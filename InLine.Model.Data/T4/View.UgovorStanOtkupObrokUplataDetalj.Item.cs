...
namespace InLine.Model.Data.Item.View
{
    ...
    public partial class UgovorStanOtkupObrokUplataDetaljItem 
    {
    
    	public UgovorStanOtkupObrokUplataDetaljItem() {}
    	public UgovorStanOtkupObrokUplataDetaljItem(long? id_UgovorStanOtkupObrokUplata, string idValuta)
    	{
    	...
    	public UgovorStanOtkupObrokUplataDetaljItem(Model.Data.View.UgovorStanOtkupObrokUplataDetalj item)
    	{
        ...
        this.PlacanjeVrOznaka = item.PlacanjeVrOznaka;
        this.PlacanjeVrNaziv = item.PlacanjeVrNaziv;
        this.GodinaUplata = item.GodinaUplata;
    	}
    
    	public UgovorStanOtkupObrokUplataDetaljItem(dynamic item)
    	{
    	    this.ID_UgovorStanOtkupObrokUplata = item.ID_UgovorStanOtkupObrokUplata;
        this.ID_UgovorStanOtkupObrok = item.ID_UgovorStanOtkupObrok;
        this.Datum = item.Datum;
