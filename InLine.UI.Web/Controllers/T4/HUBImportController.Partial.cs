...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class HUBImportController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IHUBImport _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.HUBImportItem item)
    	{
    		
    		if (item.ID_HUBImport == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.HUBImportItem item)
    	{
        ...
        public InLine.Model.Data.HUBImport FindID(long id)
        {
    		InLine.Model.Data.HUBImport rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.HUBImport> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.HUBImport> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.HUBImport> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.HUBImport> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.HUBImport(korisnik_data);
                }
    			else
                {
