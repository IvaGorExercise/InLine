...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class PraznikController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IPraznik _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.PraznikItem item)
    	{
    		
    		if (item.ID_Praznik == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.PraznikItem item)
    	{
        ...
        public InLine.Model.Data.Praznik FindID(long id)
        {
    		InLine.Model.Data.Praznik rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.Praznik> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.Praznik> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.Praznik> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.Praznik> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.Praznik(korisnik_data);
                }
    			else
                {
