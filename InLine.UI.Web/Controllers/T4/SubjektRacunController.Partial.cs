...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class SubjektRacunController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.ISubjektRacun _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.SubjektRacunItem item)
    	{
    		
    		if (item.ID_SubjektRacun == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.SubjektRacunItem item)
    	{
        ...
        public InLine.Model.Data.SubjektRacun FindID(long id)
        {
    		InLine.Model.Data.SubjektRacun rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.SubjektRacun> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.SubjektRacun> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.SubjektRacun> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.SubjektRacun> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.SubjektRacun(korisnik_data);
                }
    			else
                {
