...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ZapisTablicaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IZapisTablica _service;
        ...
        public InLine.Model.Data.ZapisTablica FindID(long id)
        {
    		InLine.Model.Data.ZapisTablica rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ZapisTablica> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ZapisTablica> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ZapisTablica> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ZapisTablica> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ZapisTablica(korisnik_data);
                }
    			else
                {
