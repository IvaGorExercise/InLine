...
namespace InLine.UI.Web.Controllers.View
{
    ...
    public partial class OsobaDetaljViewController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.View.IOsobaDetalj _service;
        ...
        public InLine.Model.Data.View.OsobaDetalj FindID(long id)
        {
    		InLine.Model.Data.View.OsobaDetalj rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.View.OsobaDetalj> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.View.OsobaDetalj> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.View.OsobaDetalj> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.View.OsobaDetalj> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    				...
    				if (searchingName == "OtacIme")
    			{
    				...
    				if (searchingName == "OtacMjestoRodenja")
    			{
    				...
    				if (searchingName == "MajkaPrezimeDjevojacko")
    			{
    				...
    				if (searchingName == "MajkaMjestoRodenja")
    			{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.View.OsobaDetalj(korisnik_data);
                }
    			else
                {
