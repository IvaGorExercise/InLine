...
namespace InLine.UI.Web.Controllers.View
{
    ...
    public partial class KriterijStKriterijStKriterijStViewController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.View.IKriterijStKriterijStKriterijSt _service;
        ...
        public InLine.Model.Data.View.KriterijStKriterijStKriterijSt FindID(long id)
        {
    		InLine.Model.Data.View.KriterijStKriterijStKriterijSt rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.View.KriterijStKriterijStKriterijSt> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.View.KriterijStKriterijStKriterijSt> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.View.KriterijStKriterijStKriterijSt> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.View.KriterijStKriterijStKriterijSt> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    				...
    				if (searchingName == "Put")
    			{
    				...
    				if (searchingName == "KriterijNaziv")
    			{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.View.KriterijStKriterijStKriterijSt(korisnik_data);
                }
    			else
                {
