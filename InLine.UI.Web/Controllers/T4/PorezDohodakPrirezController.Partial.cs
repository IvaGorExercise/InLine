...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class PorezDohodakPrirezController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IPorezDohodakPrirez _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.PorezDohodakPrirezItem item)
    	{
    		
    		if (item.ID_PorezDohodakPrirez == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.PorezDohodakPrirezItem item)
    	{
        ...
        public InLine.Model.Data.PorezDohodakPrirez FindID(long id)
        {
    		InLine.Model.Data.PorezDohodakPrirez rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.PorezDohodakPrirez> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.PorezDohodakPrirez> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.PorezDohodakPrirez> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.PorezDohodakPrirez> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_PorezDohodakPrirez";
            }
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_PorezDohodakPrirez")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.PorezDohodakPrirez(korisnik_data);
                }
    			else
                {
