...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class OsobaPrezimeController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IOsobaPrezime _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.OsobaPrezimeItem item)
    	{
    		
    		if (item.ID_OsobaPrezime == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.OsobaPrezimeItem item)
    	{
        ...
        public InLine.Model.Data.OsobaPrezime FindID(long id)
        {
    		InLine.Model.Data.OsobaPrezime rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.OsobaPrezime> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.OsobaPrezime> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.OsobaPrezime> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.OsobaPrezime> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_OsobaPrezime")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.OsobaPrezime(korisnik_data);
                }
    			else
                {
