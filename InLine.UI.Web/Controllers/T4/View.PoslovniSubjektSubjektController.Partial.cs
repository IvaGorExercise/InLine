...
namespace InLine.UI.Web.Controllers.View
{
    ...
    public partial class PoslovniSubjektSubjektViewController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.View.IPoslovniSubjektSubjekt _service;
        ...
        public InLine.Model.Data.View.PoslovniSubjektSubjekt FindID(long id)
        {
    		InLine.Model.Data.View.PoslovniSubjektSubjekt rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.View.PoslovniSubjektSubjekt> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.View.PoslovniSubjektSubjekt> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.View.PoslovniSubjektSubjekt> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.View.PoslovniSubjektSubjekt> rezultat;
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_Subjekt")
    				{
    					...
    					if (searchingName == "IDSubjektTablica")
    				{
    				...
    				if (searchingName == "TablicaNaziv")
    			{
    				...
    				if (searchingName == "SubjektVrNaziv")
    			{
    				...
    				if (searchingName == "SubjektVrNazivKr")
    			{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.View.PoslovniSubjektSubjekt(korisnik_data);
                }
    			else
                {
