...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class DoprinosDohodakController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IDoprinosDohodak _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.DoprinosDohodakItem item)
    	{
    		
    		if (item.ID_DoprinosDohodak == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.DoprinosDohodakItem item)
    	{
        ...
        public InLine.Model.Data.DoprinosDohodak FindID(long id)
        {
    		InLine.Model.Data.DoprinosDohodak rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.DoprinosDohodak> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.DoprinosDohodak> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.DoprinosDohodak> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.DoprinosDohodak> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.DoprinosDohodak(korisnik_data);
                }
    			else
                {
