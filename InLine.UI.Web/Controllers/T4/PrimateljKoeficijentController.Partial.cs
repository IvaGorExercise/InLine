...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class PrimateljKoeficijentController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IPrimateljKoeficijent _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.PrimateljKoeficijentItem item)
    	{
    		
    		if (item.ID_PrimateljKoeficijent == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.PrimateljKoeficijentItem item)
    	{
        ...
        public InLine.Model.Data.PrimateljKoeficijent FindID(long id)
        {
    		InLine.Model.Data.PrimateljKoeficijent rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.PrimateljKoeficijent> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.PrimateljKoeficijent> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.PrimateljKoeficijent> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.PrimateljKoeficijent> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_PrimateljKoeficijent";
            }
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_PrimateljKoeficijent")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    				if (searchingName == "ID_PrimateljKoeficijentGr")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.PrimateljKoeficijent(korisnik_data);
                }
    			else
                {
