...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class DrzavaRadnaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IDrzavaRadna _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.DrzavaRadnaItem item)
    	{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.DrzavaRadnaItem item)
    	{
        ...
        public InLine.Model.Data.DrzavaRadna FindID(long id)
        {
    		InLine.Model.Data.DrzavaRadna rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.DrzavaRadna> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.DrzavaRadna> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.DrzavaRadna> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.DrzavaRadna> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.DrzavaRadna(korisnik_data);
                }
    			else
                {
