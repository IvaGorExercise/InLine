...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class TemeljnicaVrVrController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.ITemeljnicaVrVr _service;
        ...
        public InLine.Model.Data.TemeljnicaVrVr FindID(long id)
        {
    		InLine.Model.Data.TemeljnicaVrVr rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.TemeljnicaVrVr> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.TemeljnicaVrVr> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.TemeljnicaVrVr> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.TemeljnicaVrVr> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.TemeljnicaVrVr(korisnik_data);
                }
    			else
                {
