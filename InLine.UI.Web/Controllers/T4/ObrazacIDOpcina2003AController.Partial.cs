...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ObrazacIDOpcina2003AController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IObrazacIDOpcina2003A _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ObrazacIDOpcina2003AItem item)
    	{
    		
    		if (item.ID_ObrazacIDOpcina2003A == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ObrazacIDOpcina2003AItem item)
    	{
        ...
        public InLine.Model.Data.ObrazacIDOpcina2003A FindID(long id)
        {
    		InLine.Model.Data.ObrazacIDOpcina2003A rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ObrazacIDOpcina2003A> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ObrazacIDOpcina2003A> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ObrazacIDOpcina2003A> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ObrazacIDOpcina2003A> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_ObrazacIDOpcina2003A";
            }
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_ObrazacIDOpcina2003A")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ObrazacIDOpcina2003A(korisnik_data);
                }
    			else
                {
