...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class PosebanPorezDohodakController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IPosebanPorezDohodak _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.PosebanPorezDohodakItem item)
    	{
    		
    		if (item.ID_PosebanPorezDohodak == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.PosebanPorezDohodakItem item)
    	{
        ...
        public InLine.Model.Data.PosebanPorezDohodak FindID(long id)
        {
    		InLine.Model.Data.PosebanPorezDohodak rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.PosebanPorezDohodak> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.PosebanPorezDohodak> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.PosebanPorezDohodak> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.PosebanPorezDohodak> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_PosebanPorezDohodak";
            }
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_PosebanPorezDohodak")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    				if (searchingName == "ID_PosebanPorezDohodakVr")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    				...
    				if (searchingName == "IznosOsnovaOd")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    					...
    					if (searchingName == "IznosOsnovaDo")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.PosebanPorezDohodak(korisnik_data);
                }
    			else
                {
