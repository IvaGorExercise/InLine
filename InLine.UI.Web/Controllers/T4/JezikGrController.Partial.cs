...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class JezikGrController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IJezikGr _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.JezikGrItem item)
    	{
    		
    		if (item.ID_JezikGr == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.JezikGrItem item)
    	{
        ...
        public InLine.Model.Data.JezikGr FindID(long id)
        {
    		InLine.Model.Data.JezikGr rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.JezikGr> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.JezikGr> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.JezikGr> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.JezikGr> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.JezikGr(korisnik_data);
                }
    			else
                {
