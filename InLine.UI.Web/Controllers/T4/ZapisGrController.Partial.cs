...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ZapisGrController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IZapisGr _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ZapisGrItem item)
    	{
    		
    		if (item.ID_ZapisGr == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ZapisGrItem item)
    	{
        ...
        public InLine.Model.Data.ZapisGr FindID(long id)
        {
    		InLine.Model.Data.ZapisGr rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ZapisGr> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ZapisGr> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ZapisGr> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ZapisGr> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ZapisGr(korisnik_data);
                }
    			else
                {
