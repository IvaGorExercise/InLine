...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class HUBNamjena2013AController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IHUBNamjena2013A _service;
        ...
        public InLine.Model.Data.HUBNamjena2013A FindID(long id)
        {
    		InLine.Model.Data.HUBNamjena2013A rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.HUBNamjena2013A> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.HUBNamjena2013A> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.HUBNamjena2013A> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.HUBNamjena2013A> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    				...
    				if (searchingName == "Kratica")
    			{
    				...
    				if (searchingName == "Klasifikacija")
    			{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.HUBNamjena2013A(korisnik_data);
                }
    			else
                {
