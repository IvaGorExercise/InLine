...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class OpcinaGrOpcinaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IOpcinaGrOpcina _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.OpcinaGrOpcinaItem item)
    	{
    		
    		if (item.ID_OpcinaGrOpcina == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.OpcinaGrOpcinaItem item)
    	{
        ...
        public InLine.Model.Data.OpcinaGrOpcina FindID(long id)
        {
    		InLine.Model.Data.OpcinaGrOpcina rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.OpcinaGrOpcina> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.OpcinaGrOpcina> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.OpcinaGrOpcina> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.OpcinaGrOpcina> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.OpcinaGrOpcina(korisnik_data);
                }
    			else
                {
