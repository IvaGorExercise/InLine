...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class PraznikPraviloPomakController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IPraznikPraviloPomak _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.PraznikPraviloPomakItem item)
    	{
    		
    		if (item.ID_PraznikPraviloPomak == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.PraznikPraviloPomakItem item)
    	{
        ...
        public InLine.Model.Data.PraznikPraviloPomak FindID(long id)
        {
    		InLine.Model.Data.PraznikPraviloPomak rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.PraznikPraviloPomak> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.PraznikPraviloPomak> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.PraznikPraviloPomak> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.PraznikPraviloPomak> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_PraznikPraviloPomak";
            }
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_PraznikPraviloPomak")
    				{
    				...
    				if (searchingName == "TjedanDanPomak")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.PraznikPraviloPomak(korisnik_data);
                }
    			else
                {
