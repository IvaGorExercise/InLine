...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class PraznikGrController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IPraznikGr _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.PraznikGrItem item)
    	{
    		
    		if (item.ID_PraznikGr == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.PraznikGrItem item)
    	{
        ...
        public InLine.Model.Data.PraznikGr FindID(long id)
        {
    		InLine.Model.Data.PraznikGr rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.PraznikGr> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.PraznikGr> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.PraznikGr> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.PraznikGr> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.PraznikGr(korisnik_data);
                }
    			else
                {
