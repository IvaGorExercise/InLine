...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class KalendarMjesecController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IKalendarMjesec _service;
        ...
        public InLine.Model.Data.KalendarMjesec FindID(long id)
        {
    		InLine.Model.Data.KalendarMjesec rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.KalendarMjesec> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.KalendarMjesec> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.KalendarMjesec> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.KalendarMjesec> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.KalendarMjesec(korisnik_data);
                }
    			else
                {
