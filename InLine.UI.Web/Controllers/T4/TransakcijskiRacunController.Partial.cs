...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class TransakcijskiRacunController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.ITransakcijskiRacun _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.TransakcijskiRacunItem item)
    	{
    		
    		if (item.ID_TransakcijskiRacun == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.TransakcijskiRacunItem item)
    	{
        ...
        public InLine.Model.Data.TransakcijskiRacun FindID(long id)
        {
    		InLine.Model.Data.TransakcijskiRacun rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.TransakcijskiRacun> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.TransakcijskiRacun> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.TransakcijskiRacun> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.TransakcijskiRacun> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_TransakcijskiRacun";
            }
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_TransakcijskiRacun")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.TransakcijskiRacun(korisnik_data);
                }
    			else
                {
