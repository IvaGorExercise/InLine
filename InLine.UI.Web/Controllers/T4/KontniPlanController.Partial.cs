...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class KontniPlanController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IKontniPlan _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.KontniPlanItem item)
    	{
    		
    		if (item.ID_KontniPlan == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.KontniPlanItem item)
    	{
        ...
        public InLine.Model.Data.KontniPlan FindID(long id)
        {
    		InLine.Model.Data.KontniPlan rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.KontniPlan> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.KontniPlan> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.KontniPlan> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.KontniPlan> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.KontniPlan(korisnik_data);
                }
    			else
                {
