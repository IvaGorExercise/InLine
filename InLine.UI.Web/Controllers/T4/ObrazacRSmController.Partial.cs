...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ObrazacRSmController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IObrazacRSm _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ObrazacRSmItem item)
    	{
    		
    		if (item.ID_ObrazacRSm == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ObrazacRSmItem item)
    	{
        ...
        public InLine.Model.Data.ObrazacRSm FindID(long id)
        {
    		InLine.Model.Data.ObrazacRSm rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ObrazacRSm> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ObrazacRSm> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ObrazacRSm> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ObrazacRSm> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "IDObrazacRSmVerzija")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ObrazacRSm(korisnik_data);
                }
    			else
                {
