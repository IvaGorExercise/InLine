...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class DatotekaIzvodController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IDatotekaIzvod _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.DatotekaIzvodItem item)
    	{
    		
    		if (item.ID_DatotekaIzvod == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.DatotekaIzvodItem item)
    	{
        ...
        public InLine.Model.Data.DatotekaIzvod FindID(long id)
        {
    		InLine.Model.Data.DatotekaIzvod rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.DatotekaIzvod> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.DatotekaIzvod> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.DatotekaIzvod> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.DatotekaIzvod> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_IzvodPosiljatelj")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    				...
    				if (searchingName == "IDDatotekaIzvodVerzija")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.DatotekaIzvod(korisnik_data);
                }
    			else
                {
