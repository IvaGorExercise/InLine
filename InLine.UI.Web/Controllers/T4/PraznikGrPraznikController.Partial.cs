...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class PraznikGrPraznikController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IPraznikGrPraznik _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.PraznikGrPraznikItem item)
    	{
    		
    		if (item.ID_PraznikGrPraznik == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.PraznikGrPraznikItem item)
    	{
        ...
        public InLine.Model.Data.PraznikGrPraznik FindID(long id)
        {
    		InLine.Model.Data.PraznikGrPraznik rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.PraznikGrPraznik> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.PraznikGrPraznik> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.PraznikGrPraznik> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.PraznikGrPraznik> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.PraznikGrPraznik(korisnik_data);
                }
    			else
                {
