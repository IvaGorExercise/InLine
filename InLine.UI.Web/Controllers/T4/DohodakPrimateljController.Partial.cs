...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class DohodakPrimateljController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IDohodakPrimatelj _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.DohodakPrimateljItem item)
    	{
    		
    		if (item.ID_DohodakPrimatelj == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.DohodakPrimateljItem item)
    	{
        ...
        public InLine.Model.Data.DohodakPrimatelj FindID(long id)
        {
    		InLine.Model.Data.DohodakPrimatelj rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.DohodakPrimatelj> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.DohodakPrimatelj> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.DohodakPrimatelj> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.DohodakPrimatelj> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.DohodakPrimatelj(korisnik_data);
                }
    			else
                {
