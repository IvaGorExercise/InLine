...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class DavanjeDoprinosDohodakVrController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IDavanjeDoprinosDohodakVr _service;
        ...
        public InLine.Model.Data.DavanjeDoprinosDohodakVr FindID(long id)
        {
    		InLine.Model.Data.DavanjeDoprinosDohodakVr rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.DavanjeDoprinosDohodakVr> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.DavanjeDoprinosDohodakVr> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.DavanjeDoprinosDohodakVr> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.DavanjeDoprinosDohodakVr> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "IDDavanjeDoprinosDohodakVr";
            }
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.DavanjeDoprinosDohodakVr(korisnik_data);
                }
    			else
                {
