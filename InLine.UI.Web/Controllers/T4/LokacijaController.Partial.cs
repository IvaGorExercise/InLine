...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class LokacijaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.ILokacija _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.LokacijaItem item)
    	{
    		
    		if (item.ID_Lokacija == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.LokacijaItem item)
    	{
        ...
        public InLine.Model.Data.Lokacija FindID(long id)
        {
    		InLine.Model.Data.Lokacija rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.Lokacija> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.Lokacija> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.Lokacija> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.Lokacija> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.Lokacija(korisnik_data);
                }
    			else
                {
