...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class DavanjeDoprinosDohodakController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IDavanjeDoprinosDohodak _service;
        ...
        public InLine.Model.Data.DavanjeDoprinosDohodak FindID(long id)
        {
    		InLine.Model.Data.DavanjeDoprinosDohodak rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.DavanjeDoprinosDohodak> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.DavanjeDoprinosDohodak> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.DavanjeDoprinosDohodak> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.DavanjeDoprinosDohodak> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "IDDavanjeDoprinosDohodak";
            }
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "IDDavanjeDoprinosDohodak")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.DavanjeDoprinosDohodak(korisnik_data);
                }
    			else
                {
