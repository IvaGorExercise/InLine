...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ShemaStPoljeController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IShemaStPolje _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ShemaStPoljeItem item)
    	{
    		
    		if (item.ID_ShemaStPolje == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ShemaStPoljeItem item)
    	{
        ...
        public InLine.Model.Data.ShemaStPolje FindID(long id)
        {
    		InLine.Model.Data.ShemaStPolje rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ShemaStPolje> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ShemaStPolje> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ShemaStPolje> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ShemaStPolje> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ShemaStPolje(korisnik_data);
                }
    			else
                {
