...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ValutaRadnaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IValutaRadna _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ValutaRadnaItem item)
    	{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ValutaRadnaItem item)
    	{
        ...
        public InLine.Model.Data.ValutaRadna FindID(long id)
        {
    		InLine.Model.Data.ValutaRadna rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ValutaRadna> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ValutaRadna> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ValutaRadna> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ValutaRadna> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ValutaRadna(korisnik_data);
                }
    			else
                {
