...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class GlavnaKnjigaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IGlavnaKnjiga _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.GlavnaKnjigaItem item)
    	{
    		
    		if (item.ID_GlavnaKnjiga == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.GlavnaKnjigaItem item)
    	{
        ...
        public InLine.Model.Data.GlavnaKnjiga FindID(long id)
        {
    		InLine.Model.Data.GlavnaKnjiga rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.GlavnaKnjiga> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.GlavnaKnjiga> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.GlavnaKnjiga> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.GlavnaKnjiga> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.GlavnaKnjiga(korisnik_data);
                }
    			else
                {
