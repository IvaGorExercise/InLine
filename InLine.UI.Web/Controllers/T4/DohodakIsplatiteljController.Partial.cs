...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class DohodakIsplatiteljController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IDohodakIsplatitelj _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.DohodakIsplatiteljItem item)
    	{
    		
    		if (item.ID_DohodakIsplatitelj == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.DohodakIsplatiteljItem item)
    	{
        ...
        public InLine.Model.Data.DohodakIsplatitelj FindID(long id)
        {
    		InLine.Model.Data.DohodakIsplatitelj rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.DohodakIsplatitelj> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.DohodakIsplatitelj> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.DohodakIsplatitelj> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.DohodakIsplatitelj> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_DohodakIsplatitelj";
            }
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.DohodakIsplatitelj(korisnik_data);
                }
    			else
                {
