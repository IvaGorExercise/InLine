...
namespace InLine.UI.Web.Controllers.View
{
    ...
    public partial class TemeljnicaStKriterijViewController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.View.ITemeljnicaStKriterij _service;
        ...
        public InLine.Model.Data.View.TemeljnicaStKriterij FindID(long id)
        {
    		InLine.Model.Data.View.TemeljnicaStKriterij rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.View.TemeljnicaStKriterij> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.View.TemeljnicaStKriterij> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.View.TemeljnicaStKriterij> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.View.TemeljnicaStKriterij> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_TemeljnicaSt")
    				{
    				...
    				if (searchingName == "KriterijOznaka1")
    			{
    				...
    				if (searchingName == "KriterijOznaka2")
    			{
    				...
    				if (searchingName == "KriterijOznaka3")
    			{
    				...
    				if (searchingName == "KriterijOznaka4")
    			{
    				...
    				if (searchingName == "KriterijOznaka5")
    			{
    				...
    				if (searchingName == "KriterijOznaka6")
    			{
    				...
    				if (searchingName == "KriterijNaziv1")
    			{
    				...
    				if (searchingName == "KriterijNaziv2")
    			{
    				...
    				if (searchingName == "KriterijNaziv3")
    			{
    				...
    				if (searchingName == "KriterijNaziv4")
    			{
    				...
    				if (searchingName == "KriterijNaziv5")
    			{
    				...
    				if (searchingName == "KriterijNaziv6")
    			{
    				...
    				if (searchingName == "KriterijStOznaka1")
    			{
    				...
    				if (searchingName == "KriterijStOznaka2")
    			{
    				...
    				if (searchingName == "KriterijStOznaka3")
    			{
    				...
    				if (searchingName == "KriterijStOznaka4")
    			{
    				...
    				if (searchingName == "KriterijStOznaka5")
    			{
    				...
    				if (searchingName == "KriterijStOznaka6")
    			{
    				...
    				if (searchingName == "KriterijStNaziv1")
    			{
    				...
    				if (searchingName == "KriterijStNaziv2")
    			{
    				...
    				if (searchingName == "KriterijStNaziv3")
    			{
    				...
    				if (searchingName == "KriterijStNaziv4")
    			{
    				...
    				if (searchingName == "KriterijStNaziv5")
    			{
    				...
    				if (searchingName == "KriterijStNaziv6")
    			{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.View.TemeljnicaStKriterij(korisnik_data);
                }
    			else
                {
