...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class HUBPrimateljVrsta2013AController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IHUBPrimateljVrsta2013A _service;
        ...
        public InLine.Model.Data.HUBPrimateljVrsta2013A FindID(long id)
        {
    		InLine.Model.Data.HUBPrimateljVrsta2013A rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.HUBPrimateljVrsta2013A> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.HUBPrimateljVrsta2013A> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.HUBPrimateljVrsta2013A> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.HUBPrimateljVrsta2013A> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "IDHUBPrimateljVrsta2013A";
            }
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.HUBPrimateljVrsta2013A(korisnik_data);
                }
    			else
                {
