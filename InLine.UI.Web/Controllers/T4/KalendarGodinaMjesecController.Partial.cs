...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class KalendarGodinaMjesecController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IKalendarGodinaMjesec _service;
        ...
        public InLine.Model.Data.KalendarGodinaMjesec FindID(long id)
        {
    		InLine.Model.Data.KalendarGodinaMjesec rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.KalendarGodinaMjesec> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.KalendarGodinaMjesec> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.KalendarGodinaMjesec> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.KalendarGodinaMjesec> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.KalendarGodinaMjesec(korisnik_data);
                }
    			else
                {
