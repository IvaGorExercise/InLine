...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class KalendarGodinaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IKalendarGodina _service;
        ...
        public InLine.Model.Data.KalendarGodina FindID(long id)
        {
    		InLine.Model.Data.KalendarGodina rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.KalendarGodina> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.KalendarGodina> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.KalendarGodina> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.KalendarGodina> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.KalendarGodina(korisnik_data);
                }
    			else
                {
