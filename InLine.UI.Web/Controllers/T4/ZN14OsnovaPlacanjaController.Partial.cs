...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ZN14OsnovaPlacanjaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IZN14OsnovaPlacanja _service;
        ...
        public InLine.Model.Data.ZN14OsnovaPlacanja FindID(long id)
        {
    		InLine.Model.Data.ZN14OsnovaPlacanja rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ZN14OsnovaPlacanja> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ZN14OsnovaPlacanja> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ZN14OsnovaPlacanja> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ZN14OsnovaPlacanja> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "IDZN14OsnovaPlacanja";
            }
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "IDZN14OsnovaPlacanja")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ZN14OsnovaPlacanja(korisnik_data);
                }
    			else
                {
