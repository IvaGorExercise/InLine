...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ObrazacRSmVerzijaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IObrazacRSmVerzija _service;
        ...
        public InLine.Model.Data.ObrazacRSmVerzija FindID(long id)
        {
    		InLine.Model.Data.ObrazacRSmVerzija rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ObrazacRSmVerzija> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ObrazacRSmVerzija> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ObrazacRSmVerzija> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ObrazacRSmVerzija> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ObrazacRSmVerzija(korisnik_data);
                }
    			else
                {
