...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ObrazacPDVController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IObrazacPDV _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ObrazacPDVItem item)
    	{
    		
    		if (item.ID_ObrazacPDV == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ObrazacPDVItem item)
    	{
        ...
        public InLine.Model.Data.ObrazacPDV FindID(long id)
        {
    		InLine.Model.Data.ObrazacPDV rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ObrazacPDV> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ObrazacPDV> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ObrazacPDV> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ObrazacPDV> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ObrazacPDV(korisnik_data);
                }
    			else
                {
