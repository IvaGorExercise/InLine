...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ShemaStController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IShemaSt _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ShemaStItem item)
    	{
    		
    		if (item.ID_ShemaSt == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ShemaStItem item)
    	{
        ...
        public InLine.Model.Data.ShemaSt FindID(long id)
        {
    		InLine.Model.Data.ShemaSt rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ShemaSt> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ShemaSt> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ShemaSt> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ShemaSt> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ShemaSt(korisnik_data);
                }
    			else
                {
