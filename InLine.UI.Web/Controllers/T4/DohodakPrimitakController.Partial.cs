...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class DohodakPrimitakController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IDohodakPrimitak _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.DohodakPrimitakItem item)
    	{
    		
    		if (item.ID_DohodakPrimitak == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.DohodakPrimitakItem item)
    	{
        ...
        public InLine.Model.Data.DohodakPrimitak FindID(long id)
        {
    		InLine.Model.Data.DohodakPrimitak rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.DohodakPrimitak> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.DohodakPrimitak> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.DohodakPrimitak> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.DohodakPrimitak> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "IznosDoprinosIz")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.DohodakPrimitak(korisnik_data);
                }
    			else
                {
