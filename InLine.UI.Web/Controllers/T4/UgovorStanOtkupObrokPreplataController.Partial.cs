...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class UgovorStanOtkupObrokPreplataController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IUgovorStanOtkupObrokPreplata _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.UgovorStanOtkupObrokPreplataItem item)
    	{
    		
    		if (item.ID_UgovorStanOtkupObrokPreplata == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.UgovorStanOtkupObrokPreplataItem item)
    	{
        ...
        public InLine.Model.Data.UgovorStanOtkupObrokPreplata FindID(long id)
        {
    		InLine.Model.Data.UgovorStanOtkupObrokPreplata rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.UgovorStanOtkupObrokPreplata> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.UgovorStanOtkupObrokPreplata> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.UgovorStanOtkupObrokPreplata> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.UgovorStanOtkupObrokPreplata> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_UgovorStanOtkupObrokPreplata";
            }
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.UgovorStanOtkupObrokPreplata(korisnik_data);
                }
    			else
                {
