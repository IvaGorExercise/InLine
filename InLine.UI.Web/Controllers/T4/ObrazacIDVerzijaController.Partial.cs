...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ObrazacIDVerzijaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IObrazacIDVerzija _service;
        ...
        public InLine.Model.Data.ObrazacIDVerzija FindID(long id)
        {
    		InLine.Model.Data.ObrazacIDVerzija rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ObrazacIDVerzija> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ObrazacIDVerzija> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ObrazacIDVerzija> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ObrazacIDVerzija> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ObrazacIDVerzija(korisnik_data);
                }
    			else
                {
