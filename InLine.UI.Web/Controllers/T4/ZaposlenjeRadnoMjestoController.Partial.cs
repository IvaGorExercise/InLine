...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ZaposlenjeRadnoMjestoController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IZaposlenjeRadnoMjesto _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ZaposlenjeRadnoMjestoItem item)
    	{
    		
    		if (item.ID_ZaposlenjeRadnoMjesto == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ZaposlenjeRadnoMjestoItem item)
    	{
        ...
        public InLine.Model.Data.ZaposlenjeRadnoMjesto FindID(long id)
        {
    		InLine.Model.Data.ZaposlenjeRadnoMjesto rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ZaposlenjeRadnoMjesto> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ZaposlenjeRadnoMjesto> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ZaposlenjeRadnoMjesto> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ZaposlenjeRadnoMjesto> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_ZaposlenjeRadnoMjesto";
            }
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_ZaposlenjeRadnoMjesto")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    				if (searchingName == "ID_Zaposlenje")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    				if (searchingName == "ID_RadnoMjesto")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ZaposlenjeRadnoMjesto(korisnik_data);
                }
    			else
                {
