...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class Izvod2012ATransakcijaVrController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IIzvod2012ATransakcijaVr _service;
        ...
        public InLine.Model.Data.Izvod2012ATransakcijaVr FindID(long id)
        {
    		InLine.Model.Data.Izvod2012ATransakcijaVr rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.Izvod2012ATransakcijaVr> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.Izvod2012ATransakcijaVr> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.Izvod2012ATransakcijaVr> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.Izvod2012ATransakcijaVr> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "IDIzvod2012ATransakcijaVr";
            }
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.Izvod2012ATransakcijaVr(korisnik_data);
                }
    			else
                {
