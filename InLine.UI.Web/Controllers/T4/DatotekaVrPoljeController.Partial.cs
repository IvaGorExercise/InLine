...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class DatotekaVrPoljeController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IDatotekaVrPolje _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.DatotekaVrPoljeItem item)
    	{
    		
    		if (item.ID_DatotekaVrPolje == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.DatotekaVrPoljeItem item)
    	{
        ...
        public InLine.Model.Data.DatotekaVrPolje FindID(long id)
        {
    		InLine.Model.Data.DatotekaVrPolje rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.DatotekaVrPolje> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.DatotekaVrPolje> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.DatotekaVrPolje> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.DatotekaVrPolje> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_DatotekaVrVerzija")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    				if (searchingName == "ID_DatotekaVrPoljeTip")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    				
    		
    					if (searchingName == "Duljina")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.DatotekaVrPolje(korisnik_data);
                }
    			else
                {
