...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class UgovorStanOtkupMoratorijMjesecController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IUgovorStanOtkupMoratorijMjesec _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.UgovorStanOtkupMoratorijMjesecItem item)
    	{
    		
    		if (item.ID_UgovorStanOtkupMoratorijMjesec == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.UgovorStanOtkupMoratorijMjesecItem item)
    	{
        ...
        public InLine.Model.Data.UgovorStanOtkupMoratorijMjesec FindID(long id)
        {
    		InLine.Model.Data.UgovorStanOtkupMoratorijMjesec rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.UgovorStanOtkupMoratorijMjesec> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.UgovorStanOtkupMoratorijMjesec> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.UgovorStanOtkupMoratorijMjesec> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.UgovorStanOtkupMoratorijMjesec> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_UgovorStanOtkupMoratorijMjesec";
            }
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_UgovorStanOtkupMoratorijMjesec")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.UgovorStanOtkupMoratorijMjesec(korisnik_data);
                }
    			else
                {
