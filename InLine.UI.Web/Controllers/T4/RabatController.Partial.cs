...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class RabatController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IRabat _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.RabatItem item)
    	{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.RabatItem item)
    	{
        ...
        public InLine.Model.Data.Rabat FindID(long id)
        {
    		InLine.Model.Data.Rabat rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.Rabat> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.Rabat> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.Rabat> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.Rabat> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.Rabat(korisnik_data);
                }
    			else
                {
