...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ZapisVrTablicaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IZapisVrTablica _service;
        ...
        public InLine.Model.Data.ZapisVrTablica FindID(long id)
        {
    		InLine.Model.Data.ZapisVrTablica rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ZapisVrTablica> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ZapisVrTablica> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ZapisVrTablica> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ZapisVrTablica> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ZapisVrTablica(korisnik_data);
                }
    			else
                {
