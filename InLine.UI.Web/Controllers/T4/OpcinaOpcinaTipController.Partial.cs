...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class OpcinaOpcinaTipController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IOpcinaOpcinaTip _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.OpcinaOpcinaTipItem item)
    	{
    		
    		if (item.ID_OpcinaOpcinaTip == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.OpcinaOpcinaTipItem item)
    	{
        ...
        public InLine.Model.Data.OpcinaOpcinaTip FindID(long id)
        {
    		InLine.Model.Data.OpcinaOpcinaTip rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.OpcinaOpcinaTip> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.OpcinaOpcinaTip> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.OpcinaOpcinaTip> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.OpcinaOpcinaTip> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_OpcinaOpcinaTip")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.OpcinaOpcinaTip(korisnik_data);
                }
    			else
                {
