...
namespace InLine.UI.Web.Controllers.View
{
    ...
    public partial class Izvod2012ADetaljViewController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.View.IIzvod2012ADetalj _service;
        ...
        public InLine.Model.Data.View.Izvod2012ADetalj FindID(long id)
        {
    		InLine.Model.Data.View.Izvod2012ADetalj rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.View.Izvod2012ADetalj> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.View.Izvod2012ADetalj> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.View.Izvod2012ADetalj> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.View.Izvod2012ADetalj> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.View.Izvod2012ADetalj(korisnik_data);
                }
    			else
                {
