...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ZapisGrZapisGrController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IZapisGrZapisGr _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ZapisGrZapisGrItem item)
    	{
    		
    		if (item.ID_ZapisGrZapisGr == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ZapisGrZapisGrItem item)
    	{
        ...
        public InLine.Model.Data.ZapisGrZapisGr FindID(long id)
        {
    		InLine.Model.Data.ZapisGrZapisGr rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ZapisGrZapisGr> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ZapisGrZapisGr> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ZapisGrZapisGr> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ZapisGrZapisGr> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_ZapisGrZapisGr")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    				if (searchingName == "ID_ZapisGr")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    				if (searchingName == "ID_ZapisGrNad")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ZapisGrZapisGr(korisnik_data);
                }
    			else
                {
