...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class KalendarKvartalController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IKalendarKvartal _service;
        ...
        public InLine.Model.Data.KalendarKvartal FindID(long id)
        {
    		InLine.Model.Data.KalendarKvartal rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.KalendarKvartal> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.KalendarKvartal> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.KalendarKvartal> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.KalendarKvartal> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.KalendarKvartal(korisnik_data);
                }
    			else
                {
