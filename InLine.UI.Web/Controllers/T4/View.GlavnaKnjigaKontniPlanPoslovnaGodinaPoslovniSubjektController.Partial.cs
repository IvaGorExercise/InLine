...
namespace InLine.UI.Web.Controllers.View
{
    ...
    public partial class GlavnaKnjigaKontniPlanPoslovnaGodinaPoslovniSubjektViewController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.View.IGlavnaKnjigaKontniPlanPoslovnaGodinaPoslovniSubjekt _service;
        ...
        public InLine.Model.Data.View.GlavnaKnjigaKontniPlanPoslovnaGodinaPoslovniSubjekt FindID(long id)
        {
    		InLine.Model.Data.View.GlavnaKnjigaKontniPlanPoslovnaGodinaPoslovniSubjekt rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.View.GlavnaKnjigaKontniPlanPoslovnaGodinaPoslovniSubjekt> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.View.GlavnaKnjigaKontniPlanPoslovnaGodinaPoslovniSubjekt> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.View.GlavnaKnjigaKontniPlanPoslovnaGodinaPoslovniSubjekt> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.View.GlavnaKnjigaKontniPlanPoslovnaGodinaPoslovniSubjekt> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_GlavnaKnjiga")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.View.GlavnaKnjigaKontniPlanPoslovnaGodinaPoslovniSubjekt(korisnik_data);
                }
    			else
                {
