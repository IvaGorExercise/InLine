...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ShemaGrShemaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IShemaGrShema _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ShemaGrShemaItem item)
    	{
    		
    		if (item.ID_ShemaGrShema == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ShemaGrShemaItem item)
    	{
        ...
        public InLine.Model.Data.ShemaGrShema FindID(long id)
        {
    		InLine.Model.Data.ShemaGrShema rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ShemaGrShema> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ShemaGrShema> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ShemaGrShema> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ShemaGrShema> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_ShemaGrShema")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ShemaGrShema(korisnik_data);
                }
    			else
                {
