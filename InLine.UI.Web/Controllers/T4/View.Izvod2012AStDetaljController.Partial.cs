...
namespace InLine.UI.Web.Controllers.View
{
    ...
    public partial class Izvod2012AStDetaljViewController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.View.IIzvod2012AStDetalj _service;
        ...
        public InLine.Model.Data.View.Izvod2012AStDetalj FindID(long id)
        {
    		InLine.Model.Data.View.Izvod2012AStDetalj rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.View.Izvod2012AStDetalj> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.View.Izvod2012AStDetalj> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.View.Izvod2012AStDetalj> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.View.Izvod2012AStDetalj> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.View.Izvod2012AStDetalj(korisnik_data);
                }
    			else
                {
