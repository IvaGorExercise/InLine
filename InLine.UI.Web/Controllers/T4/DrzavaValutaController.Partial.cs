...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class DrzavaValutaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IDrzavaValuta _service;
        ...
        public InLine.Model.Data.DrzavaValuta FindID(long id)
        {
    		InLine.Model.Data.DrzavaValuta rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.DrzavaValuta> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.DrzavaValuta> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.DrzavaValuta> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.DrzavaValuta> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.DrzavaValuta(korisnik_data);
                }
    			else
                {
