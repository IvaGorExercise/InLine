...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ZupanijaGrController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IZupanijaGr _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ZupanijaGrItem item)
    	{
    		
    		if (item.ID_ZupanijaGr == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ZupanijaGrItem item)
    	{
        ...
        public InLine.Model.Data.ZupanijaGr FindID(long id)
        {
    		InLine.Model.Data.ZupanijaGr rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ZupanijaGr> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ZupanijaGr> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ZupanijaGr> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ZupanijaGr> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ZupanijaGr(korisnik_data);
                }
    			else
                {
