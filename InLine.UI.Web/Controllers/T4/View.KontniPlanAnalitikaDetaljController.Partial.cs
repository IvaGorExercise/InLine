...
namespace InLine.UI.Web.Controllers.View
{
    ...
    public partial class KontniPlanAnalitikaDetaljViewController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.View.IKontniPlanAnalitikaDetalj _service;
        ...
        public InLine.Model.Data.View.KontniPlanAnalitikaDetalj FindID(long id)
        {
    		InLine.Model.Data.View.KontniPlanAnalitikaDetalj rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.View.KontniPlanAnalitikaDetalj> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.View.KontniPlanAnalitikaDetalj> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.View.KontniPlanAnalitikaDetalj> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.View.KontniPlanAnalitikaDetalj> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.View.KontniPlanAnalitikaDetalj(korisnik_data);
                }
    			else
                {
