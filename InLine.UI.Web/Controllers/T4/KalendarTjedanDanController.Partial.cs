...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class KalendarTjedanDanController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IKalendarTjedanDan _service;
        ...
        public InLine.Model.Data.KalendarTjedanDan FindID(long id)
        {
    		InLine.Model.Data.KalendarTjedanDan rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.KalendarTjedanDan> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.KalendarTjedanDan> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.KalendarTjedanDan> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.KalendarTjedanDan> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.KalendarTjedanDan(korisnik_data);
                }
    			else
                {
