...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class OpomenaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IOpomena _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.OpomenaItem item)
    	{
    		
    		if (item.ID_Opomena == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.OpomenaItem item)
    	{
        ...
        public InLine.Model.Data.Opomena FindID(long id)
        {
    		InLine.Model.Data.Opomena rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.Opomena> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.Opomena> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.Opomena> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.Opomena> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.Opomena(korisnik_data);
                }
    			else
                {
