...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class RacunIzlazKontniPlanController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IRacunIzlazKontniPlan _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.RacunIzlazKontniPlanItem item)
    	{
    		
    		if (item.ID_RacunIzlazKontniPlan == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.RacunIzlazKontniPlanItem item)
    	{
        ...
        public InLine.Model.Data.RacunIzlazKontniPlan FindID(long id)
        {
    		InLine.Model.Data.RacunIzlazKontniPlan rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.RacunIzlazKontniPlan> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.RacunIzlazKontniPlan> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.RacunIzlazKontniPlan> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.RacunIzlazKontniPlan> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_RacunIzlazKontniPlan";
            }
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.RacunIzlazKontniPlan(korisnik_data);
                }
    			else
                {
