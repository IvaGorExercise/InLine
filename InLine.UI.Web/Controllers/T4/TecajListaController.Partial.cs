...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class TecajListaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.ITecajLista _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.TecajListaItem item)
    	{
    		
    		if (item.ID_TecajLista == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.TecajListaItem item)
    	{
        ...
        public InLine.Model.Data.TecajLista FindID(long id)
        {
    		InLine.Model.Data.TecajLista rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.TecajLista> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.TecajLista> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.TecajLista> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.TecajLista> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "GodinaRedniBroj")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.TecajLista(korisnik_data);
                }
    			else
                {
