...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class PoreznaUpravaIspostavaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IPoreznaUpravaIspostava _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.PoreznaUpravaIspostavaItem item)
    	{
    		
    		if (item.ID_PoreznaUpravaIspostava == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.PoreznaUpravaIspostavaItem item)
    	{
        ...
        public InLine.Model.Data.PoreznaUpravaIspostava FindID(long id)
        {
    		InLine.Model.Data.PoreznaUpravaIspostava rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.PoreznaUpravaIspostava> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.PoreznaUpravaIspostava> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.PoreznaUpravaIspostava> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.PoreznaUpravaIspostava> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_PoreznaUpravaIspostava";
            }
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.PoreznaUpravaIspostava(korisnik_data);
                }
    			else
                {
