...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class OsobaPrebivalisteController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IOsobaPrebivaliste _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.OsobaPrebivalisteItem item)
    	{
    		
    		if (item.ID_OsobaPrebivaliste == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.OsobaPrebivalisteItem item)
    	{
        ...
        public InLine.Model.Data.OsobaPrebivaliste FindID(long id)
        {
    		InLine.Model.Data.OsobaPrebivaliste rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.OsobaPrebivaliste> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.OsobaPrebivaliste> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.OsobaPrebivaliste> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.OsobaPrebivaliste> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_OsobaPrebivaliste";
            }
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_OsobaPrebivaliste")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.OsobaPrebivaliste(korisnik_data);
                }
    			else
                {
