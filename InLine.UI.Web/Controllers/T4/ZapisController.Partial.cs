...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ZapisController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IZapis _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ZapisItem item)
    	{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ZapisItem item)
    	{
        ...
        public InLine.Model.Data.Zapis FindID(long id)
        {
    		InLine.Model.Data.Zapis rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.Zapis> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.Zapis> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.Zapis> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.Zapis> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.Zapis(korisnik_data);
                }
    			else
                {
