...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class HUBController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IHUB _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.HUBItem item)
    	{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.HUBItem item)
    	{
        ...
        public InLine.Model.Data.HUB FindID(long id)
        {
    		InLine.Model.Data.HUB rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.HUB> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.HUB> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.HUB> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.HUB> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.HUB(korisnik_data);
                }
    			else
                {
