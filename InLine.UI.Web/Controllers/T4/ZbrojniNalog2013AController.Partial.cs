...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ZbrojniNalog2013AController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IZbrojniNalog2013A _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ZbrojniNalog2013AItem item)
    	{
    		
    		if (item.ID_ZbrojniNalog2013A == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ZbrojniNalog2013AItem item)
    	{
        ...
        public InLine.Model.Data.ZbrojniNalog2013A FindID(long id)
        {
    		InLine.Model.Data.ZbrojniNalog2013A rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ZbrojniNalog2013A> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ZbrojniNalog2013A> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ZbrojniNalog2013A> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ZbrojniNalog2013A> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_ZbrojniNalog2013A";
            }
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "IDHUBNalogVrsta2013A")
    				{
    					...
    					if (searchingName == "IDHUBDokumentIzvor2013A")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    				...
    				if (searchingName == "Predan")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    				if (searchingName == "Izvrsen")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    				...
    				if (searchingName == "IDValutaPlacanje")
    			{
    				...
    				if (searchingName == "IDValutaNaknada")
    			{
    				...
    				if (searchingName == "RacunPlatitelj")
    			{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ZbrojniNalog2013A(korisnik_data);
                }
    			else
                {
