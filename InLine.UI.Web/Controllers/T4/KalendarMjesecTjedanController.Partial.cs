...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class KalendarMjesecTjedanController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IKalendarMjesecTjedan _service;
        ...
        public InLine.Model.Data.KalendarMjesecTjedan FindID(long id)
        {
    		InLine.Model.Data.KalendarMjesecTjedan rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.KalendarMjesecTjedan> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.KalendarMjesecTjedan> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.KalendarMjesecTjedan> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.KalendarMjesecTjedan> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.KalendarMjesecTjedan(korisnik_data);
                }
    			else
                {
