...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class UgovorStanOtkupOpomenaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IUgovorStanOtkupOpomena _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.UgovorStanOtkupOpomenaItem item)
    	{
    		
    		if (item.ID_UgovorStanOtkupOpomena == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.UgovorStanOtkupOpomenaItem item)
    	{
        ...
        public InLine.Model.Data.UgovorStanOtkupOpomena FindID(long id)
        {
    		InLine.Model.Data.UgovorStanOtkupOpomena rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.UgovorStanOtkupOpomena> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.UgovorStanOtkupOpomena> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.UgovorStanOtkupOpomena> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.UgovorStanOtkupOpomena> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.UgovorStanOtkupOpomena(korisnik_data);
                }
    			else
                {
