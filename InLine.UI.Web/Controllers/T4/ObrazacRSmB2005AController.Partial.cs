...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ObrazacRSmB2005AController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IObrazacRSmB2005A _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ObrazacRSmB2005AItem item)
    	{
    		
    		if (item.ID_ObrazacRSmB2005A == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ObrazacRSmB2005AItem item)
    	{
        ...
        public InLine.Model.Data.ObrazacRSmB2005A FindID(long id)
        {
    		InLine.Model.Data.ObrazacRSmB2005A rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ObrazacRSmB2005A> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ObrazacRSmB2005A> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ObrazacRSmB2005A> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ObrazacRSmB2005A> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_ObrazacRSmB2005A")
    				{
    				...
    				if (searchingName == "ObrazacRSm2005OsnovaOsiguranja")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    				...
    				if (searchingName == "ObrazacRSm2005StazSPovecanimTrajanjem")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    				...
    				if (searchingName == "OsiguranikIdentifikacijskiBroj")
    			{
    				...
    				if (searchingName == "OsiguranikPrezime")
    			{
    				...
    				if (searchingName == "OsiguranikIme")
    			{
    				...
    				if (searchingName == "SifraOpcina")
    			{
    				...
    				if (searchingName == "OsnovaOsiguranja")
    			{
    				...
    				if (searchingName == "StazSPovecanimTrajanjem")
    			{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ObrazacRSmB2005A(korisnik_data);
                }
    			else
                {
