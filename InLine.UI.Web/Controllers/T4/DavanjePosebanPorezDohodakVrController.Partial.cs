...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class DavanjePosebanPorezDohodakVrController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IDavanjePosebanPorezDohodakVr _service;
        ...
        public InLine.Model.Data.DavanjePosebanPorezDohodakVr FindID(long id)
        {
    		InLine.Model.Data.DavanjePosebanPorezDohodakVr rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.DavanjePosebanPorezDohodakVr> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.DavanjePosebanPorezDohodakVr> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.DavanjePosebanPorezDohodakVr> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.DavanjePosebanPorezDohodakVr> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "IDDavanjePosebanPorezDohodakVr";
            }
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "IDDavanjePosebanPorezDohodakVr")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.DavanjePosebanPorezDohodakVr(korisnik_data);
                }
    			else
                {
