...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ObjektVrController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IObjektVr _service;
        ...
        public InLine.Model.Data.ObjektVr FindID(long id)
        {
    		InLine.Model.Data.ObjektVr rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ObjektVr> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ObjektVr> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ObjektVr> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ObjektVr> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ObjektVr(korisnik_data);
                }
    			else
                {
