...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class HUBKontrolaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IHUBKontrola _service;
        ...
        public InLine.Model.Data.HUBKontrola FindID(long id)
        {
    		InLine.Model.Data.HUBKontrola rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.HUBKontrola> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.HUBKontrola> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.HUBKontrola> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.HUBKontrola> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.HUBKontrola(korisnik_data);
                }
    			else
                {
