...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class KalendarGodinaKvartalController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IKalendarGodinaKvartal _service;
        ...
        public InLine.Model.Data.KalendarGodinaKvartal FindID(long id)
        {
    		InLine.Model.Data.KalendarGodinaKvartal rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.KalendarGodinaKvartal> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.KalendarGodinaKvartal> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.KalendarGodinaKvartal> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.KalendarGodinaKvartal> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.KalendarGodinaKvartal(korisnik_data);
                }
    			else
                {
