...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ObrazacIP2011AController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IObrazacIP2011A _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ObrazacIP2011AItem item)
    	{
    		
    		if (item.ID_ObrazacIP2011A == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ObrazacIP2011AItem item)
    	{
        ...
        public InLine.Model.Data.ObrazacIP2011A FindID(long id)
        {
    		InLine.Model.Data.ObrazacIP2011A rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_ObrazacIP2011A")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ObrazacIP2011A(korisnik_data);
                }
    			else
                {
