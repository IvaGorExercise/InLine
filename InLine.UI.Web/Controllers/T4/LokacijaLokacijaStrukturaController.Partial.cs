...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class LokacijaLokacijaStrukturaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.ILokacijaLokacijaStruktura _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.LokacijaLokacijaStrukturaItem item)
    	{
    		
    		if (item.ID_LokacijaLokacijaStruktura == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.LokacijaLokacijaStrukturaItem item)
    	{
        ...
        public InLine.Model.Data.LokacijaLokacijaStruktura FindID(long id)
        {
    		InLine.Model.Data.LokacijaLokacijaStruktura rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.LokacijaLokacijaStruktura> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.LokacijaLokacijaStruktura> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.LokacijaLokacijaStruktura> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.LokacijaLokacijaStruktura> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_LokacijaLokacijaStruktura";
            }
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.LokacijaLokacijaStruktura(korisnik_data);
                }
    			else
                {
