...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class DohodakDavanjeController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IDohodakDavanje _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.DohodakDavanjeItem item)
    	{
    		
    		if (item.ID_DohodakDavanje == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.DohodakDavanjeItem item)
    	{
        ...
        public InLine.Model.Data.DohodakDavanje FindID(long id)
        {
    		InLine.Model.Data.DohodakDavanje rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.DohodakDavanje> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.DohodakDavanje> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.DohodakDavanje> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.DohodakDavanje> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_DohodakDavanje")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.DohodakDavanje(korisnik_data);
                }
    			else
                {
