...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ObjektGrController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IObjektGr _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ObjektGrItem item)
    	{
    		
    		if (item.ID_ObjektGr == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ObjektGrItem item)
    	{
        ...
        public InLine.Model.Data.ObjektGr FindID(long id)
        {
    		InLine.Model.Data.ObjektGr rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ObjektGr> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ObjektGr> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ObjektGr> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ObjektGr> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ObjektGr(korisnik_data);
                }
    			else
                {
