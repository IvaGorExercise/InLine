...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class SubjektTelefonController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.ISubjektTelefon _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.SubjektTelefonItem item)
    	{
    		
    		if (item.ID_SubjektTelefon == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.SubjektTelefonItem item)
    	{
        ...
        public InLine.Model.Data.SubjektTelefon FindID(long id)
        {
    		InLine.Model.Data.SubjektTelefon rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.SubjektTelefon> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.SubjektTelefon> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.SubjektTelefon> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.SubjektTelefon> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_SubjektTelefon")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.SubjektTelefon(korisnik_data);
                }
    			else
                {
