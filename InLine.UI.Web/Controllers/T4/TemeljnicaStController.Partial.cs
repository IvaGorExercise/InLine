...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class TemeljnicaStController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.ITemeljnicaSt _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.TemeljnicaStItem item)
    	{
    		
    		if (item.ID_TemeljnicaSt == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.TemeljnicaStItem item)
    	{
        ...
        public InLine.Model.Data.TemeljnicaSt FindID(long id)
        {
    		InLine.Model.Data.TemeljnicaSt rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.TemeljnicaSt> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.TemeljnicaSt> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.TemeljnicaSt> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.TemeljnicaSt> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.TemeljnicaSt(korisnik_data);
                }
    			else
                {
