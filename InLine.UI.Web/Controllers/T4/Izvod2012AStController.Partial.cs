...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class Izvod2012AStController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IIzvod2012ASt _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.Izvod2012AStItem item)
    	{
    		
    		if (item.ID_Izvod2012ASt == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.Izvod2012AStItem item)
    	{
        ...
        public InLine.Model.Data.Izvod2012ASt FindID(long id)
        {
    		InLine.Model.Data.Izvod2012ASt rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.Izvod2012ASt> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.Izvod2012ASt> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.Izvod2012ASt> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.Izvod2012ASt> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.Izvod2012ASt(korisnik_data);
                }
    			else
                {
