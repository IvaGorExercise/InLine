...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ZbrojniNalogVerzijaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IZbrojniNalogVerzija _service;
        ...
        public InLine.Model.Data.ZbrojniNalogVerzija FindID(long id)
        {
    		InLine.Model.Data.ZbrojniNalogVerzija rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ZbrojniNalogVerzija> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ZbrojniNalogVerzija> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ZbrojniNalogVerzija> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ZbrojniNalogVerzija> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "IDZbrojniNalogVerzija";
            }
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ZbrojniNalogVerzija(korisnik_data);
                }
    			else
                {
