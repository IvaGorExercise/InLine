...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class KnjigaOSController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IKnjigaOS _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.KnjigaOSItem item)
    	{
    		
    		if (item.ID_KnjigaOS == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.KnjigaOSItem item)
    	{
        ...
        public InLine.Model.Data.KnjigaOS FindID(long id)
        {
    		InLine.Model.Data.KnjigaOS rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.KnjigaOS> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.KnjigaOS> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.KnjigaOS> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.KnjigaOS> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.KnjigaOS(korisnik_data);
                }
    			else
                {
