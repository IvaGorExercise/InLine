...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class PrimitakProsjekIznosController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IPrimitakProsjekIznos _service;
        ...
        public InLine.Model.Data.PrimitakProsjekIznos FindID(long id)
        {
    		InLine.Model.Data.PrimitakProsjekIznos rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.PrimitakProsjekIznos> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.PrimitakProsjekIznos> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.PrimitakProsjekIznos> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.PrimitakProsjekIznos> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "IDPrimitakProsjekIznos";
            }
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "IDPrimitakProsjekIznos")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.PrimitakProsjekIznos(korisnik_data);
                }
    			else
                {
