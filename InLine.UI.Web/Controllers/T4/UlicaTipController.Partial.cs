...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class UlicaTipController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IUlicaTip _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.UlicaTipItem item)
    	{
    		
    		if (item.ID_UlicaTip == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.UlicaTipItem item)
    	{
        ...
        public InLine.Model.Data.UlicaTip FindID(long id)
        {
    		InLine.Model.Data.UlicaTip rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.UlicaTip> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.UlicaTip> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.UlicaTip> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.UlicaTip> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.UlicaTip(korisnik_data);
                }
    			else
                {
