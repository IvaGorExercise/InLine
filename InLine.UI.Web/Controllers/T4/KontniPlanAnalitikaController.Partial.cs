...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class KontniPlanAnalitikaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IKontniPlanAnalitika _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.KontniPlanAnalitikaItem item)
    	{
    		
    		if (item.ID_KontniPlanAnalitika == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.KontniPlanAnalitikaItem item)
    	{
        ...
        public InLine.Model.Data.KontniPlanAnalitika FindID(long id)
        {
    		InLine.Model.Data.KontniPlanAnalitika rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.KontniPlanAnalitika> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.KontniPlanAnalitika> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.KontniPlanAnalitika> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.KontniPlanAnalitika> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_KontniPlanAnalitika";
            }
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.KontniPlanAnalitika(korisnik_data);
                }
    			else
                {
