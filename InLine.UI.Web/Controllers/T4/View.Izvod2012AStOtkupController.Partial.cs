...
namespace InLine.UI.Web.Controllers.View
{
    ...
    public partial class Izvod2012AStOtkupViewController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.View.IIzvod2012AStOtkup _service;
        ...
        public InLine.Model.Data.View.Izvod2012AStOtkup FindID(long id)
        {
    		InLine.Model.Data.View.Izvod2012AStOtkup rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.View.Izvod2012AStOtkup> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.View.Izvod2012AStOtkup> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.View.Izvod2012AStOtkup> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.View.Izvod2012AStOtkup> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    				...
    				if (searchingName == "IdentifikatorTransakcije")
    			{
    				...
    				if (searchingName == "Izvod2012ATransakcijaVrNaziv")
    			{
    				...
    				if (searchingName == "HUBNamjena2013AOznaka")
    			{
    				...
    				if (searchingName == "HUBNamjena2013ANaziv")
    			{
    				...
    				if (searchingName == "HUBNamjena2013ANazivKr")
    			{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.View.Izvod2012AStOtkup(korisnik_data);
                }
    			else
                {
