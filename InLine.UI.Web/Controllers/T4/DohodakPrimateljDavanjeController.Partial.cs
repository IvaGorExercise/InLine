...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class DohodakPrimateljDavanjeController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IDohodakPrimateljDavanje _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.DohodakPrimateljDavanjeItem item)
    	{
    		
    		if (item.ID_DohodakPrimateljDavanje == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.DohodakPrimateljDavanjeItem item)
    	{
        ...
        public InLine.Model.Data.DohodakPrimateljDavanje FindID(long id)
        {
    		InLine.Model.Data.DohodakPrimateljDavanje rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.DohodakPrimateljDavanje> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.DohodakPrimateljDavanje> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.DohodakPrimateljDavanje> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.DohodakPrimateljDavanje> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_DohodakPrimateljDavanje";
            }
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_DohodakPrimateljDavanje")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.DohodakPrimateljDavanje(korisnik_data);
                }
    			else
                {
