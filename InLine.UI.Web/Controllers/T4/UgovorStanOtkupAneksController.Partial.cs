...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class UgovorStanOtkupAneksController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IUgovorStanOtkupAneks _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.UgovorStanOtkupAneksItem item)
    	{
    		
    		if (item.ID_UgovorStanOtkupAneks == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.UgovorStanOtkupAneksItem item)
    	{
        ...
        public InLine.Model.Data.UgovorStanOtkupAneks FindID(long id)
        {
    		InLine.Model.Data.UgovorStanOtkupAneks rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.UgovorStanOtkupAneks> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.UgovorStanOtkupAneks> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.UgovorStanOtkupAneks> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.UgovorStanOtkupAneks> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_UgovorStanOtkupAneks";
            }
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.UgovorStanOtkupAneks(korisnik_data);
                }
    			else
                {
