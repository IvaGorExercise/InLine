...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class SubjektController : Controller
    {
    	...
    	#region Fields
    	 ...
    	 Service.Data.ISubjekt _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.SubjektItem item)
    	{
    		
    		if (item.ID_Subjekt == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.SubjektItem item)
    	{
        ...
        public InLine.Model.Data.Subjekt FindID(long id)
        {
    		InLine.Model.Data.Subjekt rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.Subjekt> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.Subjekt> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.Subjekt> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.Subjekt> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.Subjekt(korisnik_data);
                }
    			else
                {
