...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class DokumentGrController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IDokumentGr _service;
        ...
        public InLine.Model.Data.DokumentGr FindID(long id)
        {
    		InLine.Model.Data.DokumentGr rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.DokumentGr> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.DokumentGr> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.DokumentGr> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.DokumentGr> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.DokumentGr(korisnik_data);
                }
    			else
                {
