...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class IzvodController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IIzvod _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.IzvodItem item)
    	{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.IzvodItem item)
    	{
        ...
        public InLine.Model.Data.Izvod FindID(long id)
        {
    		InLine.Model.Data.Izvod rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.Izvod> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.Izvod> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.Izvod> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.Izvod> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.Izvod(korisnik_data);
                }
    			else
                {
