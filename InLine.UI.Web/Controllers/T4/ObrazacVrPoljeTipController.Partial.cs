...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ObrazacVrPoljeTipController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IObrazacVrPoljeTip _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ObrazacVrPoljeTipItem item)
    	{
    		
    		if (item.ID_ObrazacVrPoljeTip == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ObrazacVrPoljeTipItem item)
    	{
        ...
        public InLine.Model.Data.ObrazacVrPoljeTip FindID(long id)
        {
    		InLine.Model.Data.ObrazacVrPoljeTip rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ObrazacVrPoljeTip> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ObrazacVrPoljeTip> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ObrazacVrPoljeTip> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ObrazacVrPoljeTip> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_ObrazacVrPoljeTip";
            }
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_ObrazacVrPoljeTip")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ObrazacVrPoljeTip(korisnik_data);
                }
    			else
                {
