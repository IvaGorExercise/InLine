...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class DohodakPrimateljKoeficijentController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IDohodakPrimateljKoeficijent _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.DohodakPrimateljKoeficijentItem item)
    	{
    		
    		if (item.ID_DohodakPrimateljKoeficijent == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.DohodakPrimateljKoeficijentItem item)
    	{
        ...
        public InLine.Model.Data.DohodakPrimateljKoeficijent FindID(long id)
        {
    		InLine.Model.Data.DohodakPrimateljKoeficijent rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.DohodakPrimateljKoeficijent> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.DohodakPrimateljKoeficijent> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.DohodakPrimateljKoeficijent> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.DohodakPrimateljKoeficijent> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_DohodakPrimateljKoeficijent";
            }
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_DohodakPrimateljKoeficijent")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.DohodakPrimateljKoeficijent(korisnik_data);
                }
    			else
                {
