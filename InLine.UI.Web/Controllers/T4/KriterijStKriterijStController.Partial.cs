...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class KriterijStKriterijStController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IKriterijStKriterijSt _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.KriterijStKriterijStItem item)
    	{
    		
    		if (item.ID_KriterijStKriterijSt == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.KriterijStKriterijStItem item)
    	{
        ...
        public InLine.Model.Data.KriterijStKriterijSt FindID(long id)
        {
    		InLine.Model.Data.KriterijStKriterijSt rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.KriterijStKriterijSt> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.KriterijStKriterijSt> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.KriterijStKriterijSt> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.KriterijStKriterijSt> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_KriterijStKriterijSt";
            }
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_KriterijStKriterijSt")
    				{
    				...
    				if (searchingName == "ID_KriterijStNad")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.KriterijStKriterijSt(korisnik_data);
                }
    			else
                {
