...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class DavanjePorezDohodakVrController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IDavanjePorezDohodakVr _service;
        ...
        public InLine.Model.Data.DavanjePorezDohodakVr FindID(long id)
        {
    		InLine.Model.Data.DavanjePorezDohodakVr rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.DavanjePorezDohodakVr> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.DavanjePorezDohodakVr> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.DavanjePorezDohodakVr> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.DavanjePorezDohodakVr> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "IDDavanjePorezDohodakVr";
            }
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "IDDavanjePorezDohodakVr")
    				{
    				...
    				if (searchingName == "OsobniOdbitak")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.DavanjePorezDohodakVr(korisnik_data);
                }
    			else
                {
