...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class PrimitakProsjekIzracunController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IPrimitakProsjekIzracun _service;
        ...
        public InLine.Model.Data.PrimitakProsjekIzracun FindID(long id)
        {
    		InLine.Model.Data.PrimitakProsjekIzracun rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.PrimitakProsjekIzracun> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.PrimitakProsjekIzracun> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.PrimitakProsjekIzracun> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.PrimitakProsjekIzracun> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "IDPrimitakProsjekIzracun";
            }
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "IDPrimitakProsjekIzracun")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.PrimitakProsjekIzracun(korisnik_data);
                }
    			else
                {
