...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class OsnovnoSredstvoDogadajController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IOsnovnoSredstvoDogadaj _service;
        ...
        public InLine.Model.Data.OsnovnoSredstvoDogadaj FindID(long id)
        {
    		InLine.Model.Data.OsnovnoSredstvoDogadaj rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.OsnovnoSredstvoDogadaj> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.OsnovnoSredstvoDogadaj> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.OsnovnoSredstvoDogadaj> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.OsnovnoSredstvoDogadaj> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "IDOsnovnoSredstvoDogadaj";
            }
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.OsnovnoSredstvoDogadaj(korisnik_data);
                }
    			else
                {
