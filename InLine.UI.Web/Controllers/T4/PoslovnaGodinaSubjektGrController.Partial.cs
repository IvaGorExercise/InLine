...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class PoslovnaGodinaSubjektGrController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IPoslovnaGodinaSubjektGr _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.PoslovnaGodinaSubjektGrItem item)
    	{
    		
    		if (item.ID_PoslovnaGodinaSubjektGr == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.PoslovnaGodinaSubjektGrItem item)
    	{
        ...
        public InLine.Model.Data.PoslovnaGodinaSubjektGr FindID(long id)
        {
    		InLine.Model.Data.PoslovnaGodinaSubjektGr rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.PoslovnaGodinaSubjektGr> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.PoslovnaGodinaSubjektGr> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.PoslovnaGodinaSubjektGr> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.PoslovnaGodinaSubjektGr> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_PoslovnaGodinaSubjektGr";
            }
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.PoslovnaGodinaSubjektGr(korisnik_data);
                }
    			else
                {
