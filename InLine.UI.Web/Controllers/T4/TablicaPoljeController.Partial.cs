...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class TablicaPoljeController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.ITablicaPolje _service;
        ...
        public InLine.Model.Data.TablicaPolje FindID(long id)
        {
    		InLine.Model.Data.TablicaPolje rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.TablicaPolje> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.TablicaPolje> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.TablicaPolje> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.TablicaPolje> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.TablicaPolje(korisnik_data);
                }
    			else
                {
