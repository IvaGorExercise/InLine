...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class OpcinaTipController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IOpcinaTip _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.OpcinaTipItem item)
    	{
    		
    		if (item.ID_OpcinaTip == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.OpcinaTipItem item)
    	{
        ...
        public InLine.Model.Data.OpcinaTip FindID(long id)
        {
    		InLine.Model.Data.OpcinaTip rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.OpcinaTip> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.OpcinaTip> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.OpcinaTip> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.OpcinaTip> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.OpcinaTip(korisnik_data);
                }
    			else
                {
