...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class DatotekaVrPoljeTipController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IDatotekaVrPoljeTip _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.DatotekaVrPoljeTipItem item)
    	{
    		
    		if (item.ID_DatotekaVrPoljeTip == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.DatotekaVrPoljeTipItem item)
    	{
        ...
        public InLine.Model.Data.DatotekaVrPoljeTip FindID(long id)
        {
    		InLine.Model.Data.DatotekaVrPoljeTip rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.DatotekaVrPoljeTip> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.DatotekaVrPoljeTip> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.DatotekaVrPoljeTip> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.DatotekaVrPoljeTip> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_DatotekaVrPoljeTip";
            }
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.DatotekaVrPoljeTip(korisnik_data);
                }
    			else
                {
