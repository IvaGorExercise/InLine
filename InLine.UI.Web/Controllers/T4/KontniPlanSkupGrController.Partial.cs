...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class KontniPlanSkupGrController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IKontniPlanSkupGr _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.KontniPlanSkupGrItem item)
    	{
    		
    		if (item.ID_KontniPlanSkupGr == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.KontniPlanSkupGrItem item)
    	{
        ...
        public InLine.Model.Data.KontniPlanSkupGr FindID(long id)
        {
    		InLine.Model.Data.KontniPlanSkupGr rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.KontniPlanSkupGr> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.KontniPlanSkupGr> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.KontniPlanSkupGr> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.KontniPlanSkupGr> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.KontniPlanSkupGr(korisnik_data);
                }
    			else
                {
