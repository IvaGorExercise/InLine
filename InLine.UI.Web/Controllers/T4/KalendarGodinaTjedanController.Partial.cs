...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class KalendarGodinaTjedanController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IKalendarGodinaTjedan _service;
        ...
        public InLine.Model.Data.KalendarGodinaTjedan FindID(long id)
        {
    		InLine.Model.Data.KalendarGodinaTjedan rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.KalendarGodinaTjedan> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.KalendarGodinaTjedan> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.KalendarGodinaTjedan> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.KalendarGodinaTjedan> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.KalendarGodinaTjedan(korisnik_data);
                }
    			else
                {
