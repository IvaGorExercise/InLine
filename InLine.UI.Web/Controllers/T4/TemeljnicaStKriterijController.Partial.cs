...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class TemeljnicaStKriterijController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.ITemeljnicaStKriterij _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.TemeljnicaStKriterijItem item)
    	{
    		
    		if (item.ID_TemeljnicaStKriterij == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.TemeljnicaStKriterijItem item)
    	{
        ...
        public InLine.Model.Data.TemeljnicaStKriterij FindID(long id)
        {
    		InLine.Model.Data.TemeljnicaStKriterij rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.TemeljnicaStKriterij> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.TemeljnicaStKriterij> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.TemeljnicaStKriterij> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.TemeljnicaStKriterij> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_TemeljnicaStKriterij";
            }
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_TemeljnicaStKriterij")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.TemeljnicaStKriterij(korisnik_data);
                }
    			else
                {
