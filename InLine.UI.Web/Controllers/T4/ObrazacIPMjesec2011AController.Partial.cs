...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ObrazacIPMjesec2011AController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IObrazacIPMjesec2011A _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ObrazacIPMjesec2011AItem item)
    	{
    		
    		if (item.ID_ObrazacIPMjesec2011A == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ObrazacIPMjesec2011AItem item)
    	{
        ...
        public InLine.Model.Data.ObrazacIPMjesec2011A FindID(long id)
        {
    		InLine.Model.Data.ObrazacIPMjesec2011A rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ObrazacIPMjesec2011A> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ObrazacIPMjesec2011A> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ObrazacIPMjesec2011A> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ObrazacIPMjesec2011A> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_ObrazacIPMjesec2011A";
            }
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ObrazacIPMjesec2011A(korisnik_data);
                }
    			else
                {
