...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ObrazacID2009AController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IObrazacID2009A _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ObrazacID2009AItem item)
    	{
    		
    		if (item.ID_ObrazacID2009A == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ObrazacID2009AItem item)
    	{
        ...
        public InLine.Model.Data.ObrazacID2009A FindID(long id)
        {
    		InLine.Model.Data.ObrazacID2009A rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ObrazacID2009A> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ObrazacID2009A> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ObrazacID2009A> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ObrazacID2009A> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_ObrazacID2009A")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    				if (searchingName == "ID_ObrazacID")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    				
    				if (searchingName == "IDObrazacIDIdentifikator2009A")
    				{
    				...
    				if (searchingName == "BrojPrimatelja")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    				...
    				if (searchingName == "BrojOsiguranihOsoba")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    				...
    				if (searchingName == "IsplataPrimitak")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    				...
    				if (searchingName == "UplataDoprinos")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    				...
    				if (searchingName == "UplataDoprinosIz")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    				...
    				if (searchingName == "UplataDoprinosMIO1")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    				...
    				if (searchingName == "UplataDoprinosMIO2")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    				...
    				if (searchingName == "UplataDoprinosOstaloIz")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    				...
    				if (searchingName == "UplataOsiguranje")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    				...
    				if (searchingName == "UplataOsiguranjeZivotno")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    				...
    				if (searchingName == "UplataOsiguranjeZdravstvo")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    				...
    				if (searchingName == "UplataOsiguranjeMIO")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    				...
    				if (searchingName == "UplataDohodak")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    				...
    				if (searchingName == "UplataOsobniOdbitak")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    				...
    				if (searchingName == "UplataPoreznaOsnova")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    				...
    				if (searchingName == "ObracunPorezPrirez")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    				...
    				if (searchingName == "ObracunPrirez")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    				...
    				if (searchingName == "UplataPorezPrirez")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    				...
    				if (searchingName == "ObracunDoprinosMIO1")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    				...
    				if (searchingName == "ObracunDoprinosStaz1")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    				...
    				if (searchingName == "ObracunDoprinosMIO2")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    				...
    				if (searchingName == "ObracunDoprinosStaz2")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    				...
    				if (searchingName == "ObracunDoprinosZdravstvo")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    				...
    				if (searchingName == "ObracunDoprinosZdravstvoRad")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    				...
    				if (searchingName == "ObracunDoprinosZdravstvoIno")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    				...
    				if (searchingName == "ObracunDoprinosZaposljavanje")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    				...
    				if (searchingName == "ObracunDoprinosZaposljavanjeInv")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ObrazacID2009A(korisnik_data);
                }
    			else
                {
