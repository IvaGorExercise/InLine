...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class IzvodTemeljnicaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IIzvodTemeljnica _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.IzvodTemeljnicaItem item)
    	{
    		
    		if (item.ID_IzvodTemeljnica == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.IzvodTemeljnicaItem item)
    	{
        ...
        public InLine.Model.Data.IzvodTemeljnica FindID(long id)
        {
    		InLine.Model.Data.IzvodTemeljnica rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.IzvodTemeljnica> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.IzvodTemeljnica> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.IzvodTemeljnica> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.IzvodTemeljnica> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_IzvodTemeljnica")
    				{
    				...
    				if (searchingName == "TemeljnicaStatus")
    			{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.IzvodTemeljnica(korisnik_data);
                }
    			else
                {
