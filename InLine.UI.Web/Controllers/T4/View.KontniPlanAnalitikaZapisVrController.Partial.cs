...
namespace InLine.UI.Web.Controllers.View
{
    ...
    public partial class KontniPlanAnalitikaZapisVrViewController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.View.IKontniPlanAnalitikaZapisVr _service;
        ...
        public InLine.Model.Data.View.KontniPlanAnalitikaZapisVr FindID(long id)
        {
    		InLine.Model.Data.View.KontniPlanAnalitikaZapisVr rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.View.KontniPlanAnalitikaZapisVr> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.View.KontniPlanAnalitikaZapisVr> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.View.KontniPlanAnalitikaZapisVr> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.View.KontniPlanAnalitikaZapisVr> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_KontniPlanAnalitika")
    				{
    				...
    				if (searchingName == "Kratica")
    			{
    				...
    				if (searchingName == "OznakaKontniPlanAnalitika")
    			{
    				...
    				if (searchingName == "NazivKontniPlanAnalitika")
    			{
    				...
    				if (searchingName == "NazivKrKontniPlanAnalitika")
    			{
    				...
    				if (searchingName == "KraticaKontniPlanAnalitika")
    			{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.View.KontniPlanAnalitikaZapisVr(korisnik_data);
                }
    			else
                {
