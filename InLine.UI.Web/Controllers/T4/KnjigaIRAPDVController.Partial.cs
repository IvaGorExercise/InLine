...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class KnjigaIRAPDVController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IKnjigaIRAPDV _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.KnjigaIRAPDVItem item)
    	{
    		
    		if (item.ID_KnjigaIRAPDV == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.KnjigaIRAPDVItem item)
    	{
        ...
        public InLine.Model.Data.KnjigaIRAPDV FindID(long id)
        {
    		InLine.Model.Data.KnjigaIRAPDV rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.KnjigaIRAPDV> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.KnjigaIRAPDV> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.KnjigaIRAPDV> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.KnjigaIRAPDV> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_KnjigaIRAPDV")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.KnjigaIRAPDV(korisnik_data);
                }
    			else
                {
