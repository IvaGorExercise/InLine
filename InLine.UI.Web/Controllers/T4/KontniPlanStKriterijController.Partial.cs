...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class KontniPlanStKriterijController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IKontniPlanStKriterij _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.KontniPlanStKriterijItem item)
    	{
    		
    		if (item.ID_KontniPlanStKriterij == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.KontniPlanStKriterijItem item)
    	{
        ...
        public InLine.Model.Data.KontniPlanStKriterij FindID(long id)
        {
    		InLine.Model.Data.KontniPlanStKriterij rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.KontniPlanStKriterij> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.KontniPlanStKriterij> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.KontniPlanStKriterij> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.KontniPlanStKriterij> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_KontniPlanStKriterij";
            }
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_KontniPlanStKriterij")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.KontniPlanStKriterij(korisnik_data);
                }
    			else
                {
