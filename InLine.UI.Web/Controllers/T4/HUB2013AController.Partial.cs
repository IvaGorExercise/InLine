...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class HUB2013AController : Controller
    {
    	...
    	#region Fields
    	 ...
    	 Service.Data.IHUB2013A _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.HUB2013AItem item)
    	{
    		
    		if (item.ID_HUB2013A == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.HUB2013AItem item)
    	{
        ...
        public InLine.Model.Data.HUB2013A FindID(long id)
        {
    		InLine.Model.Data.HUB2013A rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.HUB2013A> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.HUB2013A> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.HUB2013A> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.HUB2013A> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.HUB2013A(korisnik_data);
                }
    			else
                {
