...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ZupanijaGrZupanijaDatumController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IZupanijaGrZupanijaDatum _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ZupanijaGrZupanijaDatumItem item)
    	{
    		
    		if (item.ID_ZupanijaGrZupanijaDatum == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ZupanijaGrZupanijaDatumItem item)
    	{
        ...
        public InLine.Model.Data.ZupanijaGrZupanijaDatum FindID(long id)
        {
    		InLine.Model.Data.ZupanijaGrZupanijaDatum rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ZupanijaGrZupanijaDatum> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ZupanijaGrZupanijaDatum> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ZupanijaGrZupanijaDatum> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ZupanijaGrZupanijaDatum> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_ZupanijaGrZupanijaDatum";
            }
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_ZupanijaGrZupanijaDatum")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    				if (searchingName == "ID_ZupanijaGrZupanija")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ZupanijaGrZupanijaDatum(korisnik_data);
                }
    			else
                {
