...
namespace InLine.UI.Web.Controllers.View
{
    ...
    public partial class KontniPlanAnalitikaViewController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.View.IKontniPlanAnalitika _service;
        ...
        public InLine.Model.Data.View.KontniPlanAnalitika FindID(long id)
        {
    		InLine.Model.Data.View.KontniPlanAnalitika rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.View.KontniPlanAnalitika> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.View.KontniPlanAnalitika> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.View.KontniPlanAnalitika> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.View.KontniPlanAnalitika> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    				...
    				if (searchingName == "ZapisVrNaziv")
    			{
    				...
    				if (searchingName == "ZapisVrNazivKr")
    			{
    				...
    				if (searchingName == "ZapisVrKratica")
    			{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.View.KontniPlanAnalitika(korisnik_data);
                }
    			else
                {
