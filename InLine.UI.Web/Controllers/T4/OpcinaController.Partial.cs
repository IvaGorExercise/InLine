...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class OpcinaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IOpcina _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.OpcinaItem item)
    	{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.OpcinaItem item)
    	{
        ...
        public InLine.Model.Data.Opcina FindID(long id)
        {
    		InLine.Model.Data.Opcina rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.Opcina> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.Opcina> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.Opcina> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.Opcina> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.Opcina(korisnik_data);
                }
    			else
                {
