...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class TablicaPoljeUIController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.ITablicaPoljeUI _service;
        ...
        public InLine.Model.Data.TablicaPoljeUI FindID(long id)
        {
    		InLine.Model.Data.TablicaPoljeUI rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.TablicaPoljeUI> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.TablicaPoljeUI> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.TablicaPoljeUI> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.TablicaPoljeUI> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.TablicaPoljeUI(korisnik_data);
                }
    			else
                {
