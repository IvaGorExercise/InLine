...
namespace InLine.UI.Web.Controllers.View
{
    ...
    public partial class KontniPlanTemeljnicaVrViewController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.View.IKontniPlanTemeljnicaVr _service;
        ...
        public InLine.Model.Data.View.KontniPlanTemeljnicaVr FindID(long id)
        {
    		InLine.Model.Data.View.KontniPlanTemeljnicaVr rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.View.KontniPlanTemeljnicaVr> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.View.KontniPlanTemeljnicaVr> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.View.KontniPlanTemeljnicaVr> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.View.KontniPlanTemeljnicaVr> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_KontniPlanTemeljnicaVr";
            }
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_KontniPlanTemeljnicaVr")
    				{
    				...
    				if (searchingName == "IDTemeljnicaVrVr")
    				{
    				...
    				if (searchingName == "Naziv")
    			{
    				...
    				if (searchingName == "OznakaTemeljnicaVrVr")
    			{
    				...
    				if (searchingName == "NazivTemeljnicaVrVr")
    			{
    				...
    				if (searchingName == "NazivKrTemeljnicaVrVr")
    			{
    				...
    				if (searchingName == "KraticaTemeljnicaVrVr")
    			{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.View.KontniPlanTemeljnicaVr(korisnik_data);
                }
    			else
                {
