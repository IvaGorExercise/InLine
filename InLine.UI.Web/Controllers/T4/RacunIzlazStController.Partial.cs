...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class RacunIzlazStController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IRacunIzlazSt _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.RacunIzlazStItem item)
    	{
    		
    		if (item.ID_RacunIzlazSt == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.RacunIzlazStItem item)
    	{
        ...
        public InLine.Model.Data.RacunIzlazSt FindID(long id)
        {
    		InLine.Model.Data.RacunIzlazSt rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.RacunIzlazSt> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.RacunIzlazSt> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.RacunIzlazSt> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.RacunIzlazSt> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "IznosVrijednost")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.RacunIzlazSt(korisnik_data);
                }
    			else
                {
