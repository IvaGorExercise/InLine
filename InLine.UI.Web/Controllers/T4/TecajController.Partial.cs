...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class TecajController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.ITecaj _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.TecajItem item)
    	{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.TecajItem item)
    	{
        ...
        public InLine.Model.Data.Tecaj FindID(long id)
        {
    		InLine.Model.Data.Tecaj rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.Tecaj> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.Tecaj> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.Tecaj> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.Tecaj> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.Tecaj(korisnik_data);
                }
    			else
                {
