...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class SubjektWebController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.ISubjektWeb _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.SubjektWebItem item)
    	{
    		
    		if (item.ID_SubjektWeb == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.SubjektWebItem item)
    	{
        ...
        public InLine.Model.Data.SubjektWeb FindID(long id)
        {
    		InLine.Model.Data.SubjektWeb rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.SubjektWeb> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.SubjektWeb> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.SubjektWeb> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.SubjektWeb> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_SubjektWeb")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.SubjektWeb(korisnik_data);
                }
    			else
                {
