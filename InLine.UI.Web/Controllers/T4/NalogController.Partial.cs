...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class NalogController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.INalog _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.NalogItem item)
    	{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.NalogItem item)
    	{
        ...
        public InLine.Model.Data.Nalog FindID(long id)
        {
    		InLine.Model.Data.Nalog rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.Nalog> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.Nalog> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.Nalog> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.Nalog> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.Nalog(korisnik_data);
                }
    			else
                {
