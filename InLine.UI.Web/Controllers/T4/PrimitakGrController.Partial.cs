...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class PrimitakGrController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IPrimitakGr _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.PrimitakGrItem item)
    	{
    		
    		if (item.ID_PrimitakGr == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.PrimitakGrItem item)
    	{
        ...
        public InLine.Model.Data.PrimitakGr FindID(long id)
        {
    		InLine.Model.Data.PrimitakGr rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.PrimitakGr> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.PrimitakGr> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.PrimitakGr> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.PrimitakGr> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.PrimitakGr(korisnik_data);
                }
    			else
                {
