...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ObrazacIPController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IObrazacIP _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ObrazacIPItem item)
    	{
    		
    		if (item.ID_ObrazacIP == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ObrazacIPItem item)
    	{
        ...
        public InLine.Model.Data.ObrazacIP FindID(long id)
        {
    		InLine.Model.Data.ObrazacIP rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ObrazacIP> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ObrazacIP> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ObrazacIP> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ObrazacIP> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "IDObrazacIPVerzija")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ObrazacIP(korisnik_data);
                }
    			else
                {
