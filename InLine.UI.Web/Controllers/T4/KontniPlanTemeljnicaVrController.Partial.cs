...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class KontniPlanTemeljnicaVrController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IKontniPlanTemeljnicaVr _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.KontniPlanTemeljnicaVrItem item)
    	{
    		
    		if (item.ID_KontniPlanTemeljnicaVr == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.KontniPlanTemeljnicaVrItem item)
    	{
        ...
        public InLine.Model.Data.KontniPlanTemeljnicaVr FindID(long id)
        {
    		InLine.Model.Data.KontniPlanTemeljnicaVr rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.KontniPlanTemeljnicaVr> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.KontniPlanTemeljnicaVr> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.KontniPlanTemeljnicaVr> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.KontniPlanTemeljnicaVr> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.KontniPlanTemeljnicaVr(korisnik_data);
                }
    			else
                {
