...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ZapisVrController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IZapisVr _service;
        ...
        public InLine.Model.Data.ZapisVr FindID(long id)
        {
    		InLine.Model.Data.ZapisVr rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ZapisVr> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ZapisVr> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ZapisVr> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ZapisVr> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ZapisVr(korisnik_data);
                }
    			else
                {
