...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ObjektGrObjektController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IObjektGrObjekt _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ObjektGrObjektItem item)
    	{
    		
    		if (item.ID_ObjektGrObjekt == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ObjektGrObjektItem item)
    	{
        ...
        public InLine.Model.Data.ObjektGrObjekt FindID(long id)
        {
    		InLine.Model.Data.ObjektGrObjekt rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ObjektGrObjekt> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ObjektGrObjekt> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ObjektGrObjekt> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ObjektGrObjekt> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_ObjektGrObjekt")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ObjektGrObjekt(korisnik_data);
                }
    			else
                {
