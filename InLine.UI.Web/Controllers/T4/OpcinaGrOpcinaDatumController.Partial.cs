...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class OpcinaGrOpcinaDatumController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IOpcinaGrOpcinaDatum _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.OpcinaGrOpcinaDatumItem item)
    	{
    		
    		if (item.ID_OpcinaGrOpcinaDatum == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.OpcinaGrOpcinaDatumItem item)
    	{
        ...
        public InLine.Model.Data.OpcinaGrOpcinaDatum FindID(long id)
        {
    		InLine.Model.Data.OpcinaGrOpcinaDatum rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.OpcinaGrOpcinaDatum> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.OpcinaGrOpcinaDatum> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.OpcinaGrOpcinaDatum> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.OpcinaGrOpcinaDatum> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_OpcinaGrOpcinaDatum";
            }
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.OpcinaGrOpcinaDatum(korisnik_data);
                }
    			else
                {
