...
namespace InLine.UI.Web.Controllers.View
{
    ...
    public partial class DokumentVrViewController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.View.IDokumentVr _service;
        ...
        public InLine.Model.Data.View.DokumentVr FindID(long id)
        {
    		InLine.Model.Data.View.DokumentVr rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.View.DokumentVr> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.View.DokumentVr> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.View.DokumentVr> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.View.DokumentVr> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.View.DokumentVr(korisnik_data);
                }
    			else
                {
