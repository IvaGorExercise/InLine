...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class DavanjeVrTablicaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IDavanjeVrTablica _service;
        ...
        public InLine.Model.Data.DavanjeVrTablica FindID(long id)
        {
    		InLine.Model.Data.DavanjeVrTablica rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.DavanjeVrTablica> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.DavanjeVrTablica> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.DavanjeVrTablica> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.DavanjeVrTablica> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.DavanjeVrTablica(korisnik_data);
                }
    			else
                {
