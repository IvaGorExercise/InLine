...
namespace InLine.UI.Web.Controllers.View
{
    ...
    public partial class KontniPlanViewController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.View.IKontniPlan _service;
        ...
        public InLine.Model.Data.View.KontniPlan FindID(long id)
        {
    		InLine.Model.Data.View.KontniPlan rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.View.KontniPlan> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.View.KontniPlan> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.View.KontniPlan> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.View.KontniPlan> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.View.KontniPlan(korisnik_data);
                }
    			else
                {
