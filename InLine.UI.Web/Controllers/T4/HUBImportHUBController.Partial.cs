...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class HUBImportHUBController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IHUBImportHUB _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.HUBImportHUBItem item)
    	{
    		
    		if (item.ID_HUBImportHUB == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.HUBImportHUBItem item)
    	{
        ...
        public InLine.Model.Data.HUBImportHUB FindID(long id)
        {
    		InLine.Model.Data.HUBImportHUB rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.HUBImportHUB> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.HUBImportHUB> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.HUBImportHUB> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.HUBImportHUB> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "BrojObrokZadnji")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    				...
    				if (searchingName == "AneksBrojObrokOd")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    				...
    				if (searchingName == "AneksBrojObrok")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    				...
    				if (searchingName == "UgovorBrojObrok")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    				...
    				if (searchingName == "IznosObrokPrije")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    				...
    				if (searchingName == "IznosUplataPrije")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    				...
    				if (searchingName == "IznosRevalorizacija")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.HUBImportHUB(korisnik_data);
                }
    			else
                {
