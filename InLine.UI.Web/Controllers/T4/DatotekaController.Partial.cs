...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class DatotekaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IDatoteka _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.DatotekaItem item)
    	{
    		
    		if (item.ID_Datoteka == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.DatotekaItem item)
    	{
        ...
        public InLine.Model.Data.Datoteka FindID(long id)
        {
    		InLine.Model.Data.Datoteka rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.Datoteka> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.Datoteka> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.Datoteka> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.Datoteka> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.Datoteka(korisnik_data);
                }
    			else
                {
