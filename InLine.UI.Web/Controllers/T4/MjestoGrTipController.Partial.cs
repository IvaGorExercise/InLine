...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class MjestoGrTipController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IMjestoGrTip _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.MjestoGrTipItem item)
    	{
    		
    		if (item.ID_MjestoGrTip == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.MjestoGrTipItem item)
    	{
        ...
        public InLine.Model.Data.MjestoGrTip FindID(long id)
        {
    		InLine.Model.Data.MjestoGrTip rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.MjestoGrTip> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.MjestoGrTip> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.MjestoGrTip> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.MjestoGrTip> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_MjestoGrTip")
    				{
    				...
    				if (searchingName == "Opis")
    			{
    				...
    				if (searchingName == "StsMjestoGrTip")
    			{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.MjestoGrTip(korisnik_data);
                }
    			else
                {
