...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class MjestoPostaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IMjestoPosta _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.MjestoPostaItem item)
    	{
    		
    		if (item.ID_MjestoPosta == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.MjestoPostaItem item)
    	{
        ...
        public InLine.Model.Data.MjestoPosta FindID(long id)
        {
    		InLine.Model.Data.MjestoPosta rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.MjestoPosta> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.MjestoPosta> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.MjestoPosta> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.MjestoPosta> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_MjestoPosta")
    				{
    				...
    				if (searchingName == "ID_Posta")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    				
    		
    					if (searchingName == "PBrStari")
    				{
    				...
    				if (searchingName == "DioMjesta")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    				if (searchingName == "IzborMjestoPosta")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    				if (searchingName == "AdresaBezMjesta")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    				
    
    				if (searchingName == "StsMjestoPosta")
    			{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.MjestoPosta(korisnik_data);
                }
    			else
                {
