...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class MjestoController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IMjesto _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.MjestoItem item)
    	{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.MjestoItem item)
    	{
        ...
        public InLine.Model.Data.Mjesto FindID(long id)
        {
    		InLine.Model.Data.Mjesto rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.Mjesto> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.Mjesto> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.Mjesto> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.Mjesto> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.Mjesto(korisnik_data);
                }
    			else
                {
