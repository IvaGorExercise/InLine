...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ObveznicaJavnogDugaIspravakController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IObveznicaJavnogDugaIspravak _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ObveznicaJavnogDugaIspravakItem item)
    	{
    		
    		if (item.ID_ObveznicaJavnogDugaIspravak == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ObveznicaJavnogDugaIspravakItem item)
    	{
        ...
        public InLine.Model.Data.ObveznicaJavnogDugaIspravak FindID(long id)
        {
    		InLine.Model.Data.ObveznicaJavnogDugaIspravak rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ObveznicaJavnogDugaIspravak> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ObveznicaJavnogDugaIspravak> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ObveznicaJavnogDugaIspravak> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ObveznicaJavnogDugaIspravak> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_ObveznicaJavnogDugaIspravak";
            }
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ObveznicaJavnogDugaIspravak(korisnik_data);
                }
    			else
                {
