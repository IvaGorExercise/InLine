...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class RobaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IRoba _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.RobaItem item)
    	{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.RobaItem item)
    	{
        ...
        public InLine.Model.Data.Roba FindID(long id)
        {
    		InLine.Model.Data.Roba rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.Roba> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.Roba> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.Roba> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.Roba> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.Roba(korisnik_data);
                }
    			else
                {
