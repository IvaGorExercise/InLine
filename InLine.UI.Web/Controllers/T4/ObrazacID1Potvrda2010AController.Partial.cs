...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ObrazacID1Potvrda2010AController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IObrazacID1Potvrda2010A _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ObrazacID1Potvrda2010AItem item)
    	{
    		
    		if (item.ID_ObrazacID1Potvrda2010A == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ObrazacID1Potvrda2010AItem item)
    	{
        ...
        public InLine.Model.Data.ObrazacID1Potvrda2010A FindID(long id)
        {
    		InLine.Model.Data.ObrazacID1Potvrda2010A rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ObrazacID1Potvrda2010A> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ObrazacID1Potvrda2010A> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ObrazacID1Potvrda2010A> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ObrazacID1Potvrda2010A> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_ObrazacID1Potvrda2010A";
            }
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_ObrazacID1Potvrda2010A")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ObrazacID1Potvrda2010A(korisnik_data);
                }
    			else
                {
