...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class KnjigaIRAController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IKnjigaIRA _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.KnjigaIRAItem item)
    	{
    		
    		if (item.ID_KnjigaIRA == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.KnjigaIRAItem item)
    	{
        ...
        public InLine.Model.Data.KnjigaIRA FindID(long id)
        {
    		InLine.Model.Data.KnjigaIRA rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.KnjigaIRA> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.KnjigaIRA> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.KnjigaIRA> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.KnjigaIRA> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "IznosProlaznaSt")
    				{
    				...
    				if (searchingName == "IznosNeoporezivo")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    				...
    				if (searchingName == "IznosMedunarodniPrijevoz")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    				...
    				if (searchingName == "IznosTuzemstvo")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.KnjigaIRA(korisnik_data);
                }
    			else
                {
