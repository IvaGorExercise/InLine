...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class StanController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IStan _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.StanItem item)
    	{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.StanItem item)
    	{
        ...
        public InLine.Model.Data.Stan FindID(long id)
        {
    		InLine.Model.Data.Stan rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.Stan> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.Stan> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.Stan> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.Stan> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.Stan(korisnik_data);
                }
    			else
                {
