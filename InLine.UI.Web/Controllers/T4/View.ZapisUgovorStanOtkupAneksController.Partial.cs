...
namespace InLine.UI.Web.Controllers.View
{
    ...
    public partial class ZapisUgovorStanOtkupAneksViewController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.View.IZapisUgovorStanOtkupAneks _service;
        ...
        public InLine.Model.Data.View.ZapisUgovorStanOtkupAneks FindID(long id)
        {
    		InLine.Model.Data.View.ZapisUgovorStanOtkupAneks rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.View.ZapisUgovorStanOtkupAneks> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.View.ZapisUgovorStanOtkupAneks> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.View.ZapisUgovorStanOtkupAneks> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.View.ZapisUgovorStanOtkupAneks> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "IDZapisTablica")
    				{
    				...
    				if (searchingName == "Odabir")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    				
    
    				if (searchingName == "UrudzbeniBroj")
    			{
    				...
    				if (searchingName == "DatumGodina")
    			{
    				...
    				if (searchingName == "VrijemeUpisString")
    			{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.View.ZapisUgovorStanOtkupAneks(korisnik_data);
                }
    			else
                {
