...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class AdresaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IAdresa _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.AdresaItem item)
    	{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.AdresaItem item)
    	{
        ...
        public InLine.Model.Data.Adresa FindID(long id)
        {
    		InLine.Model.Data.Adresa rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.Adresa> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.Adresa> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.Adresa> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.Adresa> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.Adresa(korisnik_data);
                }
    			else
                {
