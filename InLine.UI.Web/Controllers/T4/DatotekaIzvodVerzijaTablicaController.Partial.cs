...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class DatotekaIzvodVerzijaTablicaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IDatotekaIzvodVerzijaTablica _service;
        ...
        public InLine.Model.Data.DatotekaIzvodVerzijaTablica FindID(long id)
        {
    		InLine.Model.Data.DatotekaIzvodVerzijaTablica rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.DatotekaIzvodVerzijaTablica> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.DatotekaIzvodVerzijaTablica> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.DatotekaIzvodVerzijaTablica> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.DatotekaIzvodVerzijaTablica> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "IDDatotekaIzvodVerzijaTablica";
            }
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "IDDatotekaIzvodVerzijaTablica")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.DatotekaIzvodVerzijaTablica(korisnik_data);
                }
    			else
                {
