...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class UgovorStanOtkupShemaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IUgovorStanOtkupShema _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.UgovorStanOtkupShemaItem item)
    	{
    		
    		if (item.ID_UgovorStanOtkupShema == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.UgovorStanOtkupShemaItem item)
    	{
        ...
        public InLine.Model.Data.UgovorStanOtkupShema FindID(long id)
        {
    		InLine.Model.Data.UgovorStanOtkupShema rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.UgovorStanOtkupShema> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.UgovorStanOtkupShema> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.UgovorStanOtkupShema> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.UgovorStanOtkupShema> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_UgovorStanOtkupShema";
            }
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_UgovorStanOtkupShema")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.UgovorStanOtkupShema(korisnik_data);
                }
    			else
                {
