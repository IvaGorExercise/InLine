...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ZapisGrZapisController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IZapisGrZapis _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ZapisGrZapisItem item)
    	{
    		
    		if (item.ID_ZapisGrZapis == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ZapisGrZapisItem item)
    	{
        ...
        public InLine.Model.Data.ZapisGrZapis FindID(long id)
        {
    		InLine.Model.Data.ZapisGrZapis rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ZapisGrZapis> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ZapisGrZapis> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ZapisGrZapis> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ZapisGrZapis> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_ZapisGrZapis")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ZapisGrZapis(korisnik_data);
                }
    			else
                {
