...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ObrazacIPVerzijaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IObrazacIPVerzija _service;
        ...
        public InLine.Model.Data.ObrazacIPVerzija FindID(long id)
        {
    		InLine.Model.Data.ObrazacIPVerzija rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ObrazacIPVerzija> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ObrazacIPVerzija> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ObrazacIPVerzija> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ObrazacIPVerzija> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ObrazacIPVerzija(korisnik_data);
                }
    			else
                {
