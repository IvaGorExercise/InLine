...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class IzvodStTemeljnicaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IIzvodStTemeljnica _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.IzvodStTemeljnicaItem item)
    	{
    		
    		if (item.ID_IzvodStTemeljnica == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.IzvodStTemeljnicaItem item)
    	{
        ...
        public InLine.Model.Data.IzvodStTemeljnica FindID(long id)
        {
    		InLine.Model.Data.IzvodStTemeljnica rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.IzvodStTemeljnica> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.IzvodStTemeljnica> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.IzvodStTemeljnica> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.IzvodStTemeljnica> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_IzvodStTemeljnica";
            }
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_IzvodStTemeljnica")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.IzvodStTemeljnica(korisnik_data);
                }
    			else
                {
