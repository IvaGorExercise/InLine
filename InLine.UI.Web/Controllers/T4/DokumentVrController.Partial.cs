...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class DokumentVrController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IDokumentVr _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.DokumentVrItem item)
    	{
    		
    		if (item.ID_DokumentVr == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.DokumentVrItem item)
    	{
        ...
        public InLine.Model.Data.DokumentVr FindID(long id)
        {
    		InLine.Model.Data.DokumentVr rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.DokumentVr> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.DokumentVr> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.DokumentVr> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.DokumentVr> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.DokumentVr(korisnik_data);
                }
    			else
                {
