...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class PrimitakController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IPrimitak _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.PrimitakItem item)
    	{
    		
    		if (item.ID_Primitak == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.PrimitakItem item)
    	{
        ...
        public InLine.Model.Data.Primitak FindID(long id)
        {
    		InLine.Model.Data.Primitak rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.Primitak> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.Primitak> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.Primitak> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.Primitak> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ProsjektMjeseci")
    				{
    				...
    				if (searchingName == "ProsjekZaMjesec")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    				...
    				if (searchingName == "PrimitakProsjekIznos")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    				...
    				if (searchingName == "PrimitakProsjekIzracun")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.Primitak(korisnik_data);
                }
    			else
                {
