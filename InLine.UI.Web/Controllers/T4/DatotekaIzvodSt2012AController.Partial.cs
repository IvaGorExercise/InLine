...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class DatotekaIzvodSt2012AController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IDatotekaIzvodSt2012A _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.DatotekaIzvodSt2012AItem item)
    	{
    		
    		if (item.ID_DatotekaIzvodSt2012A == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.DatotekaIzvodSt2012AItem item)
    	{
        ...
        public InLine.Model.Data.DatotekaIzvodSt2012A FindID(long id)
        {
    		InLine.Model.Data.DatotekaIzvodSt2012A rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.DatotekaIzvodSt2012A> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.DatotekaIzvodSt2012A> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.DatotekaIzvodSt2012A> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.DatotekaIzvodSt2012A> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_DatotekaIzvodSt2012A";
            }
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_DatotekaIzvodSt2012A")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.DatotekaIzvodSt2012A(korisnik_data);
                }
    			else
                {
