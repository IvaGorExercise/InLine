...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class DohodakPrimateljPrimitakDavanjeController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IDohodakPrimateljPrimitakDavanje _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.DohodakPrimateljPrimitakDavanjeItem item)
    	{
    		
    		if (item.ID_DohodakPrimateljPrimitakDavanje == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.DohodakPrimateljPrimitakDavanjeItem item)
    	{
        ...
        public InLine.Model.Data.DohodakPrimateljPrimitakDavanje FindID(long id)
        {
    		InLine.Model.Data.DohodakPrimateljPrimitakDavanje rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.DohodakPrimateljPrimitakDavanje> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.DohodakPrimateljPrimitakDavanje> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.DohodakPrimateljPrimitakDavanje> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.DohodakPrimateljPrimitakDavanje> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_DohodakPrimateljPrimitakDavanje";
            }
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_DohodakPrimateljPrimitakDavanje")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    				if (searchingName == "ID_DohodakPrimateljPrimitak")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    				if (searchingName == "ID_Davanje")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.DohodakPrimateljPrimitakDavanje(korisnik_data);
                }
    			else
                {
