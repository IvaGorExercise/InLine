...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class RacunUlazController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IRacunUlaz _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.RacunUlazItem item)
    	{
    		
    		if (item.ID_RacunUlaz == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.RacunUlazItem item)
    	{
        ...
        public InLine.Model.Data.RacunUlaz FindID(long id)
        {
    		InLine.Model.Data.RacunUlaz rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.RacunUlaz> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.RacunUlaz> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.RacunUlaz> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.RacunUlaz> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.RacunUlaz(korisnik_data);
                }
    			else
                {
