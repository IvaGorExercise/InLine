...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class KupacController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IKupac _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.KupacItem item)
    	{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.KupacItem item)
    	{
        ...
        public InLine.Model.Data.Kupac FindID(long id)
        {
    		InLine.Model.Data.Kupac rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.Kupac> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.Kupac> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.Kupac> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.Kupac> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.Kupac(korisnik_data);
                }
    			else
                {
