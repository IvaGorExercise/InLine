...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class DoprinosDohodakVrController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IDoprinosDohodakVr _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.DoprinosDohodakVrItem item)
    	{
    		
    		if (item.ID_DoprinosDohodakVr == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.DoprinosDohodakVrItem item)
    	{
        ...
        public InLine.Model.Data.DoprinosDohodakVr FindID(long id)
        {
    		InLine.Model.Data.DoprinosDohodakVr rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.DoprinosDohodakVr> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.DoprinosDohodakVr> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.DoprinosDohodakVr> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.DoprinosDohodakVr> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_DoprinosDohodakVr";
            }
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_DoprinosDohodakVr")
    				{
    					...
    					if (searchingName == "IDDavanjeDoprinosDohodakVr")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.DoprinosDohodakVr(korisnik_data);
                }
    			else
                {
