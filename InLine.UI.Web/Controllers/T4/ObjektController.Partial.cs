...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ObjektController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IObjekt _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ObjektItem item)
    	{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ObjektItem item)
    	{
        ...
        public InLine.Model.Data.Objekt FindID(long id)
        {
    		InLine.Model.Data.Objekt rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.Objekt> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.Objekt> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.Objekt> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.Objekt> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "IDObjektTablica")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.Objekt(korisnik_data);
                }
    			else
                {
