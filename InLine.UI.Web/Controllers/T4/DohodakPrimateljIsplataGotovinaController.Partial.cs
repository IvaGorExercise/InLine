...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class DohodakPrimateljIsplataGotovinaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IDohodakPrimateljIsplataGotovina _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.DohodakPrimateljIsplataGotovinaItem item)
    	{
    		
    		if (item.ID_DohodakPrimateljIsplataGotovina == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.DohodakPrimateljIsplataGotovinaItem item)
    	{
        ...
        public InLine.Model.Data.DohodakPrimateljIsplataGotovina FindID(long id)
        {
    		InLine.Model.Data.DohodakPrimateljIsplataGotovina rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.DohodakPrimateljIsplataGotovina> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.DohodakPrimateljIsplataGotovina> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.DohodakPrimateljIsplataGotovina> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.DohodakPrimateljIsplataGotovina> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_DohodakPrimateljIsplataGotovina";
            }
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_DohodakPrimateljIsplataGotovina")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.DohodakPrimateljIsplataGotovina(korisnik_data);
                }
    			else
                {
