...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class DohodakController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IDohodak _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.DohodakItem item)
    	{
    		
    		if (item.ID_Dohodak == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.DohodakItem item)
    	{
        ...
        public InLine.Model.Data.Dohodak FindID(long id)
        {
    		InLine.Model.Data.Dohodak rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.Dohodak> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.Dohodak> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.Dohodak> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.Dohodak> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.Dohodak(korisnik_data);
                }
    			else
                {
