...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ZaposlenjeController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IZaposlenje _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ZaposlenjeItem item)
    	{
    		
    		if (item.ID_Zaposlenje == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ZaposlenjeItem item)
    	{
        ...
        public InLine.Model.Data.Zaposlenje FindID(long id)
        {
    		InLine.Model.Data.Zaposlenje rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.Zaposlenje> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.Zaposlenje> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.Zaposlenje> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.Zaposlenje> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.Zaposlenje(korisnik_data);
                }
    			else
                {
