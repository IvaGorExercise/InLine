...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class DohodakPrimateljIsplataRacunController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IDohodakPrimateljIsplataRacun _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.DohodakPrimateljIsplataRacunItem item)
    	{
    		
    		if (item.ID_DohodakPrimateljIsplataRacun == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.DohodakPrimateljIsplataRacunItem item)
    	{
        ...
        public InLine.Model.Data.DohodakPrimateljIsplataRacun FindID(long id)
        {
    		InLine.Model.Data.DohodakPrimateljIsplataRacun rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.DohodakPrimateljIsplataRacun> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.DohodakPrimateljIsplataRacun> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.DohodakPrimateljIsplataRacun> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.DohodakPrimateljIsplataRacun> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_DohodakPrimateljIsplataRacun";
            }
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_DohodakPrimateljIsplataRacun")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.DohodakPrimateljIsplataRacun(korisnik_data);
                }
    			else
                {
