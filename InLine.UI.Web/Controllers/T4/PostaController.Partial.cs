...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class PostaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IPosta _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.PostaItem item)
    	{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.PostaItem item)
    	{
        ...
        public InLine.Model.Data.Posta FindID(long id)
        {
    		InLine.Model.Data.Posta rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.Posta> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.Posta> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.Posta> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.Posta> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.Posta(korisnik_data);
                }
    			else
                {
