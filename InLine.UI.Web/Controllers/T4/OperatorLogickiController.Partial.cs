...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class OperatorLogickiController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IOperatorLogicki _service;
        ...
        public InLine.Model.Data.OperatorLogicki FindID(long id)
        {
    		InLine.Model.Data.OperatorLogicki rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.OperatorLogicki> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.OperatorLogicki> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.OperatorLogicki> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.OperatorLogicki> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.OperatorLogicki(korisnik_data);
                }
    			else
                {
