...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ObrazacID12010AController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IObrazacID12010A _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ObrazacID12010AItem item)
    	{
    		
    		if (item.ID_ObrazacID12010A == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ObrazacID12010AItem item)
    	{
        ...
        public InLine.Model.Data.ObrazacID12010A FindID(long id)
        {
    		InLine.Model.Data.ObrazacID12010A rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ObrazacID12010A> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ObrazacID12010A> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ObrazacID12010A> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ObrazacID12010A> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_ObrazacID12010A")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ObrazacID12010A(korisnik_data);
                }
    			else
                {
