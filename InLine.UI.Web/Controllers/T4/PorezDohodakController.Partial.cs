...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class PorezDohodakController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IPorezDohodak _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.PorezDohodakItem item)
    	{
    		
    		if (item.ID_PorezDohodak == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.PorezDohodakItem item)
    	{
        ...
        public InLine.Model.Data.PorezDohodak FindID(long id)
        {
    		InLine.Model.Data.PorezDohodak rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.PorezDohodak> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.PorezDohodak> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.PorezDohodak> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.PorezDohodak> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_PorezDohodak")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.PorezDohodak(korisnik_data);
                }
    			else
                {
