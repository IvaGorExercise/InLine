...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class PosebanPorezDohodakVrController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IPosebanPorezDohodakVr _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.PosebanPorezDohodakVrItem item)
    	{
    		
    		if (item.ID_PosebanPorezDohodakVr == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.PosebanPorezDohodakVrItem item)
    	{
        ...
        public InLine.Model.Data.PosebanPorezDohodakVr FindID(long id)
        {
    		InLine.Model.Data.PosebanPorezDohodakVr rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.PosebanPorezDohodakVr> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.PosebanPorezDohodakVr> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.PosebanPorezDohodakVr> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.PosebanPorezDohodakVr> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_PosebanPorezDohodakVr";
            }
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.PosebanPorezDohodakVr(korisnik_data);
                }
    			else
                {
