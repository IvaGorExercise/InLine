...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ObrazacIDController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IObrazacID _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ObrazacIDItem item)
    	{
    		
    		if (item.ID_ObrazacID == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ObrazacIDItem item)
    	{
        ...
        public InLine.Model.Data.ObrazacID FindID(long id)
        {
    		InLine.Model.Data.ObrazacID rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ObrazacID> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ObrazacID> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ObrazacID> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ObrazacID> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "IDObrazacIDVerzija")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ObrazacID(korisnik_data);
                }
    			else
                {
