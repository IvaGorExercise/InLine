...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class KontniPlanStController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IKontniPlanSt _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.KontniPlanStItem item)
    	{
    		
    		if (item.ID_KontniPlanSt == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.KontniPlanStItem item)
    	{
        ...
        public InLine.Model.Data.KontniPlanSt FindID(long id)
        {
    		InLine.Model.Data.KontniPlanSt rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.KontniPlanSt> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.KontniPlanSt> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.KontniPlanSt> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.KontniPlanSt> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.KontniPlanSt(korisnik_data);
                }
    			else
                {
