...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ZbrojniNalogController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IZbrojniNalog _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ZbrojniNalogItem item)
    	{
    		
    		if (item.ID_ZbrojniNalog == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ZbrojniNalogItem item)
    	{
        ...
        public InLine.Model.Data.ZbrojniNalog FindID(long id)
        {
    		InLine.Model.Data.ZbrojniNalog rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ZbrojniNalog> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ZbrojniNalog> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ZbrojniNalog> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ZbrojniNalog> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "IDZbrojniNalogVerzija")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ZbrojniNalog(korisnik_data);
                }
    			else
                {
