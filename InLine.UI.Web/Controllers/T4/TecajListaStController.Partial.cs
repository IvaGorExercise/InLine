...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class TecajListaStController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.ITecajListaSt _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.TecajListaStItem item)
    	{
    		
    		if (item.ID_TecajListaSt == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.TecajListaStItem item)
    	{
        ...
        public InLine.Model.Data.TecajListaSt FindID(long id)
        {
    		InLine.Model.Data.TecajListaSt rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.TecajListaSt> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.TecajListaSt> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.TecajListaSt> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.TecajListaSt> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.TecajListaSt(korisnik_data);
                }
    			else
                {
