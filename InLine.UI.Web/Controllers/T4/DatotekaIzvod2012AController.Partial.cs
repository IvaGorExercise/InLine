...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class DatotekaIzvod2012AController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IDatotekaIzvod2012A _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.DatotekaIzvod2012AItem item)
    	{
    		
    		if (item.ID_DatotekaIzvod2012A == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.DatotekaIzvod2012AItem item)
    	{
        ...
        public InLine.Model.Data.DatotekaIzvod2012A FindID(long id)
        {
    		InLine.Model.Data.DatotekaIzvod2012A rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.DatotekaIzvod2012A> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.DatotekaIzvod2012A> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.DatotekaIzvod2012A> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.DatotekaIzvod2012A> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_DatotekaIzvod2012A";
            }
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.DatotekaIzvod2012A(korisnik_data);
                }
    			else
                {
