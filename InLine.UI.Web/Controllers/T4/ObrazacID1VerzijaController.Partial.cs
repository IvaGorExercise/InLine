...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ObrazacID1VerzijaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IObrazacID1Verzija _service;
        ...
        public InLine.Model.Data.ObrazacID1Verzija FindID(long id)
        {
    		InLine.Model.Data.ObrazacID1Verzija rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ObrazacID1Verzija> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ObrazacID1Verzija> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ObrazacID1Verzija> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ObrazacID1Verzija> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ObrazacID1Verzija(korisnik_data);
                }
    			else
                {
