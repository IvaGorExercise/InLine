...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class JezikController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IJezik _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.JezikItem item)
    	{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.JezikItem item)
    	{
        ...
        public InLine.Model.Data.Jezik FindID(long id)
        {
    		InLine.Model.Data.Jezik rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.Jezik> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.Jezik> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.Jezik> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.Jezik> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.Jezik(korisnik_data);
                }
    			else
                {
