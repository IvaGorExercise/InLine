...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class PoslovnaGodinaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IPoslovnaGodina _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.PoslovnaGodinaItem item)
    	{
    		
    		if (item.ID_PoslovnaGodina == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.PoslovnaGodinaItem item)
    	{
        ...
        public InLine.Model.Data.PoslovnaGodina FindID(long id)
        {
    		InLine.Model.Data.PoslovnaGodina rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.PoslovnaGodina> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.PoslovnaGodina> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.PoslovnaGodina> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.PoslovnaGodina> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.PoslovnaGodina(korisnik_data);
                }
    			else
                {
