...
namespace InLine.UI.Web.Controllers.View
{
    ...
    public partial class TemeljnicaViewController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.View.ITemeljnica _service;
        ...
        public InLine.Model.Data.View.Temeljnica FindID(long id)
        {
    		InLine.Model.Data.View.Temeljnica rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.View.Temeljnica> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.View.Temeljnica> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.View.Temeljnica> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.View.Temeljnica> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.View.Temeljnica(korisnik_data);
                }
    			else
                {
