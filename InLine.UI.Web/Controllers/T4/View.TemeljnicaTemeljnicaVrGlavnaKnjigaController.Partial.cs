...
namespace InLine.UI.Web.Controllers.View
{
    ...
    public partial class TemeljnicaTemeljnicaVrGlavnaKnjigaViewController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.View.ITemeljnicaTemeljnicaVrGlavnaKnjiga _service;
        ...
        public InLine.Model.Data.View.TemeljnicaTemeljnicaVrGlavnaKnjiga FindID(long id)
        {
    		InLine.Model.Data.View.TemeljnicaTemeljnicaVrGlavnaKnjiga rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.View.TemeljnicaTemeljnicaVrGlavnaKnjiga> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.View.TemeljnicaTemeljnicaVrGlavnaKnjiga> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.View.TemeljnicaTemeljnicaVrGlavnaKnjiga> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.View.TemeljnicaTemeljnicaVrGlavnaKnjiga> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.View.TemeljnicaTemeljnicaVrGlavnaKnjiga(korisnik_data);
                }
    			else
                {
