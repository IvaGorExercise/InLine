...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class DatotekaVrController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IDatotekaVr _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.DatotekaVrItem item)
    	{
    		
    		if (item.ID_DatotekaVr == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.DatotekaVrItem item)
    	{
        ...
        public InLine.Model.Data.DatotekaVr FindID(long id)
        {
    		InLine.Model.Data.DatotekaVr rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.DatotekaVr> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.DatotekaVr> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.DatotekaVr> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.DatotekaVr> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.DatotekaVr(korisnik_data);
                }
    			else
                {
