...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class DatotekaIzvodVerzijaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IDatotekaIzvodVerzija _service;
        ...
        public InLine.Model.Data.DatotekaIzvodVerzija FindID(long id)
        {
    		InLine.Model.Data.DatotekaIzvodVerzija rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.DatotekaIzvodVerzija> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.DatotekaIzvodVerzija> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.DatotekaIzvodVerzija> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.DatotekaIzvodVerzija> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "IDDatotekaIzvodVerzija";
            }
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.DatotekaIzvodVerzija(korisnik_data);
                }
    			else
                {
