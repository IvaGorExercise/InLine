...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ShemaGrShemaGrStrukturaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IShemaGrShemaGrStruktura _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ShemaGrShemaGrStrukturaItem item)
    	{
    		
    		if (item.ID_ShemaGrShemaGrStruktura == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ShemaGrShemaGrStrukturaItem item)
    	{
        ...
        public InLine.Model.Data.ShemaGrShemaGrStruktura FindID(long id)
        {
    		InLine.Model.Data.ShemaGrShemaGrStruktura rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ShemaGrShemaGrStruktura> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ShemaGrShemaGrStruktura> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ShemaGrShemaGrStruktura> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ShemaGrShemaGrStruktura> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_ShemaGrShemaGrStruktura";
            }
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ShemaGrShemaGrStruktura(korisnik_data);
                }
    			else
                {
