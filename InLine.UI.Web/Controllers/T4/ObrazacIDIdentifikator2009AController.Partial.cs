...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ObrazacIDIdentifikator2009AController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IObrazacIDIdentifikator2009A _service;
        ...
        public InLine.Model.Data.ObrazacIDIdentifikator2009A FindID(long id)
        {
    		InLine.Model.Data.ObrazacIDIdentifikator2009A rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ObrazacIDIdentifikator2009A> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ObrazacIDIdentifikator2009A> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ObrazacIDIdentifikator2009A> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ObrazacIDIdentifikator2009A> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "IDObrazacIDIdentifikator2009A";
            }
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ObrazacIDIdentifikator2009A(korisnik_data);
                }
    			else
                {
