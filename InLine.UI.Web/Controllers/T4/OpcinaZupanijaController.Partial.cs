...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class OpcinaZupanijaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IOpcinaZupanija _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.OpcinaZupanijaItem item)
    	{
    		
    		if (item.ID_OpcinaZupanija == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.OpcinaZupanijaItem item)
    	{
        ...
        public InLine.Model.Data.OpcinaZupanija FindID(long id)
        {
    		InLine.Model.Data.OpcinaZupanija rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.OpcinaZupanija> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.OpcinaZupanija> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.OpcinaZupanija> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.OpcinaZupanija> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_OpcinaZupanija")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.OpcinaZupanija(korisnik_data);
                }
    			else
                {
