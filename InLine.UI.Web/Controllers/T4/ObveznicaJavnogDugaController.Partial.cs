...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ObveznicaJavnogDugaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IObveznicaJavnogDuga _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ObveznicaJavnogDugaItem item)
    	{
    		
    		if (item.ID_ObveznicaJavnogDuga == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ObveznicaJavnogDugaItem item)
    	{
        ...
        public InLine.Model.Data.ObveznicaJavnogDuga FindID(long id)
        {
    		InLine.Model.Data.ObveznicaJavnogDuga rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ObveznicaJavnogDuga> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ObveznicaJavnogDuga> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ObveznicaJavnogDuga> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ObveznicaJavnogDuga> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_ObveznicaJavnogDuga";
            }
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ObveznicaJavnogDuga(korisnik_data);
                }
    			else
                {
