...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ShemaStPoljeUvjetController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IShemaStPoljeUvjet _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ShemaStPoljeUvjetItem item)
    	{
    		
    		if (item.ID_ShemaStPoljeUvjet == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ShemaStPoljeUvjetItem item)
    	{
        ...
        public InLine.Model.Data.ShemaStPoljeUvjet FindID(long id)
        {
    		InLine.Model.Data.ShemaStPoljeUvjet rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ShemaStPoljeUvjet> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ShemaStPoljeUvjet> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ShemaStPoljeUvjet> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ShemaStPoljeUvjet> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_ShemaStPoljeUvjet";
            }
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_ShemaStPoljeUvjet")
    				{
    				...
    				if (searchingName == "Negacija")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    				
    
    				if (searchingName == "LogickiOperator")
    			{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ShemaStPoljeUvjet(korisnik_data);
                }
    			else
                {
