...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class PraznikPraviloController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IPraznikPravilo _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.PraznikPraviloItem item)
    	{
    		
    		if (item.ID_PraznikPravilo == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.PraznikPraviloItem item)
    	{
        ...
        public InLine.Model.Data.PraznikPravilo FindID(long id)
        {
    		InLine.Model.Data.PraznikPravilo rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.PraznikPravilo> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.PraznikPravilo> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.PraznikPravilo> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.PraznikPravilo> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_PraznikPravilo")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    				if (searchingName == "ID_Praznik")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    				if (searchingName == "ID_PraznikPraviloVr")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    				
    				if (searchingName == "GodinaOd")
    				{
    				...
    				if (searchingName == "GodinaInterval")
    				{
    					String Vrijednost = ProvjeraDecimalFiltera(searchingValue);
    				...
    				if (searchingName == "Naziv")
    			{
    				...
    				if (searchingName == "VremenskiOperator")
    			{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.PraznikPravilo(korisnik_data);
                }
    			else
                {
