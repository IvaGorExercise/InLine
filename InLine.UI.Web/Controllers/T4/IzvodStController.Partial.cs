...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class IzvodStController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IIzvodSt _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.IzvodStItem item)
    	{
    		
    		if (item.ID_IzvodSt == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.IzvodStItem item)
    	{
        ...
        public InLine.Model.Data.IzvodSt FindID(long id)
        {
    		InLine.Model.Data.IzvodSt rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.IzvodSt> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.IzvodSt> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.IzvodSt> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.IzvodSt> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.IzvodSt(korisnik_data);
                }
    			else
                {
