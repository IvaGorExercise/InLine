...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class KnjigaURAPDVController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IKnjigaURAPDV _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.KnjigaURAPDVItem item)
    	{
    		
    		if (item.ID_KnjigaURAPDV == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.KnjigaURAPDVItem item)
    	{
        ...
        public InLine.Model.Data.KnjigaURAPDV FindID(long id)
        {
    		InLine.Model.Data.KnjigaURAPDV rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.KnjigaURAPDV> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.KnjigaURAPDV> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.KnjigaURAPDV> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.KnjigaURAPDV> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.KnjigaURAPDV(korisnik_data);
                }
    			else
                {
