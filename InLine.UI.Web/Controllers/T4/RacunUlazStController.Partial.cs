...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class RacunUlazStController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IRacunUlazSt _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.RacunUlazStItem item)
    	{
    		
    		if (item.ID_RacunUlazSt == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.RacunUlazStItem item)
    	{
        ...
        public InLine.Model.Data.RacunUlazSt FindID(long id)
        {
    		InLine.Model.Data.RacunUlazSt rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.RacunUlazSt> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.RacunUlazSt> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.RacunUlazSt> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.RacunUlazSt> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.RacunUlazSt(korisnik_data);
                }
    			else
                {
