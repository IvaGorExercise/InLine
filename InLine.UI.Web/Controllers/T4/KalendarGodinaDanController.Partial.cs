...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class KalendarGodinaDanController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IKalendarGodinaDan _service;
        ...
        public InLine.Model.Data.KalendarGodinaDan FindID(long id)
        {
    		InLine.Model.Data.KalendarGodinaDan rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.KalendarGodinaDan> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.KalendarGodinaDan> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.KalendarGodinaDan> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.KalendarGodinaDan> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.KalendarGodinaDan(korisnik_data);
                }
    			else
                {
