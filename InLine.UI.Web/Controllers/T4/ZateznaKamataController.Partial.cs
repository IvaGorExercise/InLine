...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ZateznaKamataController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IZateznaKamata _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ZateznaKamataItem item)
    	{
    		
    		if (item.ID_ZateznaKamata == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ZateznaKamataItem item)
    	{
        ...
        public InLine.Model.Data.ZateznaKamata FindID(long id)
        {
    		InLine.Model.Data.ZateznaKamata rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ZateznaKamata> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ZateznaKamata> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ZateznaKamata> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ZateznaKamata> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_ZateznaKamata")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ZateznaKamata(korisnik_data);
                }
    			else
                {
