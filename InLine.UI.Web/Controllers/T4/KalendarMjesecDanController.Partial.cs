...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class KalendarMjesecDanController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IKalendarMjesecDan _service;
        ...
        public InLine.Model.Data.KalendarMjesecDan FindID(long id)
        {
    		InLine.Model.Data.KalendarMjesecDan rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.KalendarMjesecDan> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.KalendarMjesecDan> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.KalendarMjesecDan> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.KalendarMjesecDan> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.KalendarMjesecDan(korisnik_data);
                }
    			else
                {
