...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class UgovorStanOtkupTrosakController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IUgovorStanOtkupTrosak _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.UgovorStanOtkupTrosakItem item)
    	{
    		
    		if (item.ID_UgovorStanOtkupTrosak == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.UgovorStanOtkupTrosakItem item)
    	{
        ...
        public InLine.Model.Data.UgovorStanOtkupTrosak FindID(long id)
        {
    		InLine.Model.Data.UgovorStanOtkupTrosak rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.UgovorStanOtkupTrosak> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.UgovorStanOtkupTrosak> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.UgovorStanOtkupTrosak> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.UgovorStanOtkupTrosak> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_UgovorStanOtkupTrosak";
            }
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_UgovorStanOtkupTrosak")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.UgovorStanOtkupTrosak(korisnik_data);
                }
    			else
                {
