...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class DavanjeController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IDavanje _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.DavanjeItem item)
    	{
    		
    		if (item.ID_Davanje == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.DavanjeItem item)
    	{
        ...
        public InLine.Model.Data.Davanje FindID(long id)
        {
    		InLine.Model.Data.Davanje rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.Davanje> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.Davanje> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.Davanje> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.Davanje> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "IDDavanjeTablica")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.Davanje(korisnik_data);
                }
    			else
                {
