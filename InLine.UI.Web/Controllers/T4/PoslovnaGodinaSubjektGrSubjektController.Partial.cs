...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class PoslovnaGodinaSubjektGrSubjektController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IPoslovnaGodinaSubjektGrSubjekt _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.PoslovnaGodinaSubjektGrSubjektItem item)
    	{
    		
    		if (item.ID_PoslovnaGodinaSubjektGrSubjekt == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.PoslovnaGodinaSubjektGrSubjektItem item)
    	{
        ...
        public InLine.Model.Data.PoslovnaGodinaSubjektGrSubjekt FindID(long id)
        {
    		InLine.Model.Data.PoslovnaGodinaSubjektGrSubjekt rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.PoslovnaGodinaSubjektGrSubjekt> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.PoslovnaGodinaSubjektGrSubjekt> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.PoslovnaGodinaSubjektGrSubjekt> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.PoslovnaGodinaSubjektGrSubjekt> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_PoslovnaGodinaSubjektGrSubjekt";
            }
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_PoslovnaGodinaSubjektGrSubjekt")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    				if (searchingName == "ID_PoslovnaGodinaSubjektGr")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    				if (searchingName == "ID_PoslovnaGodinaSubjekt")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.PoslovnaGodinaSubjektGrSubjekt(korisnik_data);
                }
    			else
                {
