...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class RacunUlazKontniPlanController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IRacunUlazKontniPlan _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.RacunUlazKontniPlanItem item)
    	{
    		
    		if (item.ID_RacunUlazKontniPlan == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.RacunUlazKontniPlanItem item)
    	{
        ...
        public InLine.Model.Data.RacunUlazKontniPlan FindID(long id)
        {
    		InLine.Model.Data.RacunUlazKontniPlan rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.RacunUlazKontniPlan> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.RacunUlazKontniPlan> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.RacunUlazKontniPlan> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.RacunUlazKontniPlan> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_RacunUlazKontniPlan";
            }
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.RacunUlazKontniPlan(korisnik_data);
                }
    			else
                {
