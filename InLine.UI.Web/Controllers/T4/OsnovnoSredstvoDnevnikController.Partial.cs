...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class OsnovnoSredstvoDnevnikController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IOsnovnoSredstvoDnevnik _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.OsnovnoSredstvoDnevnikItem item)
    	{
    		
    		if (item.ID_OsnovnoSredstvoDnevnik == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.OsnovnoSredstvoDnevnikItem item)
    	{
        ...
        public InLine.Model.Data.OsnovnoSredstvoDnevnik FindID(long id)
        {
    		InLine.Model.Data.OsnovnoSredstvoDnevnik rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.OsnovnoSredstvoDnevnik> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.OsnovnoSredstvoDnevnik> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.OsnovnoSredstvoDnevnik> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.OsnovnoSredstvoDnevnik> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_OsnovnoSredstvoDnevnik";
            }
    		...
    		public static string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_OsnovnoSredstvoDnevnik")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    				if (searchingName == "ID_OsnovnoSredstvo")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    				
    				if (searchingName == "IDOsnovnoSredstvoDogadaj")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.OsnovnoSredstvoDnevnik(korisnik_data);
                }
    			else
                {
