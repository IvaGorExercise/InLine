...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class MjestoGrMjestoController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IMjestoGrMjesto _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.MjestoGrMjestoItem item)
    	{
    		
    		if (item.ID_MjestoGrMjesto == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.MjestoGrMjestoItem item)
    	{
        ...
        public InLine.Model.Data.MjestoGrMjesto FindID(long id)
        {
    		InLine.Model.Data.MjestoGrMjesto rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.MjestoGrMjesto> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.MjestoGrMjesto> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.MjestoGrMjesto> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.MjestoGrMjesto> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.MjestoGrMjesto(korisnik_data);
                }
    			else
                {
