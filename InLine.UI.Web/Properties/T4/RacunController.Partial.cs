...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class RacunController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IRacun _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.RacunItem item)
    	{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.RacunItem item)
    	{
        ...
        public InLine.Model.Data.Racun FindID(long id)
        {
    		InLine.Model.Data.Racun rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.Racun> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.Racun> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.Racun> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.Racun> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.Racun(korisnik_data);
                }
    			else
                {
