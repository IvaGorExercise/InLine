...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class OsnovnoSredstvoController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IOsnovnoSredstvo _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.OsnovnoSredstvoItem item)
    	{
    		
    		if (item.ID_OsnovnoSredstvo == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.OsnovnoSredstvoItem item)
    	{
        ...
        public InLine.Model.Data.OsnovnoSredstvo FindID(long id)
        {
    		InLine.Model.Data.OsnovnoSredstvo rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.OsnovnoSredstvo> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.OsnovnoSredstvo> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.OsnovnoSredstvo> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.OsnovnoSredstvo> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.OsnovnoSredstvo(korisnik_data);
                }
    			else
                {
