...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class PoslovniSubjektController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IPoslovniSubjekt _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.PoslovniSubjektItem item)
    	{
    		
    		if (item.ID_PoslovniSubjekt == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.PoslovniSubjektItem item)
    	{
        ...
        public InLine.Model.Data.PoslovniSubjekt FindID(long id)
        {
    		InLine.Model.Data.PoslovniSubjekt rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.PoslovniSubjekt> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.PoslovniSubjekt> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.PoslovniSubjekt> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.PoslovniSubjekt> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.PoslovniSubjekt(korisnik_data);
                }
    			else
                {
