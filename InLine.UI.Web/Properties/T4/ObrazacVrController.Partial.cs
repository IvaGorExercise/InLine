...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ObrazacVrController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IObrazacVr _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ObrazacVrItem item)
    	{
    		
    		if (item.ID_ObrazacVr == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ObrazacVrItem item)
    	{
        ...
        public InLine.Model.Data.ObrazacVr FindID(long id)
        {
    		InLine.Model.Data.ObrazacVr rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ObrazacVr> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ObrazacVr> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ObrazacVr> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ObrazacVr> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ObrazacVr(korisnik_data);
                }
    			else
                {
