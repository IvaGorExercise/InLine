...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class DatotekaVrVerzijaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IDatotekaVrVerzija _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.DatotekaVrVerzijaItem item)
    	{
    		
    		if (item.ID_DatotekaVrVerzija == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.DatotekaVrVerzijaItem item)
    	{
        ...
        public InLine.Model.Data.DatotekaVrVerzija FindID(long id)
        {
    		InLine.Model.Data.DatotekaVrVerzija rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.DatotekaVrVerzija> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.DatotekaVrVerzija> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.DatotekaVrVerzija> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.DatotekaVrVerzija> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_DatotekaVrVerzija";
            }
    		...
    		public string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_DatotekaVr")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.DatotekaVrVerzija(korisnik_data);
                }
    			else
                {
