...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class UgovorStanOtkupMoratorijObrokController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IUgovorStanOtkupMoratorijObrok _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.UgovorStanOtkupMoratorijObrokItem item)
    	{
    		
    		if (item.ID_UgovorStanOtkupMoratorijObrok == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.UgovorStanOtkupMoratorijObrokItem item)
    	{
        ...
        public InLine.Model.Data.UgovorStanOtkupMoratorijObrok FindID(long id)
        {
    		InLine.Model.Data.UgovorStanOtkupMoratorijObrok rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.UgovorStanOtkupMoratorijObrok> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.UgovorStanOtkupMoratorijObrok> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.UgovorStanOtkupMoratorijObrok> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.UgovorStanOtkupMoratorijObrok> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_UgovorStanOtkupMoratorijObrok";
            }
    		...
    		public string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_UgovorStanOtkupMoratorijObrok")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    				if (searchingName == "ID_UgovorStanOtkupMoratorij")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.UgovorStanOtkupMoratorijObrok(korisnik_data);
                }
    			else
                {
