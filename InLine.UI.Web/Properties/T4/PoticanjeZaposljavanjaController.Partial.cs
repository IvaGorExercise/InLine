...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class PoticanjeZaposljavanjaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IPoticanjeZaposljavanja _service;
        ...
        public InLine.Model.Data.PoticanjeZaposljavanja FindID(long id)
        {
    		InLine.Model.Data.PoticanjeZaposljavanja rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.PoticanjeZaposljavanja> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.PoticanjeZaposljavanja> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.PoticanjeZaposljavanja> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.PoticanjeZaposljavanja> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "IDPoticanjeZaposljavanja";
            }
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.PoticanjeZaposljavanja(korisnik_data);
                }
    			else
                {
