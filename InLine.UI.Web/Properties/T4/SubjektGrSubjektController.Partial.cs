...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class SubjektGrSubjektController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.ISubjektGrSubjekt _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.SubjektGrSubjektItem item)
    	{
    		
    		if (item.ID_SubjektGrSubjekt == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.SubjektGrSubjektItem item)
    	{
        ...
        public InLine.Model.Data.SubjektGrSubjekt FindID(long id)
        {
    		InLine.Model.Data.SubjektGrSubjekt rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.SubjektGrSubjekt> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.SubjektGrSubjekt> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.SubjektGrSubjekt> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.SubjektGrSubjekt> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_SubjektGrSubjekt")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.SubjektGrSubjekt(korisnik_data);
                }
    			else
                {
