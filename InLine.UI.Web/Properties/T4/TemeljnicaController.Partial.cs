...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class TemeljnicaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.ITemeljnica _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.TemeljnicaItem item)
    	{
    		
    		if (item.ID_Temeljnica == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.TemeljnicaItem item)
    	{
        ...
        public InLine.Model.Data.Temeljnica FindID(long id)
        {
    		InLine.Model.Data.Temeljnica rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.Temeljnica> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.Temeljnica> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.Temeljnica> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.Temeljnica> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.Temeljnica(korisnik_data);
                }
    			else
                {
