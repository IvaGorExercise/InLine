...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class UgovorStanOtkupKupacController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IUgovorStanOtkupKupac _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.UgovorStanOtkupKupacItem item)
    	{
    		
    		if (item.ID_UgovorStanOtkupKupac == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.UgovorStanOtkupKupacItem item)
    	{
        ...
        public InLine.Model.Data.UgovorStanOtkupKupac FindID(long id)
        {
    		InLine.Model.Data.UgovorStanOtkupKupac rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.UgovorStanOtkupKupac> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.UgovorStanOtkupKupac> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.UgovorStanOtkupKupac> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.UgovorStanOtkupKupac> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_UgovorStanOtkupKupac";
            }
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.UgovorStanOtkupKupac(korisnik_data);
                }
    			else
                {
