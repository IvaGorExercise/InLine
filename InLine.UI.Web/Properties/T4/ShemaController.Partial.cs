...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ShemaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IShema _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ShemaItem item)
    	{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ShemaItem item)
    	{
        ...
        public InLine.Model.Data.Shema FindID(long id)
        {
    		InLine.Model.Data.Shema rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.Shema> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.Shema> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.Shema> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.Shema> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.Shema(korisnik_data);
                }
    			else
                {
