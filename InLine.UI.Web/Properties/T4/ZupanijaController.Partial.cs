...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ZupanijaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IZupanija _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ZupanijaItem item)
    	{
    		
    		if (item.ID_Zupanija == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ZupanijaItem item)
    	{
        ...
        public InLine.Model.Data.Zupanija FindID(long id)
        {
    		InLine.Model.Data.Zupanija rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.Zupanija> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.Zupanija> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.Zupanija> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.Zupanija> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.Zupanija(korisnik_data);
                }
    			else
                {
