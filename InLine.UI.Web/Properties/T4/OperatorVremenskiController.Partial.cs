...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class OperatorVremenskiController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IOperatorVremenski _service;
        ...
        public InLine.Model.Data.OperatorVremenski FindID(long id)
        {
    		InLine.Model.Data.OperatorVremenski rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.OperatorVremenski> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.OperatorVremenski> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.OperatorVremenski> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.OperatorVremenski> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.OperatorVremenski(korisnik_data);
                }
    			else
                {
