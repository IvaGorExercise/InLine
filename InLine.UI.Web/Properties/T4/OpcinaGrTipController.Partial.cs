...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class OpcinaGrTipController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IOpcinaGrTip _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.OpcinaGrTipItem item)
    	{
    		
    		if (item.ID_OpcinaGrTip == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.OpcinaGrTipItem item)
    	{
        ...
        public InLine.Model.Data.OpcinaGrTip FindID(long id)
        {
    		InLine.Model.Data.OpcinaGrTip rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.OpcinaGrTip> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.OpcinaGrTip> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.OpcinaGrTip> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.OpcinaGrTip> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_OpcinaGrTip")
    				{
    				...
    				if (searchingName == "Opis")
    			{
    				...
    				if (searchingName == "StsOpcinaGrTip")
    			{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.OpcinaGrTip(korisnik_data);
                }
    			else
                {
