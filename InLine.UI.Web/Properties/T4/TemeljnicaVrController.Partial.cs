...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class TemeljnicaVrController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.ITemeljnicaVr _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.TemeljnicaVrItem item)
    	{
    		
    		if (item.ID_TemeljnicaVr == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.TemeljnicaVrItem item)
    	{
        ...
        public InLine.Model.Data.TemeljnicaVr FindID(long id)
        {
    		InLine.Model.Data.TemeljnicaVr rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.TemeljnicaVr> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.TemeljnicaVr> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.TemeljnicaVr> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.TemeljnicaVr> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.TemeljnicaVr(korisnik_data);
                }
    			else
                {
