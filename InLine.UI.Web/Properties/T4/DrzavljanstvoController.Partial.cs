...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class DrzavljanstvoController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IDrzavljanstvo _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.DrzavljanstvoItem item)
    	{
    		
    		if (item.ID_Drzavljanstvo == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.DrzavljanstvoItem item)
    	{
        ...
        public InLine.Model.Data.Drzavljanstvo FindID(long id)
        {
    		InLine.Model.Data.Drzavljanstvo rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.Drzavljanstvo> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.Drzavljanstvo> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.Drzavljanstvo> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.Drzavljanstvo> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_Drzavljanstvo")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.Drzavljanstvo(korisnik_data);
                }
    			else
                {
