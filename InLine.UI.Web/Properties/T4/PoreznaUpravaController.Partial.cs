...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class PoreznaUpravaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IPoreznaUprava _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.PoreznaUpravaItem item)
    	{
    		
    		if (item.ID_PoreznaUprava == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.PoreznaUpravaItem item)
    	{
        ...
        public InLine.Model.Data.PoreznaUprava FindID(long id)
        {
    		InLine.Model.Data.PoreznaUprava rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.PoreznaUprava> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.PoreznaUprava> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.PoreznaUprava> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.PoreznaUprava> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.PoreznaUprava(korisnik_data);
                }
    			else
                {
