...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class PDVController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IPDV _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.PDVItem item)
    	{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.PDVItem item)
    	{
        ...
        public InLine.Model.Data.PDV FindID(long id)
        {
    		InLine.Model.Data.PDV rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.PDV> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.PDV> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.PDV> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.PDV> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.PDV(korisnik_data);
                }
    			else
                {
