...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class OpcinaGrController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IOpcinaGr _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.OpcinaGrItem item)
    	{
    		
    		if (item.ID_OpcinaGr == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.OpcinaGrItem item)
    	{
        ...
        public InLine.Model.Data.OpcinaGr FindID(long id)
        {
    		InLine.Model.Data.OpcinaGr rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.OpcinaGr> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.OpcinaGr> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.OpcinaGr> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.OpcinaGr> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.OpcinaGr(korisnik_data);
                }
    			else
                {
