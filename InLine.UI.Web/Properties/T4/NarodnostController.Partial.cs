...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class NarodnostController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.INarodnost _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.NarodnostItem item)
    	{
    		
    		if (item.ID_Narodnost == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.NarodnostItem item)
    	{
        ...
        public InLine.Model.Data.Narodnost FindID(long id)
        {
    		InLine.Model.Data.Narodnost rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.Narodnost> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.Narodnost> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.Narodnost> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.Narodnost> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.Narodnost(korisnik_data);
                }
    			else
                {
