...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class SubjektGrController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.ISubjektGr _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.SubjektGrItem item)
    	{
    		
    		if (item.ID_SubjektGr == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.SubjektGrItem item)
    	{
        ...
        public InLine.Model.Data.SubjektGr FindID(long id)
        {
    		InLine.Model.Data.SubjektGr rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.SubjektGr> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.SubjektGr> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.SubjektGr> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.SubjektGr> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.SubjektGr(korisnik_data);
                }
    			else
                {
