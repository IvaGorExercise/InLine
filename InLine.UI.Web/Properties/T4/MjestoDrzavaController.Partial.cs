...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class MjestoDrzavaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IMjestoDrzava _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.MjestoDrzavaItem item)
    	{
    		
    		if (item.ID_MjestoDrzava == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.MjestoDrzavaItem item)
    	{
        ...
        public InLine.Model.Data.MjestoDrzava FindID(long id)
        {
    		InLine.Model.Data.MjestoDrzava rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.MjestoDrzava> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.MjestoDrzava> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.MjestoDrzava> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.MjestoDrzava> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_MjestoDrzava")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.MjestoDrzava(korisnik_data);
                }
    			else
                {
