...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class KontniPlanSkupGrKontniPlanSkupController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IKontniPlanSkupGrKontniPlanSkup _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.KontniPlanSkupGrKontniPlanSkupItem item)
    	{
    		
    		if (item.ID_KontniPlanSkupGrKontniPlanSkup == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.KontniPlanSkupGrKontniPlanSkupItem item)
    	{
        ...
        public InLine.Model.Data.KontniPlanSkupGrKontniPlanSkup FindID(long id)
        {
    		InLine.Model.Data.KontniPlanSkupGrKontniPlanSkup rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.KontniPlanSkupGrKontniPlanSkup> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.KontniPlanSkupGrKontniPlanSkup> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.KontniPlanSkupGrKontniPlanSkup> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.KontniPlanSkupGrKontniPlanSkup> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_KontniPlanSkupGrKontniPlanSkup";
            }
    		...
    		public string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_KontniPlanSkupGrKontniPlanSkup")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    				if (searchingName == "ID_KontniPlanSkupGr")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    				if (searchingName == "ID_KontniPlanSkup")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.KontniPlanSkupGrKontniPlanSkup(korisnik_data);
                }
    			else
                {
