...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class TecajVrController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.ITecajVr _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.TecajVrItem item)
    	{
    		
    		if (item.ID_TecajVr == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.TecajVrItem item)
    	{
        ...
        public InLine.Model.Data.TecajVr FindID(long id)
        {
    		InLine.Model.Data.TecajVr rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.TecajVr> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.TecajVr> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.TecajVr> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.TecajVr> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.TecajVr(korisnik_data);
                }
    			else
                {
