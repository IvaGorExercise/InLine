...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class UgovorStanOtkupObrokController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IUgovorStanOtkupObrok _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.UgovorStanOtkupObrokItem item)
    	{
    		
    		if (item.ID_UgovorStanOtkupObrok == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.UgovorStanOtkupObrokItem item)
    	{
        ...
        public InLine.Model.Data.UgovorStanOtkupObrok FindID(long id)
        {
    		InLine.Model.Data.UgovorStanOtkupObrok rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.UgovorStanOtkupObrok> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.UgovorStanOtkupObrok> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.UgovorStanOtkupObrok> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.UgovorStanOtkupObrok> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_UgovorStanOtkupObrok";
            }
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.UgovorStanOtkupObrok(korisnik_data);
                }
    			else
                {
