...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class SubjektVezaVrController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.ISubjektVezaVr _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.SubjektVezaVrItem item)
    	{
    		
    		if (item.ID_SubjektVezaVr == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.SubjektVezaVrItem item)
    	{
        ...
        public InLine.Model.Data.SubjektVezaVr FindID(long id)
        {
    		InLine.Model.Data.SubjektVezaVr rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.SubjektVezaVr> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.SubjektVezaVr> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.SubjektVezaVr> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.SubjektVezaVr> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_SubjektVezaVr")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.SubjektVezaVr(korisnik_data);
                }
    			else
                {
