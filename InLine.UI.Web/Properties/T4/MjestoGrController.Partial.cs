...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class MjestoGrController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IMjestoGr _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.MjestoGrItem item)
    	{
    		
    		if (item.ID_MjestoGr == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.MjestoGrItem item)
    	{
        ...
        public InLine.Model.Data.MjestoGr FindID(long id)
        {
    		InLine.Model.Data.MjestoGr rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.MjestoGr> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.MjestoGr> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.MjestoGr> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.MjestoGr> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.MjestoGr(korisnik_data);
                }
    			else
                {
