...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class PDVVrController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IPDVVr _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.PDVVrItem item)
    	{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.PDVVrItem item)
    	{
        ...
        public InLine.Model.Data.PDVVr FindID(long id)
        {
    		InLine.Model.Data.PDVVr rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.PDVVr> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.PDVVr> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.PDVVr> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.PDVVr> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.PDVVr(korisnik_data);
                }
    			else
                {
