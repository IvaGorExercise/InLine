...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class OdbitakGrController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IOdbitakGr _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.OdbitakGrItem item)
    	{
    		
    		if (item.ID_OdbitakGr == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.OdbitakGrItem item)
    	{
        ...
        public InLine.Model.Data.OdbitakGr FindID(long id)
        {
    		InLine.Model.Data.OdbitakGr rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.OdbitakGr> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.OdbitakGr> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.OdbitakGr> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.OdbitakGr> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.OdbitakGr(korisnik_data);
                }
    			else
                {
