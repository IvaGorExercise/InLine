...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class VoziloController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IVozilo _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.VoziloItem item)
    	{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.VoziloItem item)
    	{
        ...
        public InLine.Model.Data.Vozilo FindID(long id)
        {
    		InLine.Model.Data.Vozilo rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.Vozilo> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.Vozilo> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.Vozilo> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.Vozilo> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.Vozilo(korisnik_data);
                }
    			else
                {
