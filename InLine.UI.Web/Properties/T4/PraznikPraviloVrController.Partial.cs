...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class PraznikPraviloVrController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IPraznikPraviloVr _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.PraznikPraviloVrItem item)
    	{
    		
    		if (item.ID_PraznikPraviloVr == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.PraznikPraviloVrItem item)
    	{
        ...
        public InLine.Model.Data.PraznikPraviloVr FindID(long id)
        {
    		InLine.Model.Data.PraznikPraviloVr rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.PraznikPraviloVr> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.PraznikPraviloVr> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.PraznikPraviloVr> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.PraznikPraviloVr> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.PraznikPraviloVr(korisnik_data);
                }
    			else
                {
