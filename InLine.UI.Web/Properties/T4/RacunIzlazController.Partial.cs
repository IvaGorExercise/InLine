...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class RacunIzlazController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IRacunIzlaz _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.RacunIzlazItem item)
    	{
    		
    		if (item.ID_RacunIzlaz == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.RacunIzlazItem item)
    	{
        ...
        public InLine.Model.Data.RacunIzlaz FindID(long id)
        {
    		InLine.Model.Data.RacunIzlaz rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.RacunIzlaz> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.RacunIzlaz> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.RacunIzlaz> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.RacunIzlaz> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.RacunIzlaz(korisnik_data);
                }
    			else
                {
