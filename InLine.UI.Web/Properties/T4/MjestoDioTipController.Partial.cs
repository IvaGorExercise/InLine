...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class MjestoDioTipController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IMjestoDioTip _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.MjestoDioTipItem item)
    	{
    		
    		if (item.ID_MjestoDioTip == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.MjestoDioTipItem item)
    	{
        ...
        public InLine.Model.Data.MjestoDioTip FindID(long id)
        {
    		InLine.Model.Data.MjestoDioTip rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.MjestoDioTip> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.MjestoDioTip> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.MjestoDioTip> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.MjestoDioTip> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_MjestoDioTip")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.MjestoDioTip(korisnik_data);
                }
    			else
                {
