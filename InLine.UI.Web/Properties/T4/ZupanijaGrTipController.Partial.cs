...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ZupanijaGrTipController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IZupanijaGrTip _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ZupanijaGrTipItem item)
    	{
    		
    		if (item.ID_ZupanijaGrTip == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ZupanijaGrTipItem item)
    	{
        ...
        public InLine.Model.Data.ZupanijaGrTip FindID(long id)
        {
    		InLine.Model.Data.ZupanijaGrTip rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ZupanijaGrTip> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ZupanijaGrTip> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ZupanijaGrTip> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ZupanijaGrTip> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_ZupanijaGrTip")
    				{
    				...
    				if (searchingName == "Opis")
    			{
    				...
    				if (searchingName == "StsZupanijaGrTip")
    			{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ZupanijaGrTip(korisnik_data);
                }
    			else
                {
