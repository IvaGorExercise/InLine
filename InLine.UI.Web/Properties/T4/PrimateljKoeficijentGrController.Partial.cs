...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class PrimateljKoeficijentGrController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IPrimateljKoeficijentGr _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.PrimateljKoeficijentGrItem item)
    	{
    		
    		if (item.ID_PrimateljKoeficijentGr == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.PrimateljKoeficijentGrItem item)
    	{
        ...
        public InLine.Model.Data.PrimateljKoeficijentGr FindID(long id)
        {
    		InLine.Model.Data.PrimateljKoeficijentGr rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.PrimateljKoeficijentGr> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.PrimateljKoeficijentGr> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.PrimateljKoeficijentGr> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.PrimateljKoeficijentGr> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_PrimateljKoeficijentGr";
            }
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.PrimateljKoeficijentGr(korisnik_data);
                }
    			else
                {
