...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class PoduzeceController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IPoduzece _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.PoduzeceItem item)
    	{
    		
    		if (item.ID_Poduzece == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.PoduzeceItem item)
    	{
        ...
        public InLine.Model.Data.Poduzece FindID(long id)
        {
    		InLine.Model.Data.Poduzece rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.Poduzece> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.Poduzece> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.Poduzece> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.Poduzece> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.Poduzece(korisnik_data);
                }
    			else
                {
