...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ObrazacRSmDopusteno2005AController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IObrazacRSmDopusteno2005A _service;
        ...
        public InLine.Model.Data.ObrazacRSmDopusteno2005A FindID(long id)
        {
    		InLine.Model.Data.ObrazacRSmDopusteno2005A rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ObrazacRSmDopusteno2005A> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ObrazacRSmDopusteno2005A> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ObrazacRSmDopusteno2005A> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ObrazacRSmDopusteno2005A> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ObrazacRSmDopusteno2005A(korisnik_data);
                }
    			else
                {
