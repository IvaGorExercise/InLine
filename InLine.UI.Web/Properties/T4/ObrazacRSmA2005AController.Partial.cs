...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ObrazacRSmA2005AController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IObrazacRSmA2005A _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ObrazacRSmA2005AItem item)
    	{
    		
    		if (item.ID_ObrazacRSmA2005A == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ObrazacRSmA2005AItem item)
    	{
        ...
        public InLine.Model.Data.ObrazacRSmA2005A FindID(long id)
        {
    		InLine.Model.Data.ObrazacRSmA2005A rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ObrazacRSmA2005A> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ObrazacRSmA2005A> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ObrazacRSmA2005A> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ObrazacRSmA2005A> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ObrazacRSmA2005A(korisnik_data);
                }
    			else
                {
