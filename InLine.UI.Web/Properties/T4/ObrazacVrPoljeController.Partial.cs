...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ObrazacVrPoljeController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IObrazacVrPolje _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ObrazacVrPoljeItem item)
    	{
    		
    		if (item.ID_ObrazacVrPolje == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ObrazacVrPoljeItem item)
    	{
        ...
        public InLine.Model.Data.ObrazacVrPolje FindID(long id)
        {
    		InLine.Model.Data.ObrazacVrPolje rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ObrazacVrPolje> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ObrazacVrPolje> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ObrazacVrPolje> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ObrazacVrPolje> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ObrazacVrPolje(korisnik_data);
                }
    			else
                {
