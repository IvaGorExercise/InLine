...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ZaposlenjeOpcinaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IZaposlenjeOpcina _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ZaposlenjeOpcinaItem item)
    	{
    		
    		if (item.ID_ZaposlenjeOpcina == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ZaposlenjeOpcinaItem item)
    	{
        ...
        public InLine.Model.Data.ZaposlenjeOpcina FindID(long id)
        {
    		InLine.Model.Data.ZaposlenjeOpcina rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ZaposlenjeOpcina> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ZaposlenjeOpcina> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ZaposlenjeOpcina> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ZaposlenjeOpcina> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_ZaposlenjeOpcina")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ZaposlenjeOpcina(korisnik_data);
                }
    			else
                {
