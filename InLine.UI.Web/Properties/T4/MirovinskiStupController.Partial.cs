...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class MirovinskiStupController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IMirovinskiStup _service;
        ...
        public InLine.Model.Data.MirovinskiStup FindID(long id)
        {
    		InLine.Model.Data.MirovinskiStup rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.MirovinskiStup> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.MirovinskiStup> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.MirovinskiStup> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.MirovinskiStup> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.MirovinskiStup(korisnik_data);
                }
    			else
                {
