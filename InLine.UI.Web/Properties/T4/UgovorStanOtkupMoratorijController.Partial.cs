...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class UgovorStanOtkupMoratorijController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IUgovorStanOtkupMoratorij _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.UgovorStanOtkupMoratorijItem item)
    	{
    		
    		if (item.ID_UgovorStanOtkupMoratorij == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.UgovorStanOtkupMoratorijItem item)
    	{
        ...
        public InLine.Model.Data.UgovorStanOtkupMoratorij FindID(long id)
        {
    		InLine.Model.Data.UgovorStanOtkupMoratorij rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.UgovorStanOtkupMoratorij> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.UgovorStanOtkupMoratorij> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.UgovorStanOtkupMoratorij> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.UgovorStanOtkupMoratorij> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_UgovorStanOtkupMoratorij";
            }
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.UgovorStanOtkupMoratorij(korisnik_data);
                }
    			else
                {
