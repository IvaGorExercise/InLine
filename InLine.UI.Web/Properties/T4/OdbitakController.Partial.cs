...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class OdbitakController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IOdbitak _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.OdbitakItem item)
    	{
    		
    		if (item.ID_Odbitak == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.OdbitakItem item)
    	{
        ...
        public InLine.Model.Data.Odbitak FindID(long id)
        {
    		InLine.Model.Data.Odbitak rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.Odbitak> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.Odbitak> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.Odbitak> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.Odbitak> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.Odbitak(korisnik_data);
                }
    			else
                {
