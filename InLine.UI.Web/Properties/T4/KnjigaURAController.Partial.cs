...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class KnjigaURAController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IKnjigaURA _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.KnjigaURAItem item)
    	{
    		
    		if (item.ID_KnjigaURA == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.KnjigaURAItem item)
    	{
        ...
        public InLine.Model.Data.KnjigaURA FindID(long id)
        {
    		InLine.Model.Data.KnjigaURA rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.KnjigaURA> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.KnjigaURA> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.KnjigaURA> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.KnjigaURA> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.KnjigaURA(korisnik_data);
                }
    			else
                {
