...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ObrtController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IObrt _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ObrtItem item)
    	{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ObrtItem item)
    	{
        ...
        public InLine.Model.Data.Obrt FindID(long id)
        {
    		InLine.Model.Data.Obrt rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.Obrt> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.Obrt> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.Obrt> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.Obrt> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.Obrt(korisnik_data);
                }
    			else
                {
