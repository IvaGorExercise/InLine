...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class RadnoMjestoController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IRadnoMjesto _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.RadnoMjestoItem item)
    	{
    		
    		if (item.ID_RadnoMjesto == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.RadnoMjestoItem item)
    	{
        ...
        public InLine.Model.Data.RadnoMjesto FindID(long id)
        {
    		InLine.Model.Data.RadnoMjesto rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.RadnoMjesto> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.RadnoMjesto> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.RadnoMjesto> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.RadnoMjesto> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.RadnoMjesto(korisnik_data);
                }
    			else
                {
