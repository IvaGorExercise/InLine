...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class RacunVrController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IRacunVr _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.RacunVrItem item)
    	{
    		
    		if (item.ID_RacunVr == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.RacunVrItem item)
    	{
        ...
        public InLine.Model.Data.RacunVr FindID(long id)
        {
    		InLine.Model.Data.RacunVr rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.RacunVr> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.RacunVr> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.RacunVr> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.RacunVr> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.RacunVr(korisnik_data);
                }
    			else
                {
