...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class OsobaController : Controller
    {
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.OsobaItem item)
    	{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.OsobaItem item)
    	{
        ...
        public InLine.Model.Data.Osoba FindID(long id)
        {
    		InLine.Model.Data.Osoba rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.Osoba> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.Osoba> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.Osoba> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.Osoba> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.Osoba(korisnik_data);
                }
    			else
                {
