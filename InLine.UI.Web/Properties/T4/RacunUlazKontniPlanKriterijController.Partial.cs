...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class RacunUlazKontniPlanKriterijController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IRacunUlazKontniPlanKriterij _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.RacunUlazKontniPlanKriterijItem item)
    	{
    		
    		if (item.ID_RacunUlazKontniPlanKriterij == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.RacunUlazKontniPlanKriterijItem item)
    	{
        ...
        public InLine.Model.Data.RacunUlazKontniPlanKriterij FindID(long id)
        {
    		InLine.Model.Data.RacunUlazKontniPlanKriterij rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.RacunUlazKontniPlanKriterij> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.RacunUlazKontniPlanKriterij> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.RacunUlazKontniPlanKriterij> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.RacunUlazKontniPlanKriterij> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_RacunUlazKontniPlanKriterij";
            }
    		...
    		public string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_RacunUlazKontniPlanKriterij")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    				if (searchingName == "ID_RacunUlazKontniPlan")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.RacunUlazKontniPlanKriterij(korisnik_data);
                }
    			else
                {
