...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class KriterijStController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IKriterijSt _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.KriterijStItem item)
    	{
    		
    		if (item.ID_KriterijSt == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.KriterijStItem item)
    	{
        ...
        public InLine.Model.Data.KriterijSt FindID(long id)
        {
    		InLine.Model.Data.KriterijSt rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.KriterijSt> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.KriterijSt> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.KriterijSt> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.KriterijSt> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.KriterijSt(korisnik_data);
                }
    			else
                {
