...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class StrucnaSpremaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IStrucnaSprema _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.StrucnaSpremaItem item)
    	{
    		
    		if (item.ID_StrucnaSprema == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.StrucnaSpremaItem item)
    	{
        ...
        public InLine.Model.Data.StrucnaSprema FindID(long id)
        {
    		InLine.Model.Data.StrucnaSprema rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.StrucnaSprema> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.StrucnaSprema> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.StrucnaSprema> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.StrucnaSprema> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_StrucnaSprema")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.StrucnaSprema(korisnik_data);
                }
    			else
                {
