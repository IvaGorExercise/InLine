...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ObrazacRSmObracunVr2005AController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IObrazacRSmObracunVr2005A _service;
        ...
        public InLine.Model.Data.ObrazacRSmObracunVr2005A FindID(long id)
        {
    		InLine.Model.Data.ObrazacRSmObracunVr2005A rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ObrazacRSmObracunVr2005A> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ObrazacRSmObracunVr2005A> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ObrazacRSmObracunVr2005A> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ObrazacRSmObracunVr2005A> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "IDObrazacRSmObracunVr2005A";
            }
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ObrazacRSmObracunVr2005A(korisnik_data);
                }
    			else
                {
