...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class MjestoTipController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IMjestoTip _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.MjestoTipItem item)
    	{
    		
    		if (item.ID_MjestoTip == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.MjestoTipItem item)
    	{
        ...
        public InLine.Model.Data.MjestoTip FindID(long id)
        {
    		InLine.Model.Data.MjestoTip rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.MjestoTip> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.MjestoTip> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.MjestoTip> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.MjestoTip> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.MjestoTip(korisnik_data);
                }
    			else
                {
