...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class NekretninaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.INekretnina _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.NekretninaItem item)
    	{
    		
    		if (item.ID_Nekretnina == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.NekretninaItem item)
    	{
        ...
        public InLine.Model.Data.Nekretnina FindID(long id)
        {
    		InLine.Model.Data.Nekretnina rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.Nekretnina> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.Nekretnina> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.Nekretnina> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.Nekretnina> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_Nekretnina")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.Nekretnina(korisnik_data);
                }
    			else
                {
