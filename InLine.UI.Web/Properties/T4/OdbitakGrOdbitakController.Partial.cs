...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class OdbitakGrOdbitakController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IOdbitakGrOdbitak _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.OdbitakGrOdbitakItem item)
    	{
    		
    		if (item.ID_OdbitakGrOdbitak == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.OdbitakGrOdbitakItem item)
    	{
        ...
        public InLine.Model.Data.OdbitakGrOdbitak FindID(long id)
        {
    		InLine.Model.Data.OdbitakGrOdbitak rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.OdbitakGrOdbitak> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.OdbitakGrOdbitak> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.OdbitakGrOdbitak> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.OdbitakGrOdbitak> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_OdbitakGrOdbitak")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.OdbitakGrOdbitak(korisnik_data);
                }
    			else
                {
