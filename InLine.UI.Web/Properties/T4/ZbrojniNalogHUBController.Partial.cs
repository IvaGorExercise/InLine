...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ZbrojniNalogHUBController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IZbrojniNalogHUB _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ZbrojniNalogHUBItem item)
    	{
    		
    		if (item.ID_ZbrojniNalogHUB == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ZbrojniNalogHUBItem item)
    	{
        ...
        public InLine.Model.Data.ZbrojniNalogHUB FindID(long id)
        {
    		InLine.Model.Data.ZbrojniNalogHUB rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ZbrojniNalogHUB> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ZbrojniNalogHUB> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ZbrojniNalogHUB> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ZbrojniNalogHUB> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_ZbrojniNalogHUB")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ZbrojniNalogHUB(korisnik_data);
                }
    			else
                {
