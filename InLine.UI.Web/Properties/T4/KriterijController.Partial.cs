...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class KriterijController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IKriterij _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.KriterijItem item)
    	{
    		
    		if (item.ID_Kriterij == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.KriterijItem item)
    	{
        ...
        public InLine.Model.Data.Kriterij FindID(long id)
        {
    		InLine.Model.Data.Kriterij rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.Kriterij> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.Kriterij> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.Kriterij> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.Kriterij> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.Kriterij(korisnik_data);
                }
    			else
                {
