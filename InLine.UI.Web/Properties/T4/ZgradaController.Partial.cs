...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ZgradaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IZgrada _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ZgradaItem item)
    	{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ZgradaItem item)
    	{
        ...
        public InLine.Model.Data.Zgrada FindID(long id)
        {
    		InLine.Model.Data.Zgrada rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.Zgrada> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.Zgrada> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.Zgrada> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.Zgrada> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.Zgrada(korisnik_data);
                }
    			else
                {
