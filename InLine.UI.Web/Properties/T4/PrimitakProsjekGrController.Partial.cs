...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class PrimitakProsjekGrController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IPrimitakProsjekGr _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.PrimitakProsjekGrItem item)
    	{
    		
    		if (item.ID_PrimitakProsjekGr == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.PrimitakProsjekGrItem item)
    	{
        ...
        public InLine.Model.Data.PrimitakProsjekGr FindID(long id)
        {
    		InLine.Model.Data.PrimitakProsjekGr rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.PrimitakProsjekGr> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.PrimitakProsjekGr> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.PrimitakProsjekGr> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.PrimitakProsjekGr> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_PrimitakProsjekGr";
            }
    		...
    		public string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_PrimitakProsjekGr")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.PrimitakProsjekGr(korisnik_data);
                }
    			else
                {
