...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class MjernaJedinicaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IMjernaJedinica _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.MjernaJedinicaItem item)
    	{
    		
    		if (item.ID_MjernaJedinica == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.MjernaJedinicaItem item)
    	{
        ...
        public InLine.Model.Data.MjernaJedinica FindID(long id)
        {
    		InLine.Model.Data.MjernaJedinica rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.MjernaJedinica> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.MjernaJedinica> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.MjernaJedinica> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.MjernaJedinica> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_MjernaJedinica")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.MjernaJedinica(korisnik_data);
                }
    			else
                {
