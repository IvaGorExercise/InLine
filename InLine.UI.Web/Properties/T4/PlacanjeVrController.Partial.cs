...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class PlacanjeVrController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IPlacanjeVr _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.PlacanjeVrItem item)
    	{
    		
    		if (item.ID_PlacanjeVr == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.PlacanjeVrItem item)
    	{
        ...
        public InLine.Model.Data.PlacanjeVr FindID(long id)
        {
    		InLine.Model.Data.PlacanjeVr rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.PlacanjeVr> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.PlacanjeVr> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.PlacanjeVr> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.PlacanjeVr> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_PlacanjeVr")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.PlacanjeVr(korisnik_data);
                }
    			else
                {
