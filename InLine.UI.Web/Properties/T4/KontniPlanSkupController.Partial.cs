...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class KontniPlanSkupController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IKontniPlanSkup _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.KontniPlanSkupItem item)
    	{
    		
    		if (item.ID_KontniPlanSkup == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.KontniPlanSkupItem item)
    	{
        ...
        public InLine.Model.Data.KontniPlanSkup FindID(long id)
        {
    		InLine.Model.Data.KontniPlanSkup rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.KontniPlanSkup> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.KontniPlanSkup> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.KontniPlanSkup> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.KontniPlanSkup> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.KontniPlanSkup(korisnik_data);
                }
    			else
                {
