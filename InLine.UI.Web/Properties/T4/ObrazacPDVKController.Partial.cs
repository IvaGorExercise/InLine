...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ObrazacPDVKController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IObrazacPDVK _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ObrazacPDVKItem item)
    	{
    		
    		if (item.ID_ObrazacPDVK == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ObrazacPDVKItem item)
    	{
        ...
        public InLine.Model.Data.ObrazacPDVK FindID(long id)
        {
    		InLine.Model.Data.ObrazacPDVK rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ObrazacPDVK> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ObrazacPDVK> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ObrazacPDVK> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ObrazacPDVK> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_ObrazacPDVK")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ObrazacPDVK(korisnik_data);
                }
    			else
                {
