...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class DohodakOdbitakController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IDohodakOdbitak _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.DohodakOdbitakItem item)
    	{
    		
    		if (item.ID_DohodakOdbitak == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.DohodakOdbitakItem item)
    	{
        ...
        public InLine.Model.Data.DohodakOdbitak FindID(long id)
        {
    		InLine.Model.Data.DohodakOdbitak rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.DohodakOdbitak> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.DohodakOdbitak> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.DohodakOdbitak> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.DohodakOdbitak> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_DohodakOdbitak")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.DohodakOdbitak(korisnik_data);
                }
    			else
                {
