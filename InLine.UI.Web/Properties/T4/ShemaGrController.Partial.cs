...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ShemaGrController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IShemaGr _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ShemaGrItem item)
    	{
    		
    		if (item.ID_ShemaGr == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ShemaGrItem item)
    	{
        ...
        public InLine.Model.Data.ShemaGr FindID(long id)
        {
    		InLine.Model.Data.ShemaGr rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ShemaGr> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ShemaGr> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ShemaGr> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ShemaGr> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ShemaGr(korisnik_data);
                }
    			else
                {
