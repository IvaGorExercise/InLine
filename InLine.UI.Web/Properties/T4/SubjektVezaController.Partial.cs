...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class SubjektVezaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.ISubjektVeza _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.SubjektVezaItem item)
    	{
    		
    		if (item.ID_SubjektVeza == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.SubjektVezaItem item)
    	{
        ...
        public InLine.Model.Data.SubjektVeza FindID(long id)
        {
    		InLine.Model.Data.SubjektVeza rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.SubjektVeza> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.SubjektVeza> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.SubjektVeza> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.SubjektVeza> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_SubjektVeza")
    				{
    				...
    				if (searchingName == "ID_SubjektNad")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.SubjektVeza(korisnik_data);
                }
    			else
                {
