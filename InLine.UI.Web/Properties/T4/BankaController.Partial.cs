...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class BankaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IBanka _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.BankaItem item)
    	{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.BankaItem item)
    	{
        ...
        public InLine.Model.Data.Banka FindID(long id)
        {
    		InLine.Model.Data.Banka rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.Banka> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.Banka> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.Banka> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.Banka> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.Banka(korisnik_data);
                }
    			else
                {
