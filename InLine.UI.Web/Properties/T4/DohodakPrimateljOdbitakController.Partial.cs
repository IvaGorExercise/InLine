...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class DohodakPrimateljOdbitakController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IDohodakPrimateljOdbitak _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.DohodakPrimateljOdbitakItem item)
    	{
    		
    		if (item.ID_DohodakPrimateljOdbitak == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.DohodakPrimateljOdbitakItem item)
    	{
        ...
        public InLine.Model.Data.DohodakPrimateljOdbitak FindID(long id)
        {
    		InLine.Model.Data.DohodakPrimateljOdbitak rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.DohodakPrimateljOdbitak> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.DohodakPrimateljOdbitak> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.DohodakPrimateljOdbitak> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.DohodakPrimateljOdbitak> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_DohodakPrimateljOdbitak";
            }
    		...
    		public string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_DohodakPrimateljOdbitak")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.DohodakPrimateljOdbitak(korisnik_data);
                }
    			else
                {
