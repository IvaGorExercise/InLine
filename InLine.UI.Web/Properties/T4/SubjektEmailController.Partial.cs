...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class SubjektEmailController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.ISubjektEmail _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.SubjektEmailItem item)
    	{
    		
    		if (item.ID_SubjektEmail == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.SubjektEmailItem item)
    	{
        ...
        public InLine.Model.Data.SubjektEmail FindID(long id)
        {
    		InLine.Model.Data.SubjektEmail rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.SubjektEmail> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.SubjektEmail> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.SubjektEmail> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.SubjektEmail> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_SubjektEmail")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.SubjektEmail(korisnik_data);
                }
    			else
                {
