...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class PrimitakGrPrimitakController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IPrimitakGrPrimitak _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.PrimitakGrPrimitakItem item)
    	{
    		
    		if (item.ID_PrimitakGrPrimitak == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.PrimitakGrPrimitakItem item)
    	{
        ...
        public InLine.Model.Data.PrimitakGrPrimitak FindID(long id)
        {
    		InLine.Model.Data.PrimitakGrPrimitak rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.PrimitakGrPrimitak> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.PrimitakGrPrimitak> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.PrimitakGrPrimitak> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.PrimitakGrPrimitak> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_PrimitakGrPrimitak";
            }
    		...
    		public string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_PrimitakGrPrimitak")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.PrimitakGrPrimitak(korisnik_data);
                }
    			else
                {
