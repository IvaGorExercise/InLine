...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ObveznicaJavniDugController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IObveznicaJavniDug _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ObveznicaJavniDugItem item)
    	{
    		
    		if (item.ID_ObveznicaJavniDug == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ObveznicaJavniDugItem item)
    	{
        ...
        public InLine.Model.Data.ObveznicaJavniDug FindID(long id)
        {
    		InLine.Model.Data.ObveznicaJavniDug rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ObveznicaJavniDug> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ObveznicaJavniDug> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ObveznicaJavniDug> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ObveznicaJavniDug> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_ObveznicaJavniDug")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ObveznicaJavniDug(korisnik_data);
                }
    			else
                {
