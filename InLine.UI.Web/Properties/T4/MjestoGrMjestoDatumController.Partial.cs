...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class MjestoGrMjestoDatumController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IMjestoGrMjestoDatum _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.MjestoGrMjestoDatumItem item)
    	{
    		
    		if (item.ID_MjestoGrMjestoDatum == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.MjestoGrMjestoDatumItem item)
    	{
        ...
        public InLine.Model.Data.MjestoGrMjestoDatum FindID(long id)
        {
    		InLine.Model.Data.MjestoGrMjestoDatum rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.MjestoGrMjestoDatum> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.MjestoGrMjestoDatum> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.MjestoGrMjestoDatum> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.MjestoGrMjestoDatum> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_MjestoGrMjestoDatum";
            }
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.MjestoGrMjestoDatum(korisnik_data);
                }
    			else
                {
