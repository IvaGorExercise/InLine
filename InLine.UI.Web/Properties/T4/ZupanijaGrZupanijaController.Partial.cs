...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class ZupanijaGrZupanijaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IZupanijaGrZupanija _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.ZupanijaGrZupanijaItem item)
    	{
    		
    		if (item.ID_ZupanijaGrZupanija == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.ZupanijaGrZupanijaItem item)
    	{
        ...
        public InLine.Model.Data.ZupanijaGrZupanija FindID(long id)
        {
    		InLine.Model.Data.ZupanijaGrZupanija rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.ZupanijaGrZupanija> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.ZupanijaGrZupanija> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.ZupanijaGrZupanija> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.ZupanijaGrZupanija> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_ZupanijaGrZupanija";
            }
    		...
    		public string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_ZupanijaGr")
    				{
    					return String.Format("{0} {1} {2}", searchingName, searchingOperatorString, searchingValue);
    				}
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.ZupanijaGrZupanija(korisnik_data);
                }
    			else
                {
