...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class PoslovnaGodinaSubjektController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IPoslovnaGodinaSubjekt _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.PoslovnaGodinaSubjektItem item)
    	{
    		
    		if (item.ID_PoslovnaGodinaSubjekt == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.PoslovnaGodinaSubjektItem item)
    	{
        ...
        public InLine.Model.Data.PoslovnaGodinaSubjekt FindID(long id)
        {
    		InLine.Model.Data.PoslovnaGodinaSubjekt rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.PoslovnaGodinaSubjekt> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.PoslovnaGodinaSubjekt> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.PoslovnaGodinaSubjekt> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.PoslovnaGodinaSubjekt> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
            ...
            {
                fieldMain = "ID_PoslovnaGodinaSubjekt";
            }
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.PoslovnaGodinaSubjekt(korisnik_data);
                }
    			else
                {
