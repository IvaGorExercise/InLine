...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class OsobaBoravisteController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IOsobaBoraviste _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.OsobaBoravisteItem item)
    	{
    		
    		if (item.ID_OsobaBoraviste == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.OsobaBoravisteItem item)
    	{
        ...
        public InLine.Model.Data.OsobaBoraviste FindID(long id)
        {
    		InLine.Model.Data.OsobaBoraviste rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.OsobaBoraviste> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.OsobaBoraviste> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.OsobaBoraviste> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.OsobaBoraviste> rezultat;
    	...
    	public ActionResult GetGrid(JqGridRequest request, string key, string value, string viewModel, string field, long? id_master)
        {
    		...
    		public string GetFilter(string searchingName, JqGridSearchOperators searchingOperator, string searchingValue)
    		{
    			...
    			switch (searchingOperator)
    			{
    				...
    				if (searchingName == "ID_OsobaBoraviste")
    				{
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.OsobaBoraviste(korisnik_data);
                }
    			else
                {
