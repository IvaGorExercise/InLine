...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class IzvodPosiljateljController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IIzvodPosiljatelj _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.IzvodPosiljateljItem item)
    	{
    		
    		if (item.ID_IzvodPosiljatelj == -1)
    		{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.IzvodPosiljateljItem item)
    	{
        ...
        public InLine.Model.Data.IzvodPosiljatelj FindID(long id)
        {
    		InLine.Model.Data.IzvodPosiljatelj rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.IzvodPosiljatelj> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.IzvodPosiljatelj> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.IzvodPosiljatelj> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.IzvodPosiljatelj> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.IzvodPosiljatelj(korisnik_data);
                }
    			else
                {
