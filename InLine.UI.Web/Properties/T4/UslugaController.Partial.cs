...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class UslugaController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IUsluga _service;
    	...
    	public ActionResult Insert(InLine.Model.Data.Item.UslugaItem item)
    	{
    	...
    	public ActionResult Delete(InLine.Model.Data.Item.UslugaItem item)
    	{
        ...
        public InLine.Model.Data.Usluga FindID(long id)
        {
    		InLine.Model.Data.Usluga rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.Usluga> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.Usluga> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.Usluga> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.Usluga> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.Usluga(korisnik_data);
                }
    			else
                {
