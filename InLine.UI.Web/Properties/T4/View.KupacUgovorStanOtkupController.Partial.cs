...
namespace InLine.UI.Web.Controllers.View
{
    ...
    public partial class KupacUgovorStanOtkupViewController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.View.IKupacUgovorStanOtkup _service;
        ...
        public InLine.Model.Data.View.KupacUgovorStanOtkup FindID(long id)
        {
    		InLine.Model.Data.View.KupacUgovorStanOtkup rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.View.KupacUgovorStanOtkup> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.View.KupacUgovorStanOtkup> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.View.KupacUgovorStanOtkup> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.View.KupacUgovorStanOtkup> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.View.KupacUgovorStanOtkup(korisnik_data);
                }
    			else
                {
