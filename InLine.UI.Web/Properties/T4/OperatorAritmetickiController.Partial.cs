...
namespace InLine.UI.Web.Controllers
{
    ...
    public partial class OperatorAritmetickiController : Controller
    {
    	
    	#region Fields
    
    	 Service.Data.IOperatorAritmeticki _service;
        ...
        public InLine.Model.Data.OperatorAritmeticki FindID(long id)
        {
    		InLine.Model.Data.OperatorAritmeticki rezultat;
            rezultat = _service.FindID(id);
            return rezultat;  
        }
    	
    	
        //public IEnumerable<InLine.Model.Data.OperatorAritmeticki> GetGridData(string filter, string sort, long? start, long? count, bool customsearch = false)
        //{
        //    IEnumerable<InLine.Model.Data.OperatorAritmeticki> rezultat;
         //   rezultat = _service.GetGridData(filter, sort, start, count, customsearch);
         //   return rezultat;  
        //}
    
    	public IEnumerable<InLine.Model.Data.OperatorAritmeticki> GetGridData(string filter, string key, string value, string sort, long? start, long? count, bool customsearch = false)
        {
            IEnumerable<InLine.Model.Data.OperatorAritmeticki> rezultat;
    	...
    	#region Akcije
    	    ...
    	    protected override void OnActionExecuting(ActionExecutingContext filterContext)
            {
                ...
                if (korisnik_data != null)
                {
                   ...
                   _service = new Service.Data.OperatorAritmeticki(korisnik_data);
                }
    			else
                {
