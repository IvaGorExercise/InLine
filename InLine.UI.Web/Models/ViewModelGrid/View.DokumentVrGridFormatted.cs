...
namespace InLine.UI.Web.T4.GridFormattedTemplate.View
{
    ...
    public partial class DokumentVrGridFormatted
    {
        #region Properities
        ...
        public DokumentVrGridFormatted()
        { }

        public DokumentVrGridFormatted(Model.Data.View.DokumentVr gridformated)
        {
            this.ID_DokumentVr = gridformated.ID_DokumentVr;

            if (!String.IsNullOrEmpty(gridformated.Oznaka))
            {
                if (gridformated.Oznaka.Length == 4)
                {
                    this.Oznaka = gridformated.Oznaka.Substring(0, 2);
                }
