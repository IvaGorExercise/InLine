...
namespace InLine.UI.Web.T4.GridFormattedTemplate.AtributClass
{
    ...
    public static class ValutaRadna
    {
    	...
    	public static class ID_Valuta
    	{
    		public const string Item = "ID_Valuta";
    	  public const string DisplayName = "ID_Valuta"; 
    			public const string Required = "*";
     
      		public const string Formatter = "$.ID_ValutaFormatter";
    		public const string Sortable = "ID_Valuta";
    	}
    	...
    	public static class Kratica2
    	{
    		public const string Item = "Kratica2";
    	  public const string DisplayName = "Kratica2"; 
    		public const string StringLength = "Najveći broj znakova je 10";
    		public const string Formatter = "$.Kratica2Formatter";
    		public const string Sortable = "Kratica2";
    	}
    	...
    	public static class Decimale
    	{
    		public const string Item = "Decimale";
    	  public const string DisplayName = "Decimale"; 
    			public const string Required = "*";
    		public const string Formatter = "$.DecimaleFormatter";
    		public const string Sortable = "Decimale";
    	}
    
    
    	public static class NazivDio
    	{
    		public const string Item = "NazivDio";
    	  public const string DisplayName = "NazivDio"; 
    		public const string StringLength = "Najveći broj znakova je 50";
    		public const string Required = "*";
    		public const string Formatter = "$.NazivDioFormatter";
    		public const string Sortable = "NazivDio";
    	}
