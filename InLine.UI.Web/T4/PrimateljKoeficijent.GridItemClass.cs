...
namespace InLine.UI.Web.T4.GridFormattedTemplate.AtributClass
{
    ...
    public static class PrimateljKoeficijent
    {
    	...
    	public static class ID_PrimateljKoeficijent
    	{
    		public const string Item = "ID_PrimateljKoeficijent";
    		  public const string DisplayName = "ID_PrimateljKoeficijent";
    				public const string Required = "*";
     
      		public const string Formatter = "$.ID_PrimateljKoeficijentFormatter";
    		public const string Sortable = "ID_PrimateljKoeficijent";
    	}
