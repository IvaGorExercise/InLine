...
namespace InLine.UI.Web.T4.GridFormattedTemplate.AtributClass
{
    ...
    public static class Posta
    {
    	...
    	public static class StsPosta
    	{
    		public const string Item = "StsPosta";
    		  public const string DisplayName = "StsPosta";
    			public const string StringLength = "Najveći broj znakova je 1";
    		public const string Formatter = "$.StsPostaFormatter";
    		public const string Sortable = "StsPosta";
    	}
    
    
    	public static class IzborPosta
    	{
    		public const string Item = "IzborPosta";
    		  public const string DisplayName = "IzborPosta";
    				public const string Required = "*";
    		public const string Formatter = "$.IzborPostaFormatter";
    		public const string Sortable = "IzborPosta";
    	}
