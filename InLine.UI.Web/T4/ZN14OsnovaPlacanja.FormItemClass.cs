...
namespace InLine.UI.Web.T4.FormFormattedTemplate.AtributClass
{
    ...
    public static class ZN14OsnovaPlacanja
    {
    	
    
    	public static class IDZN14OsnovaPlacanja
    	{
    		public const string Item = "IDZN14OsnovaPlacanja";
    		  public const string DisplayName = "IDZN14OsnovaPlacanja";
    				public const string Required = "*";
    		public const string Sortable = "IDZN14OsnovaPlacanja";
    	}
