...
namespace InLine.UI.Web.T4.GridFormattedTemplate.View
{
    ...
    public partial class PoslovniSubjektGridFormattedBase
    {
    	#region Properities
    	...
    	public PoslovniSubjektGridFormattedBase()
        { }
    	
    	public PoslovniSubjektGridFormattedBase(Model.Data.View.PoslovniSubjekt gridformated)
    	{
