...
namespace InLine.UI.Web.T4.FormFormattedTemplate.View
{
    ...
    public partial class KriterijStDetaljFormFormattedBase
    {
    	#region Properities
    	...
    	public KriterijStDetaljFormFormattedBase()
        { }
    	
    	public KriterijStDetaljFormFormattedBase(Model.Data.View.KriterijStDetalj formformated)
    	{
