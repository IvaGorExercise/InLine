...
namespace InLine.UI.Web.T4.GridFormattedTemplate.View
{
    ...
    public partial class ZapisUgovorStanOtkupGridFormattedBase
    {
    	#region Properities
    	...
    	public ZapisUgovorStanOtkupGridFormattedBase()
        { }
    	
    	public ZapisUgovorStanOtkupGridFormattedBase(Model.Data.View.ZapisUgovorStanOtkup gridformated)
    	{
