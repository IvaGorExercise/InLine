...
namespace InLine.UI.Web.T4.FormFormattedTemplate.AtributClass
{
    ...
    public static class SubjektVezaVr
    {
    	...
    	public static class ID_SubjektVezaVr
    	{
    		public const string Item = "ID_SubjektVezaVr";
    		  public const string DisplayName = "ID_SubjektVezaVr";
    				public const string Required = "*";
     
      		public const string Sortable = "ID_SubjektVezaVr";
    	}
