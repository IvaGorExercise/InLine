...
namespace InLine.UI.Web.T4.FormFormattedTemplate
{
    ...
    public partial class ZapisFormFormattedBase
    {
        ...
        [Required(ErrorMessage = AtributClass.Zapis.ID_Zapis.Required)]
    	[DisplayName(AtributClass.Zapis.ID_Zapis.DisplayName)]
        	public long ID_Zapis { get; set; }
    
        [Required(ErrorMessage = AtributClass.Zapis.IDZapisTablica.Required)]
    	[DisplayName(AtributClass.Zapis.IDZapisTablica.DisplayName)]
       	public int IDZapisTablica { get; set; }
    
        [Required(ErrorMessage = AtributClass.Zapis.IDZapis.Required)]
    	...
    	public ZapisFormFormattedBase(Model.Data.Zapis formformated)
    	{
