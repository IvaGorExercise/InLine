...
namespace InLine.UI.Web.T4.FormFormattedTemplate.AtributClass
{
    ...
    public static class PrimitakProsjekGr
    {
    	...
    	public static class ID_PrimitakProsjekGr
    	{
    		public const string Item = "ID_PrimitakProsjekGr";
    		  public const string DisplayName = "ID_PrimitakProsjekGr";
    				public const string Required = "*";
     
      		public const string Sortable = "ID_PrimitakProsjekGr";
    	}
