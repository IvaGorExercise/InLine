...
namespace InLine.UI.Web.T4.FormFormattedTemplate.View
{
    ...
    public partial class UgovorStanOtkupOpomenaFormFormattedBase
    {
    	...
    	public UgovorStanOtkupOpomenaFormFormattedBase(Model.Data.View.UgovorStanOtkupOpomena formformated)
    	{
    	    ...
    	    this.SumaIznosDugZateznaKamata = formformated.SumaIznosDugZateznaKamata;
    	}
