...
namespace InLine.UI.Web.T4.FormFormattedTemplate.AtributClass
{
    ...
    public static class SubjektFunkcija
    {
    	
    
    	public static class IDSubjektFunkcija
    	{
    		public const string Item = "IDSubjektFunkcija";
    		  public const string DisplayName = "IDSubjektFunkcija";
    				public const string Required = "*";
    		public const string Sortable = "IDSubjektFunkcija";
    	}
