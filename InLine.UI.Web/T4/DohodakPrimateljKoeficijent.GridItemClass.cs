...
namespace InLine.UI.Web.T4.GridFormattedTemplate.AtributClass
{
    ...
    public static class DohodakPrimateljKoeficijent
    {
    	
    
    	public static class ID_DohodakPrimateljKoeficijent
    	{
    		public const string Item = "ID_DohodakPrimateljKoeficijent";
    		  public const string DisplayName = "ID_DohodakPrimateljKoeficijent";
    				public const string Required = "*";
     
      		public const string Formatter = "$.ID_DohodakPrimateljKoeficijentFormatter";
    		public const string Sortable = "ID_DohodakPrimateljKoeficijent";
    	}
