...
namespace InLine.UI.Web.T4.GridFormattedTemplate.AtributClass
{
    ...
    public static class Roba
    {
    	
    
    	public static class ID_Roba
    	{
    		public const string Item = "ID_Roba";
    		  public const string DisplayName = "ID_Roba";
    				public const string Required = "*";
     
      		public const string Formatter = "$.ID_RobaFormatter";
    		public const string Sortable = "ID_Roba";
    	}
