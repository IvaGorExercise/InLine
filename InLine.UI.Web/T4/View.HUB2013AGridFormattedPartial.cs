...
namespace InLine.UI.Web.T4.GridFormattedTemplate.View
{
    ...
    public partial class HUB2013AGridFormattedBase
    {
    	...
    	[DisplayName(AtributClass.HUB2013A.IDHUBNamjena2013AOznaka.DisplayName)]
       	[JqGridColumnSearchable(true, SearchType = JqGridColumnSearchTypes.Text, SearchOperators = JqGridSearchOperators.TextOperators)]
    	[JqGridColumnLayout(Alignment = JqGridAlignments.Left)]
    	[JqGridColumnFormatter(AtributClass.HUB2013A.IDHUBNamjena2013AOznaka.Formatter)]
    	[JqGridColumnSortable(true, Index = AtributClass.HUB2013A.IDHUBNamjena2013AOznaka.Sortable)]
    	...
    	[DisplayName(AtributClass.HUB2013A.IDHUBNamjena2013ANaziv.DisplayName)]
       	[JqGridColumnSearchable(true, SearchType = JqGridColumnSearchTypes.Text, SearchOperators = JqGridSearchOperators.TextOperators)]
    	[JqGridColumnLayout(Alignment = JqGridAlignments.Left)]
    	[JqGridColumnFormatter(AtributClass.HUB2013A.IDHUBNamjena2013ANaziv.Formatter)]
    	[JqGridColumnSortable(true, Index = AtributClass.HUB2013A.IDHUBNamjena2013ANaziv.Sortable)]
    	...
    	[DisplayName(AtributClass.HUB2013A.IDHUBPrimateljVrsta2013AOznaka.DisplayName)]
       	[JqGridColumnSearchable(true, SearchType = JqGridColumnSearchTypes.Text, SearchOperators = JqGridSearchOperators.TextOperators)]
    	[JqGridColumnLayout(Alignment = JqGridAlignments.Left)]
    	[JqGridColumnFormatter(AtributClass.HUB2013A.IDHUBPrimateljVrsta2013AOznaka.Formatter)]
    	[JqGridColumnSortable(true, Index = AtributClass.HUB2013A.IDHUBPrimateljVrsta2013AOznaka.Sortable)]
    	...
    	[DisplayName(AtributClass.HUB2013A.IDHUBPrimateljVrsta2013ANaziv.DisplayName)]
       	[JqGridColumnSearchable(true, SearchType = JqGridColumnSearchTypes.Text, SearchOperators = JqGridSearchOperators.TextOperators)]
    	[JqGridColumnLayout(Alignment = JqGridAlignments.Left)]
    	[JqGridColumnFormatter(AtributClass.HUB2013A.IDHUBPrimateljVrsta2013ANaziv.Formatter)]
    	[JqGridColumnSortable(true, Index = AtributClass.HUB2013A.IDHUBPrimateljVrsta2013ANaziv.Sortable)]
    	...
    	[DisplayName(AtributClass.HUB2013A.IDHUBTroskoviOpcija2013AOznaka.DisplayName)]
       	[JqGridColumnSearchable(true, SearchType = JqGridColumnSearchTypes.Text, SearchOperators = JqGridSearchOperators.TextOperators)]
    	[JqGridColumnLayout(Alignment = JqGridAlignments.Left)]
    	[JqGridColumnFormatter(AtributClass.HUB2013A.IDHUBTroskoviOpcija2013AOznaka.Formatter)]
    	[JqGridColumnSortable(true, Index = AtributClass.HUB2013A.IDHUBTroskoviOpcija2013AOznaka.Sortable)]
    	...
    	[DisplayName(AtributClass.HUB2013A.IDHUBTroskoviOpcija2013ANaziv.DisplayName)]
       	[JqGridColumnSearchable(true, SearchType = JqGridColumnSearchTypes.Text, SearchOperators = JqGridSearchOperators.TextOperators)]
    	[JqGridColumnLayout(Alignment = JqGridAlignments.Left)]
    	[JqGridColumnFormatter(AtributClass.HUB2013A.IDHUBTroskoviOpcija2013ANaziv.Formatter)]
    	[JqGridColumnSortable(true, Index = AtributClass.HUB2013A.IDHUBTroskoviOpcija2013ANaziv.Sortable)]
    	...
    	[DisplayName(AtributClass.HUB2013A.HUBModel2013APlatiteljOznaka.DisplayName)]
       	[JqGridColumnSearchable(true, SearchType = JqGridColumnSearchTypes.Text, SearchOperators = JqGridSearchOperators.TextOperators)]
    	[JqGridColumnLayout(Alignment = JqGridAlignments.Left)]
    	[JqGridColumnFormatter(AtributClass.HUB2013A.HUBModel2013APlatiteljOznaka.Formatter)]
    	[JqGridColumnSortable(true, Index = AtributClass.HUB2013A.HUBModel2013APlatiteljOznaka.Sortable)]
    	...
    	[DisplayName(AtributClass.HUB2013A.HUBModel2013APlatiteljPredOznaka.DisplayName)]
       	[JqGridColumnSearchable(true, SearchType = JqGridColumnSearchTypes.Text, SearchOperators = JqGridSearchOperators.TextOperators)]
    	[JqGridColumnLayout(Alignment = JqGridAlignments.Left)]
    	[JqGridColumnFormatter(AtributClass.HUB2013A.HUBModel2013APlatiteljPredOznaka.Formatter)]
    	[JqGridColumnSortable(true, Index = AtributClass.HUB2013A.HUBModel2013APlatiteljPredOznaka.Sortable)]
    	...
    	[DisplayName(AtributClass.HUB2013A.HUBModel2013APrimateljOznaka.DisplayName)]
       	[JqGridColumnSearchable(true, SearchType = JqGridColumnSearchTypes.Text, SearchOperators = JqGridSearchOperators.TextOperators)]
    	[JqGridColumnLayout(Alignment = JqGridAlignments.Left)]
    	[JqGridColumnFormatter(AtributClass.HUB2013A.HUBModel2013APrimateljOznaka.Formatter)]
    	[JqGridColumnSortable(true, Index = AtributClass.HUB2013A.HUBModel2013APrimateljOznaka.Sortable)]
    	...
    	[DisplayName(AtributClass.HUB2013A.HUBModel2013APrimateljPredOznaka.DisplayName)]
       	[JqGridColumnSearchable(true, SearchType = JqGridColumnSearchTypes.Text, SearchOperators = JqGridSearchOperators.TextOperators)]
    	[JqGridColumnLayout(Alignment = JqGridAlignments.Left)]
    	[JqGridColumnFormatter(AtributClass.HUB2013A.HUBModel2013APrimateljPredOznaka.Formatter)]
    	[JqGridColumnSortable(true, Index = AtributClass.HUB2013A.HUBModel2013APrimateljPredOznaka.Sortable)]
    	...
    	[DisplayName(AtributClass.HUB2013A.DrzavaPrimateljSif.DisplayName)]
       	[JqGridColumnSearchable(true, SearchType = JqGridColumnSearchTypes.Text, SearchOperators = JqGridSearchOperators.TextOperators)]
    	[JqGridColumnLayout(Alignment = JqGridAlignments.Left)]
    	[JqGridColumnFormatter(AtributClass.HUB2013A.DrzavaPrimateljSif.Formatter)]
    	[JqGridColumnSortable(true, Index = AtributClass.HUB2013A.DrzavaPrimateljSif.Sortable)]
    	...
    	[DisplayName(AtributClass.HUB2013A.DrzavaBankaSif.DisplayName)]
       	[JqGridColumnSearchable(true, SearchType = JqGridColumnSearchTypes.Text, SearchOperators = JqGridSearchOperators.TextOperators)]
    	[JqGridColumnLayout(Alignment = JqGridAlignments.Left)]
    	[JqGridColumnFormatter(AtributClass.HUB2013A.DrzavaBankaSif.Formatter)]
    	[JqGridColumnSortable(true, Index = AtributClass.HUB2013A.DrzavaBankaSif.Sortable)]
    	...
    	[DisplayName(AtributClass.HUB2013A.BrojUgovor.DisplayName)]
       	[JqGridColumnSearchable(true, SearchType = JqGridColumnSearchTypes.Text, SearchOperators = JqGridSearchOperators.Eq)]
    	[JqGridColumnLayout(Alignment = JqGridAlignments.Right)]
    	[JqGridColumnFormatter(AtributClass.HUB2013A.BrojUgovor.Formatter)]
    	[JqGridColumnSortable(true, Index = AtributClass.HUB2013A.BrojUgovor.Sortable)]
    	...
    	[DisplayName(AtributClass.HUB2013A.BrojObrok.DisplayName)]
       	[JqGridColumnSearchable(true, SearchType = JqGridColumnSearchTypes.Text, SearchOperators = JqGridSearchOperators.Eq)]
    	[JqGridColumnLayout(Alignment = JqGridAlignments.Right)]
    	[JqGridColumnFormatter(AtributClass.HUB2013A.BrojObrok.Formatter)]
    	[JqGridColumnSortable(true, Index = AtributClass.HUB2013A.BrojObrok.Sortable)]
        ...
        [ScaffoldColumn(false)]
       	[JqGridColumnSearchable(false, SearchType = JqGridColumnSearchTypes.Text, SearchOperators = JqGridSearchOperators.Eq)]
    	[JqGridColumnLayout(Alignment = JqGridAlignments.Right)]
    	[JqGridColumnFormatter(AtributClass.HUB2013A.ID_HUBImportHUB.Formatter)]
    	[JqGridColumnSortable(true, Index = AtributClass.HUB2013A.ID_HUBImportHUB.Sortable)]
    	...
    	[DisplayName(AtributClass.HUB2013A.Godina.DisplayName)]
       	[JqGridColumnSearchable(true, SearchType = JqGridColumnSearchTypes.Text, SearchOperators = JqGridSearchOperators.Eq)]
    	[JqGridColumnLayout(Alignment = JqGridAlignments.Right)]
    	[JqGridColumnFormatter(AtributClass.HUB2013A.Godina.Formatter)]
    	[JqGridColumnSortable(true, Index = AtributClass.HUB2013A.Godina.Sortable)]
    	...
    	[DisplayName(AtributClass.HUB2013A.Mjesec.DisplayName)]
       	[JqGridColumnSearchable(true, SearchType = JqGridColumnSearchTypes.Text, SearchOperators = JqGridSearchOperators.Eq)]
    	[JqGridColumnLayout(Alignment = JqGridAlignments.Right)]
    	[JqGridColumnFormatter(AtributClass.HUB2013A.Mjesec.Formatter)]
    	[JqGridColumnSortable(true, Index = AtributClass.HUB2013A.Mjesec.Sortable)]
        ...
        [ScaffoldColumn(false)]
       	[JqGridColumnSearchable(false, SearchType = JqGridColumnSearchTypes.Text, SearchOperators = JqGridSearchOperators.Eq)]
    	[JqGridColumnLayout(Alignment = JqGridAlignments.Right)]
    	[JqGridColumnFormatter(AtributClass.HUB2013A.ID_HUBImport.Formatter)]
    	[JqGridColumnSortable(true, Index = AtributClass.HUB2013A.ID_HUBImport.Sortable)]
    	...
    	public HUB2013AGridFormattedBase(Model.Data.View.HUB2013A gridformated)
    	{
    	    ...
    	    this.IDHUBNamjena2013AOznaka = gridformated.IDHUBNamjena2013AOznaka;
    	    this.IDHUBNamjena2013ANaziv = gridformated.IDHUBNamjena2013ANaziv;
    	    this.IDHUBPrimateljVrsta2013A = gridformated.IDHUBPrimateljVrsta2013A;
    	    this.IDHUBPrimateljVrsta2013AOznaka = gridformated.IDHUBPrimateljVrsta2013AOznaka;
    	    this.IDHUBPrimateljVrsta2013ANaziv = gridformated.IDHUBPrimateljVrsta2013ANaziv;
    	    this.IDHUBTroskoviOpcija2013A = gridformated.IDHUBTroskoviOpcija2013A;
    	    this.IDHUBTroskoviOpcija2013AOznaka = gridformated.IDHUBTroskoviOpcija2013AOznaka;
    	    this.IDHUBTroskoviOpcija2013ANaziv = gridformated.IDHUBTroskoviOpcija2013ANaziv;
    	    ...
    	    this.HUBModel2013APlatiteljOznaka = gridformated.HUBModel2013APlatiteljOznaka;
    	    this.HUBModel2013APlatiteljPredOznaka = gridformated.HUBModel2013APlatiteljPredOznaka;
    	    this.HUBModel2013APrimateljOznaka = gridformated.HUBModel2013APrimateljOznaka;
    	    this.HUBModel2013APrimateljPredOznaka = gridformated.HUBModel2013APrimateljPredOznaka;
    	    this.DrzavaPrimateljSif = gridformated.DrzavaPrimateljSif;
    	    this.DrzavaBankaSif = gridformated.DrzavaBankaSif;
