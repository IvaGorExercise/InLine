...
namespace InLine.UI.Web.T4.GridFormattedTemplate.AtributClass
{
    ...
    public static class HUBNamjena2013A
    {
    	...
    	public static class Klasifikacija
    	{
    		public const string Item = "Klasifikacija";
    	  public const string DisplayName = "Klasifikacija"; 
    		public const string StringLength = "Najveći broj znakova je 2000";
    		public const string Formatter = "$.KlasifikacijaFormatter";
    		public const string Sortable = "Klasifikacija";
    	}
