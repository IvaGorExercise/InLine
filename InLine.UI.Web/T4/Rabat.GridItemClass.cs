...
namespace InLine.UI.Web.T4.GridFormattedTemplate.AtributClass
{
    ...
    public static class Rabat
    {
    	...
    	public static class ID_Rabat
    	{
    		public const string Item = "ID_Rabat";
    		  public const string DisplayName = "ID_Rabat";
    				public const string Required = "*";
     
      		public const string Formatter = "$.ID_RabatFormatter";
    		public const string Sortable = "ID_Rabat";
    	}
