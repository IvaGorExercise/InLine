...
namespace InLine.UI.Web.T4.GridFormattedTemplate.AtributClass
{
    ...
    public static class MjestoGrTip
    {
    	
    
    	public static class ID_MjestoGrTip
    	{
    		public const string Item = "ID_MjestoGrTip";
    		  public const string DisplayName = "ID_MjestoGrTip";
    				public const string Required = "*";
     
      		public const string Formatter = "$.ID_MjestoGrTipFormatter";
    		public const string Sortable = "ID_MjestoGrTip";
    	}
    	...
    	public static class StsMjestoGrTip
    	{
    		public const string Item = "StsMjestoGrTip";
    		  public const string DisplayName = "StsMjestoGrTip";
    			public const string StringLength = "Najveći broj znakova je 1";
    		public const string Formatter = "$.StsMjestoGrTipFormatter";
    		public const string Sortable = "StsMjestoGrTip";
    	}
