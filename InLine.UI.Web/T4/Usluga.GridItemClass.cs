...
namespace InLine.UI.Web.T4.GridFormattedTemplate.AtributClass
{
    ...
    public static class Usluga
    {
    	
    
    	public static class ID_Usluga
    	{
    		public const string Item = "ID_Usluga";
    		  public const string DisplayName = "ID_Usluga";
    				public const string Required = "*";
     
      		public const string Formatter = "$.ID_UslugaFormatter";
    		public const string Sortable = "ID_Usluga";
    	}
