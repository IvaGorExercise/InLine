...
namespace InLine.UI.Web.T4.GridFormattedTemplate.AtributClass
{
    ...
    public static class OpcinaTip
    {
    	...
    	public static class StsOpcinaTip
    	{
    		public const string Item = "StsOpcinaTip";
    		  public const string DisplayName = "StsOpcinaTip";
    			public const string StringLength = "Najveći broj znakova je 1";
    		public const string Formatter = "$.StsOpcinaTipFormatter";
    		public const string Sortable = "StsOpcinaTip";
    	}
