...
namespace InLine.UI.Web.T4.GridFormattedTemplate.View
{
    ...
    public partial class UgovorStanOtkupOpomenaGridFormattedBase
    {
    	#region Properities
    	...
    	public UgovorStanOtkupOpomenaGridFormattedBase()
        { }
    	
    	public UgovorStanOtkupOpomenaGridFormattedBase(Model.Data.View.UgovorStanOtkupOpomena gridformated)
    	{
