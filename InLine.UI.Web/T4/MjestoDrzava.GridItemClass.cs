...
namespace InLine.UI.Web.T4.GridFormattedTemplate.AtributClass
{
    ...
    public static class MjestoDrzava
    {
    	...
    	public static class ID_MjestoDrzava
    	{
    		public const string Item = "ID_MjestoDrzava";
    		  public const string DisplayName = "ID_MjestoDrzava";
    				public const string Required = "*";
     
      		public const string Formatter = "$.ID_MjestoDrzavaFormatter";
    		public const string Sortable = "ID_MjestoDrzava";
    	}
