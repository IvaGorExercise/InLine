...
namespace InLine.UI.Web.T4.FormFormattedTemplate.AtributClass
{
    ...
    public static class PrimitakProsjekIznos
    {
    	...
    	public static class IDPrimitakProsjekIznos
    	{
    		public const string Item = "IDPrimitakProsjekIznos";
    		  public const string DisplayName = "IDPrimitakProsjekIznos";
    				public const string Required = "*";
    		public const string Sortable = "IDPrimitakProsjekIznos";
    	}
