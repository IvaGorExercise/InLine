...
namespace InLine.UI.Web.T4.FormFormattedTemplate.AtributClass
{
    ...
    public static class DavanjePDVVr
    {
    	...
    	public static class IDDavanjePDVVr
    	{
    		public const string Item = "IDDavanjePDVVr";
    		  public const string DisplayName = "IDDavanjePDVVr";
    				public const string Required = "*";
    		public const string Sortable = "IDDavanjePDVVr";
    	}
