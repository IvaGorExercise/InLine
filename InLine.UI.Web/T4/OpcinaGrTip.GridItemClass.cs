...
namespace InLine.UI.Web.T4.GridFormattedTemplate.AtributClass
{
    ...
    public static class OpcinaGrTip
    {
    	
    
    	public static class ID_OpcinaGrTip
    	{
    		public const string Item = "ID_OpcinaGrTip";
    		  public const string DisplayName = "ID_OpcinaGrTip";
    				public const string Required = "*";
     
      		public const string Formatter = "$.ID_OpcinaGrTipFormatter";
    		public const string Sortable = "ID_OpcinaGrTip";
    	}
    	...
    	public static class StsOpcinaGrTip
    	{
    		public const string Item = "StsOpcinaGrTip";
    		  public const string DisplayName = "StsOpcinaGrTip";
    			public const string StringLength = "Najveći broj znakova je 1";
    		public const string Formatter = "$.StsOpcinaGrTipFormatter";
    		public const string Sortable = "StsOpcinaGrTip";
    	}
