...
namespace InLine.UI.Web.T4.GridFormattedTemplate.AtributClass
{
    ...
    public static class MjestoGrMjesto
    {
    	...
    	public static class ID_MjestoGr
    	{
    		public const string Item = "ID_MjestoGr";
    		  public const string DisplayName = "ID_MjestoGr";
    				public const string Required = "*";
    		public const string Formatter = "$.ID_MjestoGrFormatter";
    		public const string Sortable = "ID_MjestoGr";
    	}
