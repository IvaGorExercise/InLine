...
namespace InLine.UI.Web.T4.GridFormattedTemplate.View
{
    ...
    public partial class PoslovnaGodinaPoslovniSubjektGridFormattedBase
    {
    	#region Properities
    	...
    	public PoslovnaGodinaPoslovniSubjektGridFormattedBase()
        { }
    	
    	public PoslovnaGodinaPoslovniSubjektGridFormattedBase(Model.Data.View.PoslovnaGodinaPoslovniSubjekt gridformated)
    	{
