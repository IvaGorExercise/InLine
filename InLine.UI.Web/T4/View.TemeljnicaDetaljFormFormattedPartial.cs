...
namespace InLine.UI.Web.T4.FormFormattedTemplate.View
{
    ...
    public partial class TemeljnicaDetaljFormFormattedBase
    {
    	#region Properities
    	...
    	public TemeljnicaDetaljFormFormattedBase()
        { }
    	
    	public TemeljnicaDetaljFormFormattedBase(Model.Data.View.TemeljnicaDetalj formformated)
    	{
