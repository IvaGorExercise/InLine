...
namespace InLine.UI.Web.T4.FormFormattedTemplate.AtributClass
{
    ...
    public static class ObrazacRSmStaz2005A
    {
    	...
    	public static class IDObrazacRSmStaz2005A
    	{
    		public const string Item = "IDObrazacRSmStaz2005A";
    		  public const string DisplayName = "IDObrazacRSmStaz2005A";
    				public const string Required = "*";
    		public const string Sortable = "IDObrazacRSmStaz2005A";
    	}
