...
namespace InLine.UI.Web.T4.GridFormattedTemplate.AtributClass
{
    ...
    public static class ZupanijaGrZupanijaDatum
    {
    	...
    	public static class ID_ZupanijaGrZupanijaDatum
    	{
    		public const string Item = "ID_ZupanijaGrZupanijaDatum";
    		  public const string DisplayName = "ID_ZupanijaGrZupanijaDatum";
    				public const string Required = "*";
     
      		public const string Formatter = "$.ID_ZupanijaGrZupanijaDatumFormatter";
    		public const string Sortable = "ID_ZupanijaGrZupanijaDatum";
    	}
    
    
    	public static class ID_ZupanijaGrZupanija
    	{
    		public const string Item = "ID_ZupanijaGrZupanija";
    		  public const string DisplayName = "ID_ZupanijaGrZupanija";
    				public const string Required = "*";
    		public const string Formatter = "$.ID_ZupanijaGrZupanijaFormatter";
    		public const string Sortable = "ID_ZupanijaGrZupanija";
    	}
