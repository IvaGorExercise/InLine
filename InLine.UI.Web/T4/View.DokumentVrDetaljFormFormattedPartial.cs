...
namespace InLine.UI.Web.T4.FormFormattedTemplate.View
{
    ...
    public partial class DokumentVrDetaljFormFormattedBase
    {
    	#region Properities
    	...
    	public DokumentVrDetaljFormFormattedBase()
        { }
    	
    	public DokumentVrDetaljFormFormattedBase(Model.Data.View.DokumentVrDetalj formformated)
    	{
