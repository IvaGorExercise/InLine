...
namespace InLine.UI.Web.T4.FormFormattedTemplate.View
{
    ...
    public partial class StanDetaljFormFormattedBase
    {
    	#region Properities
    	...
    	public StanDetaljFormFormattedBase()
        { }
    	
    	public StanDetaljFormFormattedBase(Model.Data.View.StanDetalj formformated)
    	{
