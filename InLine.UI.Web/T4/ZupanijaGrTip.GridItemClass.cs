...
namespace InLine.UI.Web.T4.GridFormattedTemplate.AtributClass
{
    ...
    public static class ZupanijaGrTip
    {
    	
    
    	public static class ID_ZupanijaGrTip
    	{
    		public const string Item = "ID_ZupanijaGrTip";
    		  public const string DisplayName = "ID_ZupanijaGrTip";
    				public const string Required = "*";
     
      		public const string Formatter = "$.ID_ZupanijaGrTipFormatter";
    		public const string Sortable = "ID_ZupanijaGrTip";
    	}
    	...
    	public static class StsZupanijaGrTip
    	{
    		public const string Item = "StsZupanijaGrTip";
    		  public const string DisplayName = "StsZupanijaGrTip";
    			public const string StringLength = "Najveći broj znakova je 1";
    		public const string Formatter = "$.StsZupanijaGrTipFormatter";
    		public const string Sortable = "StsZupanijaGrTip";
    	}
