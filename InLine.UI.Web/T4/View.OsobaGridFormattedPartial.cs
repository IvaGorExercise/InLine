...
namespace InLine.UI.Web.T4.GridFormattedTemplate.View
{
    ...
    public partial class OsobaGridFormattedBase
    {
    	...
    	[JqGridColumnSortable(true, Index = AtributClass.Osoba.NazivDrzavljanstvo.Sortable)]
    	...
    	[JqGridColumnSortable(true, Index = AtributClass.Osoba.NazivNarodnost.Sortable)]
    	...
    	public OsobaGridFormattedBase(Model.Data.View.Osoba gridformated)
    	{
