...
namespace InLine.UI.Web.T4.FormFormattedTemplate.AtributClass
{
    ...
    public static class KalendarGodinaTjedan
    {
    	
    
    	public static class GodinaTjedan
    	{
    		public const string Item = "GodinaTjedan";
    		  public const string DisplayName = "GodinaTjedan";
    				public const string Required = "*";
    		public const string Sortable = "GodinaTjedan";
    	}
