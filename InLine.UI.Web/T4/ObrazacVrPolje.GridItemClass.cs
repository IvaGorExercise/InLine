...
namespace InLine.UI.Web.T4.GridFormattedTemplate.AtributClass
{
    ...
    public static class ObrazacVrPolje
    {
    	...
    	public static class ID_ObrazacVrPoljeTip
    	{
    		public const string Item = "ID_ObrazacVrPoljeTip";
    		  public const string DisplayName = "ID_ObrazacVrPoljeTip";
    				public const string Required = "*";
    		public const string Formatter = "$.ID_ObrazacVrPoljeTipFormatter";
    		public const string Sortable = "ID_ObrazacVrPoljeTip";
    	}
