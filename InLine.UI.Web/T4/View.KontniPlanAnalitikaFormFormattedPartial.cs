...
namespace InLine.UI.Web.T4.FormFormattedTemplate.View
{
    ...
    public partial class KontniPlanAnalitikaFormFormattedBase
    {
    	...
    	public KontniPlanAnalitikaFormFormattedBase(Model.Data.View.KontniPlanAnalitika formformated)
    	{
    	    ...
    	    this.ZapisVrNaziv = formformated.ZapisVrNaziv;
    	    this.ZapisVrNazivKr = formformated.ZapisVrNazivKr;
    	    this.ZapisVrKratica = formformated.ZapisVrKratica;
    	}
