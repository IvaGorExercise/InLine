...
namespace InLine.UI.Web.T4.GridFormattedTemplate.AtributClass
{
    ...
    public static class MjestoGrMjestoDatum
    {
    	...
    	public static class ID_MjestoGrMjestoDatum
    	{
    		public const string Item = "ID_MjestoGrMjestoDatum";
    		  public const string DisplayName = "ID_MjestoGrMjestoDatum";
    				public const string Required = "*";
     
      		public const string Formatter = "$.ID_MjestoGrMjestoDatumFormatter";
    		public const string Sortable = "ID_MjestoGrMjestoDatum";
    	}
    
    
    	public static class ID_MjestoGrMjesto
    	{
    		public const string Item = "ID_MjestoGrMjesto";
    		  public const string DisplayName = "ID_MjestoGrMjesto";
    				public const string Required = "*";
    		public const string Formatter = "$.ID_MjestoGrMjestoFormatter";
    		public const string Sortable = "ID_MjestoGrMjesto";
    	}
