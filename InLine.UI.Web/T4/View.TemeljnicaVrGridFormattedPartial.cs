...
namespace InLine.UI.Web.T4.GridFormattedTemplate.View
{
    ...
    public partial class TemeljnicaVrGridFormattedBase
    {
    	#region Properities
    	...
    	public TemeljnicaVrGridFormattedBase()
        { }
    	
    	public TemeljnicaVrGridFormattedBase(Model.Data.View.TemeljnicaVr gridformated)
    	{
