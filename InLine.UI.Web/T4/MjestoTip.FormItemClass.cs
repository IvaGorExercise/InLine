...
namespace InLine.UI.Web.T4.FormFormattedTemplate.AtributClass
{
    ...
    public static class MjestoTip
    {
    	...
    	public static class StsMjestoTip
    	{
    		public const string Item = "StsMjestoTip";
    		  public const string DisplayName = "StsMjestoTip";
    			public const string StringLength = "Najveći broj znakova je 1";
    		public const string Sortable = "StsMjestoTip";
    	}
