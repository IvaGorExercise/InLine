...
namespace InLine.UI.Web.T4.GridFormattedTemplate.AtributClass
{
    ...
    public static class DatotekaVrPoljeTip
    {
    	...
    	public static class Velicina
    	{
    		public const string Item = "Velicina";
    		  public const string DisplayName = "Velicina";
    				public const string Formatter = "$.VelicinaFormatter";
    		public const string Sortable = "Velicina";
    	}
    
    
    	public static class ValueMin
    	{
    		public const string Item = "ValueMin";
    		  public const string DisplayName = "ValueMin";
    				public const string Formatter = "$.ValueMinFormatter";
    		public const string Sortable = "ValueMin";
    	}
    
    
    	public static class ValueMax
    	{
    		public const string Item = "ValueMax";
    		  public const string DisplayName = "ValueMax";
    				public const string Formatter = "$.ValueMaxFormatter";
    		public const string Sortable = "ValueMax";
    	}
