...
namespace InLine.UI.Web.T4.FormFormattedTemplate.View
{
    ...
    public partial class KontniPlanDetaljFormFormattedBase
    {
    	#region Properities
    	...
    	public KontniPlanDetaljFormFormattedBase()
        { }
    	
    	public KontniPlanDetaljFormFormattedBase(Model.Data.View.KontniPlanDetalj formformated)
    	{
