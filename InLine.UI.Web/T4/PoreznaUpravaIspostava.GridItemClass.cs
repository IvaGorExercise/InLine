...
namespace InLine.UI.Web.T4.GridFormattedTemplate.AtributClass
{
    ...
    public static class PoreznaUpravaIspostava
    {
    	...
    	public static class ID_PoreznaUpravaIspostava
    	{
    		public const string Item = "ID_PoreznaUpravaIspostava";
    		  public const string DisplayName = "ID_PoreznaUpravaIspostava";
    				public const string Required = "*";
     
      		public const string Formatter = "$.ID_PoreznaUpravaIspostavaFormatter";
    		public const string Sortable = "ID_PoreznaUpravaIspostava";
    	}
    
    
    	public static class ID_PoreznaUprava
    	{
    		public const string Item = "ID_PoreznaUprava";
    		  public const string DisplayName = "ID_PoreznaUprava";
    				public const string Required = "*";
    		public const string Formatter = "$.ID_PoreznaUpravaFormatter";
    		public const string Sortable = "ID_PoreznaUprava";
    	}
    	...
    	public static class Sifra
    	{
    		public const string Item = "Sifra";
    		  public const string DisplayName = "Sifra";
    			public const string StringLength = "Najveći broj znakova je 4";
    		public const string Required = "*";
    		public const string Formatter = "$.SifraFormatter";
    		public const string Sortable = "Sifra";
    	}
