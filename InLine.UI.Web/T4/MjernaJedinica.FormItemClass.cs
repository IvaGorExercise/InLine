...
namespace InLine.UI.Web.T4.FormFormattedTemplate.AtributClass
{
    ...
    public static class MjernaJedinica
    {
    	...
    	public static class ID_MjernaJedinica
    	{
    		public const string Item = "ID_MjernaJedinica";
    	  public const string DisplayName = "ID_MjernaJedinica"; 
    			public const string Required = "*";
     
      		public const string Sortable = "ID_MjernaJedinica";
    	}
