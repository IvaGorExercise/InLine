...
namespace InLine.UI.Web.T4.FormFormattedTemplate.View
{
    ...
    public partial class KriterijStKriterijStKriterijStFormFormattedBase
    {
    	#region Properities
    	...
    	public KriterijStKriterijStKriterijStFormFormattedBase()
        { }
    	
    	public KriterijStKriterijStKriterijStFormFormattedBase(Model.Data.View.KriterijStKriterijStKriterijSt formformated)
    	{
