...
namespace InLine.UI.Web.T4.GridFormattedTemplate.AtributClass
{
    ...
    public static class Vozilo
    {
    	...
    	public static class ID_Vozilo
    	{
    		public const string Item = "ID_Vozilo";
    		  public const string DisplayName = "ID_Vozilo";
    				public const string Required = "*";
     
      		public const string Formatter = "$.ID_VoziloFormatter";
    		public const string Sortable = "ID_Vozilo";
    	}
    	...
    	{
    		public const string Item = "Registracija";
    		  public const string DisplayName = "Registracija";
    			public const string StringLength = "Najveći broj znakova je 50";
    		public const string Required = "*";
    		public const string Formatter = "$.RegistracijaFormatter";
    		public const string Sortable = "Registracija";
    	}
