...
namespace InLine.UI.Web.T4.GridFormattedTemplate.AtributClass
{
    ...
    public static class OpcinaGrOpcina
    {
    	...
    	public static class ID_OpcinaGr
    	{
    		public const string Item = "ID_OpcinaGr";
    		  public const string DisplayName = "ID_OpcinaGr";
    				public const string Required = "*";
    		public const string Formatter = "$.ID_OpcinaGrFormatter";
    		public const string Sortable = "ID_OpcinaGr";
    	}
