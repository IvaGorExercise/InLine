...
namespace InLine.UI.Web.T4.FormFormattedTemplate.View
{
    ...
    public partial class UgovorStanOtkupTrosakDetaljFormFormattedBase
    {
    	#region Properities
    	...
    	public UgovorStanOtkupTrosakDetaljFormFormattedBase()
        { }
    	
    	public UgovorStanOtkupTrosakDetaljFormFormattedBase(Model.Data.View.UgovorStanOtkupTrosakDetalj formformated)
    	{
