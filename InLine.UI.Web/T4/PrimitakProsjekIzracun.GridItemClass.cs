...
namespace InLine.UI.Web.T4.GridFormattedTemplate.AtributClass
{
    ...
    public static class PrimitakProsjekIzracun
    {
    	...
    	public static class IDPrimitakProsjekIzracun
    	{
    		public const string Item = "IDPrimitakProsjekIzracun";
    		  public const string DisplayName = "IDPrimitakProsjekIzracun";
    				public const string Required = "*";
    		public const string Formatter = "$.IDPrimitakProsjekIzracunFormatter";
    		public const string Sortable = "IDPrimitakProsjekIzracun";
    	}
