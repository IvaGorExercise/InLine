...
namespace InLine.UI.Web.T4.FormFormattedTemplate.View
{
    ...
    public partial class UgovorStanOtkupMoratorijMjesecDetaljFormFormattedBase
    {
    	#region Properities
    	...
    	public UgovorStanOtkupMoratorijMjesecDetaljFormFormattedBase()
        { }
    	
    	public UgovorStanOtkupMoratorijMjesecDetaljFormFormattedBase(Model.Data.View.UgovorStanOtkupMoratorijMjesecDetalj formformated)
    	{
