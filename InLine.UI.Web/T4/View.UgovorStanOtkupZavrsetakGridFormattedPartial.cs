...
namespace InLine.UI.Web.T4.GridFormattedTemplate.View
{
    ...
    public partial class UgovorStanOtkupZavrsetakGridFormattedBase
    {
    	#region Properities
    	...
    	public UgovorStanOtkupZavrsetakGridFormattedBase()
        { }
    	
    	public UgovorStanOtkupZavrsetakGridFormattedBase(Model.Data.View.UgovorStanOtkupZavrsetak gridformated)
    	{
