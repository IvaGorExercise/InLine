...
namespace InLine.UI.Web.T4.GridFormattedTemplate.AtributClass
{
    ...
    public static class ZupanijaGrZupanija
    {
    	...
    	public static class ID_ZupanijaGr
    	{
    		public const string Item = "ID_ZupanijaGr";
    		  public const string DisplayName = "ID_ZupanijaGr";
    				public const string Required = "*";
    		public const string Formatter = "$.ID_ZupanijaGrFormatter";
    		public const string Sortable = "ID_ZupanijaGr";
    	}
