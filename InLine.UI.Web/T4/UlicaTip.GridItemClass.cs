...
namespace InLine.UI.Web.T4.GridFormattedTemplate.AtributClass
{
    ...
    public static class UlicaTip
    {
    	...
    	public static class StsUlicaTip
    	{
    		public const string Item = "StsUlicaTip";
    		  public const string DisplayName = "StsUlicaTip";
    			public const string StringLength = "Najveći broj znakova je 1";
    		public const string Formatter = "$.StsUlicaTipFormatter";
    		public const string Sortable = "StsUlicaTip";
    	}
