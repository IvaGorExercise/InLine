...
namespace InLine.UI.Web.T4.GridFormattedTemplate.AtributClass
{
    ...
    public static class Datoteka
    {
    	...
    	public static class ID_ZapisIzvor
    	{
    		public const string Item = "ID_ZapisIzvor";
    		  public const string DisplayName = "ID_ZapisIzvor";
    				public const string Formatter = "$.ID_ZapisIzvorFormatter";
    		public const string Sortable = "ID_ZapisIzvor";
    	}
    	...
    	{
    		public const string Item = "Sadrzaj";
    		  public const string DisplayName = "Sadrzaj";
    				public const string Required = "*";
    		public const string Formatter = "$.SadrzajFormatter";
    		public const string Sortable = "Sadrzaj";
    	}
