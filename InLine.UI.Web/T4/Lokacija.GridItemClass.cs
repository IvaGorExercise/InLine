...
namespace InLine.UI.Web.T4.GridFormattedTemplate.AtributClass
{
    ...
    public static class Lokacija
    {
    	...
    	public static class ID_Nekretnina
    	{
    		public const string Item = "ID_Nekretnina";
    		  public const string DisplayName = "ID_Nekretnina";
    				public const string Formatter = "$.ID_NekretninaFormatter";
    		public const string Sortable = "ID_Nekretnina";
    	}
