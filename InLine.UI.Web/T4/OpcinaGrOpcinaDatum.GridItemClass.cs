...
namespace InLine.UI.Web.T4.GridFormattedTemplate.AtributClass
{
    ...
    public static class OpcinaGrOpcinaDatum
    {
    	...
    	public static class ID_OpcinaGrOpcinaDatum
    	{
    		public const string Item = "ID_OpcinaGrOpcinaDatum";
    		  public const string DisplayName = "ID_OpcinaGrOpcinaDatum";
    				public const string Required = "*";
     
      		public const string Formatter = "$.ID_OpcinaGrOpcinaDatumFormatter";
    		public const string Sortable = "ID_OpcinaGrOpcinaDatum";
    	}
    
    
    	public static class ID_OpcinaGrOpcina
    	{
    		public const string Item = "ID_OpcinaGrOpcina";
    		  public const string DisplayName = "ID_OpcinaGrOpcina";
    				public const string Required = "*";
    		public const string Formatter = "$.ID_OpcinaGrOpcinaFormatter";
    		public const string Sortable = "ID_OpcinaGrOpcina";
    	}
