...
namespace InLine.Service.Data.View
{
    ...
    public partial class DokumentVrDetalj : View.IDokumentVrDetalj
    {
    	#region Fields
    
    	Repository.Data.View.IDokumentVrDetalj _repository;
        ...
        public DokumentVrDetalj(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.View.DokumentVrDetalj(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public DokumentVrDetalj(Repository.Data.View.IDokumentVrDetalj repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
        ...
        {
            Model.Data.View.DokumentVrDetalj rezultat;
        ...
        //public IEnumerable<Model.Data.View.DokumentVrDetalj> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.View.DokumentVrDetalj> rezultat;
