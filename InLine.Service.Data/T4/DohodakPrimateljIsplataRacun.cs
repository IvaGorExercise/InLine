...
namespace InLine.Service.Data
{
    ...
    public partial class DohodakPrimateljIsplataRacun : IDohodakPrimateljIsplataRacun
    {
    	#region Fields
    
    	Repository.Data.IDohodakPrimateljIsplataRacun _repository;
        ...
        public DohodakPrimateljIsplataRacun(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.DohodakPrimateljIsplataRacun(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public DohodakPrimateljIsplataRacun(Repository.Data.IDohodakPrimateljIsplataRacun repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.DohodakPrimateljIsplataRacun> SelectResult(long? ID_DohodakPrimateljIsplataRacun)
        { 
            IEnumerable<Model.Data.DohodakPrimateljIsplataRacun> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_DohodakPrimateljIsplataRacun);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.DohodakPrimateljIsplataRacunItem item)
    	{
    	...
    	public Model.Data.DohodakPrimateljIsplataRacun InsertResult(Model.Data.Item.DohodakPrimateljIsplataRacunItem item)
        { 
             Model.Data.DohodakPrimateljIsplataRacun rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.DohodakPrimateljIsplataRacunItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.DohodakPrimateljIsplataRacun UpdateResult(Model.Data.Item.DohodakPrimateljIsplataRacunItem item)
        { 
             Model.Data.DohodakPrimateljIsplataRacun rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.DohodakPrimateljIsplataRacunItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.DohodakPrimateljIsplataRacunItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.DohodakPrimateljIsplataRacun> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.DohodakPrimateljIsplataRacun> rezultat;
