...
namespace InLine.Service.Data
{
    ...
    public partial class HUBPrimateljVrsta2013A : IHUBPrimateljVrsta2013A
    {
    	#region Fields
    
    	Repository.Data.IHUBPrimateljVrsta2013A _repository;
        ...
        public HUBPrimateljVrsta2013A(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.HUBPrimateljVrsta2013A(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public HUBPrimateljVrsta2013A(Repository.Data.IHUBPrimateljVrsta2013A repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.HUBPrimateljVrsta2013A> SelectResult(int? IDHUBPrimateljVrsta2013A)
        { 
            IEnumerable<Model.Data.HUBPrimateljVrsta2013A> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(IDHUBPrimateljVrsta2013A);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.HUBPrimateljVrsta2013AItem item)
    	{
    	...
    	public Model.Data.HUBPrimateljVrsta2013A InsertResult(Model.Data.Item.HUBPrimateljVrsta2013AItem item)
        { 
             Model.Data.HUBPrimateljVrsta2013A rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.HUBPrimateljVrsta2013AItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.HUBPrimateljVrsta2013A UpdateResult(Model.Data.Item.HUBPrimateljVrsta2013AItem item)
        { 
             Model.Data.HUBPrimateljVrsta2013A rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.HUBPrimateljVrsta2013AItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.HUBPrimateljVrsta2013AItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.HUBPrimateljVrsta2013A> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.HUBPrimateljVrsta2013A> rezultat;
