...
namespace InLine.Service.Data
{
    ...
    public partial class PosebanPorezDohodak : IPosebanPorezDohodak
    {
    	#region Fields
    
    	Repository.Data.IPosebanPorezDohodak _repository;
        ...
        public PosebanPorezDohodak(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.PosebanPorezDohodak(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public PosebanPorezDohodak(Repository.Data.IPosebanPorezDohodak repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.PosebanPorezDohodak> SelectResult(long? ID_PosebanPorezDohodak)
        { 
            IEnumerable<Model.Data.PosebanPorezDohodak> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_PosebanPorezDohodak);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.PosebanPorezDohodakItem item)
    	{
    	...
    	public Model.Data.PosebanPorezDohodak InsertResult(Model.Data.Item.PosebanPorezDohodakItem item)
        { 
             Model.Data.PosebanPorezDohodak rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.PosebanPorezDohodakItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.PosebanPorezDohodak UpdateResult(Model.Data.Item.PosebanPorezDohodakItem item)
        { 
             Model.Data.PosebanPorezDohodak rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.PosebanPorezDohodakItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.PosebanPorezDohodakItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.PosebanPorezDohodak> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.PosebanPorezDohodak> rezultat;
