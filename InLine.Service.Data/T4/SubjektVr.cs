...
namespace InLine.Service.Data
{
    ...
    public partial class SubjektVr : ISubjektVr
    {
    	#region Fields
    
    	Repository.Data.ISubjektVr _repository;
        ...
        public SubjektVr(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.SubjektVr(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public SubjektVr(Repository.Data.ISubjektVr repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.SubjektVr> SelectResult(int? IDSubjektVr)
        { 
            IEnumerable<Model.Data.SubjektVr> rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.SubjektVrItem item)
    	{
    	...
    	public Model.Data.SubjektVr InsertResult(Model.Data.Item.SubjektVrItem item)
        { 
             Model.Data.SubjektVr rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.SubjektVrItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.SubjektVr UpdateResult(Model.Data.Item.SubjektVrItem item)
        { 
             Model.Data.SubjektVr rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.SubjektVrItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.SubjektVrItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.SubjektVr> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.SubjektVr> rezultat;
