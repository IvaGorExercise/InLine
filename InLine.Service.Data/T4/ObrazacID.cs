...
namespace InLine.Service.Data
{
    ...
    public partial class ObrazacID : IObrazacID
    {
    	#region Fields
    
    	Repository.Data.IObrazacID _repository;
        ...
        public ObrazacID(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.ObrazacID(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public ObrazacID(Repository.Data.IObrazacID repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.ObrazacID> SelectResult(long? ID_ObrazacID)
        { 
            IEnumerable<Model.Data.ObrazacID> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_ObrazacID);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.ObrazacIDItem item)
    	{
    	...
    	public Model.Data.ObrazacID InsertResult(Model.Data.Item.ObrazacIDItem item)
        { 
             Model.Data.ObrazacID rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.ObrazacIDItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.ObrazacID UpdateResult(Model.Data.Item.ObrazacIDItem item)
        { 
             Model.Data.ObrazacID rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.ObrazacIDItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.ObrazacIDItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.ObrazacID> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.ObrazacID> rezultat;
