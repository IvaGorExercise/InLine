...
namespace InLine.Service.Data
{
    ...
    public partial class ObrazacRSmDopusteno2005A : IObrazacRSmDopusteno2005A
    {
    	#region Fields
    
    	Repository.Data.IObrazacRSmDopusteno2005A _repository;
        ...
        public ObrazacRSmDopusteno2005A(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.ObrazacRSmDopusteno2005A(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public ObrazacRSmDopusteno2005A(Repository.Data.IObrazacRSmDopusteno2005A repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.ObrazacRSmDopusteno2005A> SelectResult(int? IDObrazacRSmObveznikVr2005A)
        { 
            IEnumerable<Model.Data.ObrazacRSmDopusteno2005A> rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.ObrazacRSmDopusteno2005AItem item)
    	{
    	...
    	public Model.Data.ObrazacRSmDopusteno2005A InsertResult(Model.Data.Item.ObrazacRSmDopusteno2005AItem item)
        { 
             Model.Data.ObrazacRSmDopusteno2005A rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.ObrazacRSmDopusteno2005AItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.ObrazacRSmDopusteno2005A UpdateResult(Model.Data.Item.ObrazacRSmDopusteno2005AItem item)
        { 
             Model.Data.ObrazacRSmDopusteno2005A rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.ObrazacRSmDopusteno2005AItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.ObrazacRSmDopusteno2005AItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.ObrazacRSmDopusteno2005A> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.ObrazacRSmDopusteno2005A> rezultat;
