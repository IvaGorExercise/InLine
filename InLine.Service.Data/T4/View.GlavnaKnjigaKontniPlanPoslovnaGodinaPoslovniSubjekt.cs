...
namespace InLine.Service.Data.View
{
    ...
    public partial class GlavnaKnjigaKontniPlanPoslovnaGodinaPoslovniSubjekt : View.IGlavnaKnjigaKontniPlanPoslovnaGodinaPoslovniSubjekt
    {
    	#region Fields
    
    	Repository.Data.View.IGlavnaKnjigaKontniPlanPoslovnaGodinaPoslovniSubjekt _repository;
        ...
        public GlavnaKnjigaKontniPlanPoslovnaGodinaPoslovniSubjekt(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.View.GlavnaKnjigaKontniPlanPoslovnaGodinaPoslovniSubjekt(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public GlavnaKnjigaKontniPlanPoslovnaGodinaPoslovniSubjekt(Repository.Data.View.IGlavnaKnjigaKontniPlanPoslovnaGodinaPoslovniSubjekt repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
        ...
        {
            Model.Data.View.GlavnaKnjigaKontniPlanPoslovnaGodinaPoslovniSubjekt rezultat;
        ...
        //public IEnumerable<Model.Data.View.GlavnaKnjigaKontniPlanPoslovnaGodinaPoslovniSubjekt> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.View.GlavnaKnjigaKontniPlanPoslovnaGodinaPoslovniSubjekt> rezultat;
