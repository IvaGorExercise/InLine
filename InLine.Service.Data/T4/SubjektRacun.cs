...
namespace InLine.Service.Data
{
    ...
    public partial class SubjektRacun : ISubjektRacun
    {
    	#region Fields
    
    	Repository.Data.ISubjektRacun _repository;
        ...
        public SubjektRacun(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.SubjektRacun(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public SubjektRacun(Repository.Data.ISubjektRacun repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.SubjektRacun> SelectResult(long? ID_SubjektRacun)
        { 
            IEnumerable<Model.Data.SubjektRacun> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_SubjektRacun);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.SubjektRacunItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.SubjektRacun UpdateResult(Model.Data.Item.SubjektRacunItem item)
        { 
             Model.Data.SubjektRacun rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.SubjektRacunItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
        ...
        //public IEnumerable<Model.Data.SubjektRacun> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.SubjektRacun> rezultat;
