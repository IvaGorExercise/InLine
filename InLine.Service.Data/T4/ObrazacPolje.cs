...
namespace InLine.Service.Data
{
    ...
    public partial class ObrazacPolje : IObrazacPolje
    {
    	#region Fields
    
    	Repository.Data.IObrazacPolje _repository;
        ...
        public ObrazacPolje(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.ObrazacPolje(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public ObrazacPolje(Repository.Data.IObrazacPolje repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.ObrazacPolje> SelectResult(long? ID_ObrazacPolje)
        { 
            IEnumerable<Model.Data.ObrazacPolje> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_ObrazacPolje);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.ObrazacPoljeItem item)
    	{
    	...
    	public Model.Data.ObrazacPolje InsertResult(Model.Data.Item.ObrazacPoljeItem item)
        { 
             Model.Data.ObrazacPolje rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.ObrazacPoljeItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.ObrazacPolje UpdateResult(Model.Data.Item.ObrazacPoljeItem item)
        { 
             Model.Data.ObrazacPolje rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.ObrazacPoljeItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.ObrazacPoljeItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.ObrazacPolje> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.ObrazacPolje> rezultat;
