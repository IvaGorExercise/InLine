...
namespace InLine.Service.Data
{
    ...
    public partial class KalendarTjedanDan : IKalendarTjedanDan
    {
    	#region Fields
    
    	Repository.Data.IKalendarTjedanDan _repository;
        ...
        public KalendarTjedanDan(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.KalendarTjedanDan(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public KalendarTjedanDan(Repository.Data.IKalendarTjedanDan repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.KalendarTjedanDan> SelectResult(int? TjedanDan)
        { 
            IEnumerable<Model.Data.KalendarTjedanDan> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(TjedanDan);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.KalendarTjedanDanItem item)
    	{
    	...
    	public Model.Data.KalendarTjedanDan InsertResult(Model.Data.Item.KalendarTjedanDanItem item)
        { 
             Model.Data.KalendarTjedanDan rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.KalendarTjedanDanItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.KalendarTjedanDan UpdateResult(Model.Data.Item.KalendarTjedanDanItem item)
        { 
             Model.Data.KalendarTjedanDan rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.KalendarTjedanDanItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.KalendarTjedanDanItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.KalendarTjedanDan> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.KalendarTjedanDan> rezultat;
