...
namespace InLine.Service.Data
{
    ...
    public partial class MjestoPosta : IMjestoPosta
    {
    	#region Fields
    
    	Repository.Data.IMjestoPosta _repository;
        ...
        public MjestoPosta(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.MjestoPosta(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public MjestoPosta(Repository.Data.IMjestoPosta repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.MjestoPosta> SelectResult(long? ID_MjestoPosta)
        { 
            IEnumerable<Model.Data.MjestoPosta> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_MjestoPosta);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.MjestoPostaItem item)
    	{
    	...
    	public Model.Data.MjestoPosta InsertResult(Model.Data.Item.MjestoPostaItem item)
        { 
             Model.Data.MjestoPosta rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.MjestoPostaItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.MjestoPosta UpdateResult(Model.Data.Item.MjestoPostaItem item)
        { 
             Model.Data.MjestoPosta rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.MjestoPostaItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.MjestoPostaItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.MjestoPosta> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.MjestoPosta> rezultat;
