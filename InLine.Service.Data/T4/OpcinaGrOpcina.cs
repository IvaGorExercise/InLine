...
namespace InLine.Service.Data
{
    ...
    public partial class OpcinaGrOpcina : IOpcinaGrOpcina
    {
    	#region Fields
    
    	Repository.Data.IOpcinaGrOpcina _repository;
        ...
        public OpcinaGrOpcina(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.OpcinaGrOpcina(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public OpcinaGrOpcina(Repository.Data.IOpcinaGrOpcina repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.OpcinaGrOpcina> SelectResult(long? ID_OpcinaGrOpcina)
        { 
            IEnumerable<Model.Data.OpcinaGrOpcina> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_OpcinaGrOpcina);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.OpcinaGrOpcinaItem item)
    	{
    	...
    	public Model.Data.OpcinaGrOpcina InsertResult(Model.Data.Item.OpcinaGrOpcinaItem item)
        { 
             Model.Data.OpcinaGrOpcina rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.OpcinaGrOpcinaItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.OpcinaGrOpcina UpdateResult(Model.Data.Item.OpcinaGrOpcinaItem item)
        { 
             Model.Data.OpcinaGrOpcina rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.OpcinaGrOpcinaItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.OpcinaGrOpcinaItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.OpcinaGrOpcina> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.OpcinaGrOpcina> rezultat;
