...
namespace InLine.Service.Data
{
    ...
    public partial class MjestoTip : IMjestoTip
    {
    	#region Fields
    
    	Repository.Data.IMjestoTip _repository;
        ...
        public MjestoTip(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.MjestoTip(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public MjestoTip(Repository.Data.IMjestoTip repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.MjestoTip> SelectResult(long? ID_MjestoTip)
        { 
            IEnumerable<Model.Data.MjestoTip> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_MjestoTip);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.MjestoTipItem item)
    	{
    	...
    	public Model.Data.MjestoTip InsertResult(Model.Data.Item.MjestoTipItem item)
        { 
             Model.Data.MjestoTip rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.MjestoTipItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.MjestoTip UpdateResult(Model.Data.Item.MjestoTipItem item)
        { 
             Model.Data.MjestoTip rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.MjestoTipItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.MjestoTipItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.MjestoTip> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.MjestoTip> rezultat;
