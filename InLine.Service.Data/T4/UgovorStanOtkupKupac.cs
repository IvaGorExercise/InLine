...
namespace InLine.Service.Data
{
    ...
    public partial class UgovorStanOtkupKupac : IUgovorStanOtkupKupac
    {
    	#region Fields
    
    	Repository.Data.IUgovorStanOtkupKupac _repository;
        ...
        public UgovorStanOtkupKupac(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.UgovorStanOtkupKupac(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public UgovorStanOtkupKupac(Repository.Data.IUgovorStanOtkupKupac repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.UgovorStanOtkupKupac> SelectResult(long? ID_UgovorStanOtkupKupac)
        { 
            IEnumerable<Model.Data.UgovorStanOtkupKupac> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_UgovorStanOtkupKupac);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.UgovorStanOtkupKupacItem item)
    	{
    	...
    	public Model.Data.UgovorStanOtkupKupac InsertResult(Model.Data.Item.UgovorStanOtkupKupacItem item)
        { 
             Model.Data.UgovorStanOtkupKupac rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.UgovorStanOtkupKupacItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.UgovorStanOtkupKupac UpdateResult(Model.Data.Item.UgovorStanOtkupKupacItem item)
        { 
             Model.Data.UgovorStanOtkupKupac rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.UgovorStanOtkupKupacItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.UgovorStanOtkupKupacItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.UgovorStanOtkupKupac> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.UgovorStanOtkupKupac> rezultat;
