...
namespace InLine.Service.Data
{
    ...
    public partial class ZupanijaGrTip : IZupanijaGrTip
    {
    	#region Fields
    
    	Repository.Data.IZupanijaGrTip _repository;
        ...
        public ZupanijaGrTip(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.ZupanijaGrTip(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public ZupanijaGrTip(Repository.Data.IZupanijaGrTip repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.ZupanijaGrTip> SelectResult(long? ID_ZupanijaGrTip)
        { 
            IEnumerable<Model.Data.ZupanijaGrTip> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_ZupanijaGrTip);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.ZupanijaGrTipItem item)
    	{
    	...
    	public Model.Data.ZupanijaGrTip InsertResult(Model.Data.Item.ZupanijaGrTipItem item)
        { 
             Model.Data.ZupanijaGrTip rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.ZupanijaGrTipItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.ZupanijaGrTip UpdateResult(Model.Data.Item.ZupanijaGrTipItem item)
        { 
             Model.Data.ZupanijaGrTip rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.ZupanijaGrTipItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.ZupanijaGrTipItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.ZupanijaGrTip> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.ZupanijaGrTip> rezultat;
