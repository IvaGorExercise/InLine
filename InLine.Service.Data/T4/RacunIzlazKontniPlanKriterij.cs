...
namespace InLine.Service.Data
{
    ...
    public partial class RacunIzlazKontniPlanKriterij : IRacunIzlazKontniPlanKriterij
    {
    	#region Fields
    
    	Repository.Data.IRacunIzlazKontniPlanKriterij _repository;
        ...
        public RacunIzlazKontniPlanKriterij(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.RacunIzlazKontniPlanKriterij(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public RacunIzlazKontniPlanKriterij(Repository.Data.IRacunIzlazKontniPlanKriterij repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.RacunIzlazKontniPlanKriterij> SelectResult(long? ID_RacunIzlazKontniPlanKriterij)
        { 
            IEnumerable<Model.Data.RacunIzlazKontniPlanKriterij> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_RacunIzlazKontniPlanKriterij);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.RacunIzlazKontniPlanKriterijItem item)
    	{
    	...
    	public Model.Data.RacunIzlazKontniPlanKriterij InsertResult(Model.Data.Item.RacunIzlazKontniPlanKriterijItem item)
        { 
             Model.Data.RacunIzlazKontniPlanKriterij rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.RacunIzlazKontniPlanKriterijItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.RacunIzlazKontniPlanKriterij UpdateResult(Model.Data.Item.RacunIzlazKontniPlanKriterijItem item)
        { 
             Model.Data.RacunIzlazKontniPlanKriterij rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.RacunIzlazKontniPlanKriterijItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.RacunIzlazKontniPlanKriterijItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.RacunIzlazKontniPlanKriterij> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.RacunIzlazKontniPlanKriterij> rezultat;
