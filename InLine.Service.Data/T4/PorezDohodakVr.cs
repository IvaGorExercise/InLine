...
namespace InLine.Service.Data
{
    ...
    public partial class PorezDohodakVr : IPorezDohodakVr
    {
    	#region Fields
    
    	Repository.Data.IPorezDohodakVr _repository;
        ...
        public PorezDohodakVr(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.PorezDohodakVr(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public PorezDohodakVr(Repository.Data.IPorezDohodakVr repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.PorezDohodakVr> SelectResult(long? ID_PorezDohodakVr)
        { 
            IEnumerable<Model.Data.PorezDohodakVr> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_PorezDohodakVr);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.PorezDohodakVrItem item)
    	{
    	...
    	public Model.Data.PorezDohodakVr InsertResult(Model.Data.Item.PorezDohodakVrItem item)
        { 
             Model.Data.PorezDohodakVr rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.PorezDohodakVrItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.PorezDohodakVr UpdateResult(Model.Data.Item.PorezDohodakVrItem item)
        { 
             Model.Data.PorezDohodakVr rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.PorezDohodakVrItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.PorezDohodakVrItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.PorezDohodakVr> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.PorezDohodakVr> rezultat;
