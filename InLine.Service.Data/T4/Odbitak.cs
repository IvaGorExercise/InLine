...
namespace InLine.Service.Data
{
    ...
    public partial class Odbitak : IOdbitak
    {
    	#region Fields
    
    	Repository.Data.IOdbitak _repository;
        ...
        public Odbitak(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.Odbitak(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public Odbitak(Repository.Data.IOdbitak repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.Odbitak> SelectResult(long? ID_Odbitak)
        { 
            IEnumerable<Model.Data.Odbitak> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_Odbitak);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.OdbitakItem item)
    	{
    	...
    	public Model.Data.Odbitak InsertResult(Model.Data.Item.OdbitakItem item)
        { 
             Model.Data.Odbitak rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.OdbitakItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.Odbitak UpdateResult(Model.Data.Item.OdbitakItem item)
        { 
             Model.Data.Odbitak rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.OdbitakItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.OdbitakItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.Odbitak> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.Odbitak> rezultat;
