...
namespace InLine.Service.Data
{
    ...
    public partial class PraznikGr : IPraznikGr
    {
    	#region Fields
    
    	Repository.Data.IPraznikGr _repository;
        ...
        public PraznikGr(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.PraznikGr(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public PraznikGr(Repository.Data.IPraznikGr repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.PraznikGr> SelectResult(long? ID_PraznikGr)
        { 
            IEnumerable<Model.Data.PraznikGr> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_PraznikGr);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.PraznikGrItem item)
    	{
    	...
    	public Model.Data.PraznikGr InsertResult(Model.Data.Item.PraznikGrItem item)
        { 
             Model.Data.PraznikGr rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.PraznikGrItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.PraznikGr UpdateResult(Model.Data.Item.PraznikGrItem item)
        { 
             Model.Data.PraznikGr rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.PraznikGrItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.PraznikGrItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.PraznikGr> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.PraznikGr> rezultat;
