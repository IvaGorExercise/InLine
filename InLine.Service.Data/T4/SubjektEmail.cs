...
namespace InLine.Service.Data
{
    ...
    public partial class SubjektEmail : ISubjektEmail
    {
    	#region Fields
    
    	Repository.Data.ISubjektEmail _repository;
        ...
        public SubjektEmail(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.SubjektEmail(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public SubjektEmail(Repository.Data.ISubjektEmail repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.SubjektEmail> SelectResult(long? ID_SubjektEmail)
        { 
            IEnumerable<Model.Data.SubjektEmail> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_SubjektEmail);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.SubjektEmailItem item)
    	{
    	...
    	public Model.Data.SubjektEmail InsertResult(Model.Data.Item.SubjektEmailItem item)
        { 
             Model.Data.SubjektEmail rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.SubjektEmailItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.SubjektEmail UpdateResult(Model.Data.Item.SubjektEmailItem item)
        { 
             Model.Data.SubjektEmail rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.SubjektEmailItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.SubjektEmailItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.SubjektEmail> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.SubjektEmail> rezultat;
