...
namespace InLine.Service.Data
{
    ...
    public partial class HUBKontrola : IHUBKontrola
    {
    	#region Fields
    
    	Repository.Data.IHUBKontrola _repository;
        ...
        public HUBKontrola(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.HUBKontrola(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public HUBKontrola(Repository.Data.IHUBKontrola repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.HUBKontrola> SelectResult(int? IDHUBKontrola)
        { 
            IEnumerable<Model.Data.HUBKontrola> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(IDHUBKontrola);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.HUBKontrolaItem item)
    	{
    	...
    	public Model.Data.HUBKontrola InsertResult(Model.Data.Item.HUBKontrolaItem item)
        { 
             Model.Data.HUBKontrola rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.HUBKontrolaItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.HUBKontrola UpdateResult(Model.Data.Item.HUBKontrolaItem item)
        { 
             Model.Data.HUBKontrola rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.HUBKontrolaItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
        ...
        //public IEnumerable<Model.Data.HUBKontrola> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.HUBKontrola> rezultat;
