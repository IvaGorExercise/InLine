...
namespace InLine.Service.Data
{
    ...
    public partial class DohodakPrimatelj : IDohodakPrimatelj
    {
    	#region Fields
    
    	Repository.Data.IDohodakPrimatelj _repository;
        ...
        public DohodakPrimatelj(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.DohodakPrimatelj(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public DohodakPrimatelj(Repository.Data.IDohodakPrimatelj repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.DohodakPrimatelj> SelectResult(long? ID_DohodakPrimatelj)
        { 
            IEnumerable<Model.Data.DohodakPrimatelj> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_DohodakPrimatelj);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.DohodakPrimateljItem item)
    	{
    	...
    	public Model.Data.DohodakPrimatelj InsertResult(Model.Data.Item.DohodakPrimateljItem item)
        { 
             Model.Data.DohodakPrimatelj rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.DohodakPrimateljItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.DohodakPrimatelj UpdateResult(Model.Data.Item.DohodakPrimateljItem item)
        { 
             Model.Data.DohodakPrimatelj rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.DohodakPrimateljItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.DohodakPrimateljItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.DohodakPrimatelj> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.DohodakPrimatelj> rezultat;
