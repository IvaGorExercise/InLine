...
namespace InLine.Service.Data
{
    ...
    public partial class OdbitakGrOdbitakGr : IOdbitakGrOdbitakGr
    {
    	#region Fields
    
    	Repository.Data.IOdbitakGrOdbitakGr _repository;
        ...
        public OdbitakGrOdbitakGr(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.OdbitakGrOdbitakGr(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public OdbitakGrOdbitakGr(Repository.Data.IOdbitakGrOdbitakGr repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.OdbitakGrOdbitakGr> SelectResult(long? ID_OdbitakGrOdbitakGr)
        { 
            IEnumerable<Model.Data.OdbitakGrOdbitakGr> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_OdbitakGrOdbitakGr);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.OdbitakGrOdbitakGrItem item)
    	{
    	...
    	public Model.Data.OdbitakGrOdbitakGr InsertResult(Model.Data.Item.OdbitakGrOdbitakGrItem item)
        { 
             Model.Data.OdbitakGrOdbitakGr rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.OdbitakGrOdbitakGrItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.OdbitakGrOdbitakGr UpdateResult(Model.Data.Item.OdbitakGrOdbitakGrItem item)
        { 
             Model.Data.OdbitakGrOdbitakGr rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.OdbitakGrOdbitakGrItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.OdbitakGrOdbitakGrItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.OdbitakGrOdbitakGr> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.OdbitakGrOdbitakGr> rezultat;
