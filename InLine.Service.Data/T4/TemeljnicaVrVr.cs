...
namespace InLine.Service.Data
{
    ...
    public partial class TemeljnicaVrVr : ITemeljnicaVrVr
    {
    	#region Fields
    
    	Repository.Data.ITemeljnicaVrVr _repository;
        ...
        public TemeljnicaVrVr(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.TemeljnicaVrVr(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public TemeljnicaVrVr(Repository.Data.ITemeljnicaVrVr repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.TemeljnicaVrVr> SelectResult(int? IDTemeljnicaVrVr)
        { 
            IEnumerable<Model.Data.TemeljnicaVrVr> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(IDTemeljnicaVrVr);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.TemeljnicaVrVrItem item)
    	{
    	...
    	public Model.Data.TemeljnicaVrVr InsertResult(Model.Data.Item.TemeljnicaVrVrItem item)
        { 
             Model.Data.TemeljnicaVrVr rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.TemeljnicaVrVrItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.TemeljnicaVrVr UpdateResult(Model.Data.Item.TemeljnicaVrVrItem item)
        { 
             Model.Data.TemeljnicaVrVr rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.TemeljnicaVrVrItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.TemeljnicaVrVrItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.TemeljnicaVrVr> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.TemeljnicaVrVr> rezultat;
