...
namespace InLine.Service.Data.View
{
    ...
    public partial class Temeljnica : View.ITemeljnica
    {
    	#region Fields
    
    	Repository.Data.View.ITemeljnica _repository;
        ...
        public Temeljnica(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.View.Temeljnica(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public Temeljnica(Repository.Data.View.ITemeljnica repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
        ...
        {
            Model.Data.View.Temeljnica rezultat;
        ...
        //public IEnumerable<Model.Data.View.Temeljnica> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.View.Temeljnica> rezultat;
