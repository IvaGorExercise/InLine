...
namespace InLine.Service.Data
{
    ...
    public partial class KontniPlan : IKontniPlan
    {
    	#region Fields
    
    	Repository.Data.IKontniPlan _repository;
        ...
        public KontniPlan(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.KontniPlan(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public KontniPlan(Repository.Data.IKontniPlan repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.KontniPlan> SelectResult(long? ID_KontniPlan)
        { 
            IEnumerable<Model.Data.KontniPlan> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_KontniPlan);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.KontniPlanItem item)
    	{
    	...
    	public Model.Data.KontniPlan InsertResult(Model.Data.Item.KontniPlanItem item)
        { 
             Model.Data.KontniPlan rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.KontniPlanItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.KontniPlan UpdateResult(Model.Data.Item.KontniPlanItem item)
        { 
             Model.Data.KontniPlan rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.KontniPlanItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.KontniPlanItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.KontniPlan> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.KontniPlan> rezultat;
