...
namespace InLine.Service.Data
{
    ...
    public partial class PorezDohodakPrirez : IPorezDohodakPrirez
    {
    	#region Fields
    
    	Repository.Data.IPorezDohodakPrirez _repository;
        ...
        public PorezDohodakPrirez(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.PorezDohodakPrirez(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public PorezDohodakPrirez(Repository.Data.IPorezDohodakPrirez repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.PorezDohodakPrirez> SelectResult(long? ID_PorezDohodakPrirez)
        { 
            IEnumerable<Model.Data.PorezDohodakPrirez> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_PorezDohodakPrirez);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.PorezDohodakPrirezItem item)
    	{
    	...
    	public Model.Data.PorezDohodakPrirez InsertResult(Model.Data.Item.PorezDohodakPrirezItem item)
        { 
             Model.Data.PorezDohodakPrirez rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.PorezDohodakPrirezItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.PorezDohodakPrirez UpdateResult(Model.Data.Item.PorezDohodakPrirezItem item)
        { 
             Model.Data.PorezDohodakPrirez rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.PorezDohodakPrirezItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.PorezDohodakPrirezItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.PorezDohodakPrirez> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.PorezDohodakPrirez> rezultat;
