...
namespace InLine.Service.Data
{
    ...
    public partial class RacunIzlazSt : IRacunIzlazSt
    {
    	#region Fields
    
    	Repository.Data.IRacunIzlazSt _repository;
        ...
        public RacunIzlazSt(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.RacunIzlazSt(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public RacunIzlazSt(Repository.Data.IRacunIzlazSt repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.RacunIzlazSt> SelectResult(long? ID_RacunIzlazSt)
        { 
            IEnumerable<Model.Data.RacunIzlazSt> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_RacunIzlazSt);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.RacunIzlazStItem item)
    	{
    	...
    	public Model.Data.RacunIzlazSt InsertResult(Model.Data.Item.RacunIzlazStItem item)
        { 
             Model.Data.RacunIzlazSt rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.RacunIzlazStItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.RacunIzlazSt UpdateResult(Model.Data.Item.RacunIzlazStItem item)
        { 
             Model.Data.RacunIzlazSt rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.RacunIzlazStItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.RacunIzlazStItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.RacunIzlazSt> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.RacunIzlazSt> rezultat;
