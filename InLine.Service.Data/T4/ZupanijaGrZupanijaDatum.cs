...
namespace InLine.Service.Data
{
    ...
    public partial class ZupanijaGrZupanijaDatum : IZupanijaGrZupanijaDatum
    {
    	#region Fields
    
    	Repository.Data.IZupanijaGrZupanijaDatum _repository;
        ...
        public ZupanijaGrZupanijaDatum(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.ZupanijaGrZupanijaDatum(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public ZupanijaGrZupanijaDatum(Repository.Data.IZupanijaGrZupanijaDatum repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.ZupanijaGrZupanijaDatum> SelectResult(long? ID_ZupanijaGrZupanijaDatum)
        { 
            IEnumerable<Model.Data.ZupanijaGrZupanijaDatum> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_ZupanijaGrZupanijaDatum);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.ZupanijaGrZupanijaDatumItem item)
    	{
    	...
    	public Model.Data.ZupanijaGrZupanijaDatum InsertResult(Model.Data.Item.ZupanijaGrZupanijaDatumItem item)
        { 
             Model.Data.ZupanijaGrZupanijaDatum rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.ZupanijaGrZupanijaDatumItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.ZupanijaGrZupanijaDatum UpdateResult(Model.Data.Item.ZupanijaGrZupanijaDatumItem item)
        { 
             Model.Data.ZupanijaGrZupanijaDatum rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.ZupanijaGrZupanijaDatumItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.ZupanijaGrZupanijaDatumItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.ZupanijaGrZupanijaDatum> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.ZupanijaGrZupanijaDatum> rezultat;
