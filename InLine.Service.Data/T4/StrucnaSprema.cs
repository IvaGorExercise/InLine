...
namespace InLine.Service.Data
{
    ...
    public partial class StrucnaSprema : IStrucnaSprema
    {
    	#region Fields
    
    	Repository.Data.IStrucnaSprema _repository;
        ...
        public StrucnaSprema(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.StrucnaSprema(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public StrucnaSprema(Repository.Data.IStrucnaSprema repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.StrucnaSprema> SelectResult(long? ID_StrucnaSprema)
        { 
            IEnumerable<Model.Data.StrucnaSprema> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_StrucnaSprema);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.StrucnaSpremaItem item)
    	{
    	...
    	public Model.Data.StrucnaSprema InsertResult(Model.Data.Item.StrucnaSpremaItem item)
        { 
             Model.Data.StrucnaSprema rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.StrucnaSpremaItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.StrucnaSprema UpdateResult(Model.Data.Item.StrucnaSpremaItem item)
        { 
             Model.Data.StrucnaSprema rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.StrucnaSpremaItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.StrucnaSpremaItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.StrucnaSprema> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.StrucnaSprema> rezultat;
