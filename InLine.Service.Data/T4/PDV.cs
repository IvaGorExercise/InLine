...
namespace InLine.Service.Data
{
    ...
    public partial class PDV : IPDV
    {
    	#region Fields
    
    	Repository.Data.IPDV _repository;
        ...
        public PDV(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.PDV(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public PDV(Repository.Data.IPDV repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.PDV> SelectResult(long? ID_PDV)
        { 
            IEnumerable<Model.Data.PDV> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_PDV);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.PDVItem item)
    	{
    	...
    	public Model.Data.PDV InsertResult(Model.Data.Item.PDVItem item)
        { 
             Model.Data.PDV rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.PDVItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.PDV UpdateResult(Model.Data.Item.PDVItem item)
        { 
             Model.Data.PDV rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.PDVItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.PDVItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.PDV> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.PDV> rezultat;
