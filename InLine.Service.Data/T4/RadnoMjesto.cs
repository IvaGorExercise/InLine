...
namespace InLine.Service.Data
{
    ...
    public partial class RadnoMjesto : IRadnoMjesto
    {
    	#region Fields
    
    	Repository.Data.IRadnoMjesto _repository;
        ...
        public RadnoMjesto(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.RadnoMjesto(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public RadnoMjesto(Repository.Data.IRadnoMjesto repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.RadnoMjesto> SelectResult(long? ID_RadnoMjesto)
        { 
            IEnumerable<Model.Data.RadnoMjesto> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_RadnoMjesto);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.RadnoMjestoItem item)
    	{
    	...
    	public Model.Data.RadnoMjesto InsertResult(Model.Data.Item.RadnoMjestoItem item)
        { 
             Model.Data.RadnoMjesto rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.RadnoMjestoItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.RadnoMjesto UpdateResult(Model.Data.Item.RadnoMjestoItem item)
        { 
             Model.Data.RadnoMjesto rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.RadnoMjestoItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.RadnoMjestoItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.RadnoMjesto> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.RadnoMjesto> rezultat;
