...
namespace InLine.Service.Data
{
    ...
    public partial class UgovorStanOtkupMoratorij : IUgovorStanOtkupMoratorij
    {
    	#region Fields
    
    	Repository.Data.IUgovorStanOtkupMoratorij _repository;
        ...
        public UgovorStanOtkupMoratorij(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.UgovorStanOtkupMoratorij(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public UgovorStanOtkupMoratorij(Repository.Data.IUgovorStanOtkupMoratorij repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.UgovorStanOtkupMoratorij> SelectResult(long? ID_UgovorStanOtkupMoratorij)
        { 
            IEnumerable<Model.Data.UgovorStanOtkupMoratorij> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_UgovorStanOtkupMoratorij);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.UgovorStanOtkupMoratorijItem item)
    	{
    	...
    	public Model.Data.UgovorStanOtkupMoratorij InsertResult(Model.Data.Item.UgovorStanOtkupMoratorijItem item)
        { 
             Model.Data.UgovorStanOtkupMoratorij rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.UgovorStanOtkupMoratorijItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.UgovorStanOtkupMoratorij UpdateResult(Model.Data.Item.UgovorStanOtkupMoratorijItem item)
        { 
             Model.Data.UgovorStanOtkupMoratorij rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.UgovorStanOtkupMoratorijItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.UgovorStanOtkupMoratorijItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.UgovorStanOtkupMoratorij> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.UgovorStanOtkupMoratorij> rezultat;
