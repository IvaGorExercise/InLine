...
namespace InLine.Service.Data
{
    ...
    public partial class Izvod : IIzvod
    {
    	#region Fields
    
    	Repository.Data.IIzvod _repository;
        ...
        public Izvod(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.Izvod(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public Izvod(Repository.Data.IIzvod repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.Izvod> SelectResult(long? ID_Izvod)
        { 
            IEnumerable<Model.Data.Izvod> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_Izvod);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.IzvodItem item)
    	{
    	...
    	public Model.Data.Izvod InsertResult(Model.Data.Item.IzvodItem item)
        { 
             Model.Data.Izvod rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.IzvodItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.Izvod UpdateResult(Model.Data.Item.IzvodItem item)
        { 
             Model.Data.Izvod rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.IzvodItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.IzvodItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.Izvod> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.Izvod> rezultat;
