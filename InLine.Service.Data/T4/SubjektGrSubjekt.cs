...
namespace InLine.Service.Data
{
    ...
    public partial class SubjektGrSubjekt : ISubjektGrSubjekt
    {
    	#region Fields
    
    	Repository.Data.ISubjektGrSubjekt _repository;
        ...
        public SubjektGrSubjekt(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.SubjektGrSubjekt(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public SubjektGrSubjekt(Repository.Data.ISubjektGrSubjekt repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.SubjektGrSubjekt> SelectResult(long? ID_SubjektGrSubjekt)
        { 
            IEnumerable<Model.Data.SubjektGrSubjekt> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_SubjektGrSubjekt);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.SubjektGrSubjektItem item)
    	{
    	...
    	public Model.Data.SubjektGrSubjekt InsertResult(Model.Data.Item.SubjektGrSubjektItem item)
        { 
             Model.Data.SubjektGrSubjekt rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.SubjektGrSubjektItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.SubjektGrSubjekt UpdateResult(Model.Data.Item.SubjektGrSubjektItem item)
        { 
             Model.Data.SubjektGrSubjekt rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.SubjektGrSubjektItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.SubjektGrSubjektItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.SubjektGrSubjekt> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.SubjektGrSubjekt> rezultat;
