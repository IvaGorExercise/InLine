...
namespace InLine.Service.Data
{
    ...
    public partial class DavanjeDoprinosDohodak : IDavanjeDoprinosDohodak
    {
    	#region Fields
    
    	Repository.Data.IDavanjeDoprinosDohodak _repository;
        ...
        public DavanjeDoprinosDohodak(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.DavanjeDoprinosDohodak(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public DavanjeDoprinosDohodak(Repository.Data.IDavanjeDoprinosDohodak repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.DavanjeDoprinosDohodak> SelectResult(int? IDDavanjeDoprinosDohodak)
        { 
            IEnumerable<Model.Data.DavanjeDoprinosDohodak> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(IDDavanjeDoprinosDohodak);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.DavanjeDoprinosDohodakItem item)
    	{
    	...
    	public Model.Data.DavanjeDoprinosDohodak InsertResult(Model.Data.Item.DavanjeDoprinosDohodakItem item)
        { 
             Model.Data.DavanjeDoprinosDohodak rezultat;
    	...
    	public Model.Data.DavanjeDoprinosDohodak UpdateResult(Model.Data.Item.DavanjeDoprinosDohodakItem item)
        { 
             Model.Data.DavanjeDoprinosDohodak rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.DavanjeDoprinosDohodakItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.DavanjeDoprinosDohodakItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.DavanjeDoprinosDohodak> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.DavanjeDoprinosDohodak> rezultat;
