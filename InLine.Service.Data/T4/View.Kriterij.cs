...
namespace InLine.Service.Data.View
{
    ...
    public partial class Kriterij : View.IKriterij
    {
    	#region Fields
    
    	Repository.Data.View.IKriterij _repository;
        ...
        public Kriterij(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.View.Kriterij(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public Kriterij(Repository.Data.View.IKriterij repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
        ...
        {
            Model.Data.View.Kriterij rezultat;
        ...
        //public IEnumerable<Model.Data.View.Kriterij> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.View.Kriterij> rezultat;
