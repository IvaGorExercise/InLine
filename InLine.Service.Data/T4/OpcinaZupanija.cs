...
namespace InLine.Service.Data
{
    ...
    public partial class OpcinaZupanija : IOpcinaZupanija
    {
    	#region Fields
    
    	Repository.Data.IOpcinaZupanija _repository;
        ...
        public OpcinaZupanija(Repository.Data.IOpcinaZupanija repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.OpcinaZupanija> SelectResult(long? ID_OpcinaZupanija)
        { 
            IEnumerable<Model.Data.OpcinaZupanija> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_OpcinaZupanija);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.OpcinaZupanijaItem item)
    	{
    	...
    	public Model.Data.OpcinaZupanija InsertResult(Model.Data.Item.OpcinaZupanijaItem item)
        { 
             Model.Data.OpcinaZupanija rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.OpcinaZupanijaItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.OpcinaZupanija UpdateResult(Model.Data.Item.OpcinaZupanijaItem item)
        { 
             Model.Data.OpcinaZupanija rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.OpcinaZupanijaItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.OpcinaZupanijaItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.OpcinaZupanija> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.OpcinaZupanija> rezultat;
