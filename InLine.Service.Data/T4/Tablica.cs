...
namespace InLine.Service.Data
{
    ...
    public partial class Tablica : ITablica
    {
    	#region Fields
    
    	Repository.Data.ITablica _repository;
        ...
        public Tablica(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.Tablica(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public Tablica(Repository.Data.ITablica repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.Tablica> SelectResult(string TablicaShema,string TablicaNaziv)
        { 
            IEnumerable<Model.Data.Tablica> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(TablicaShema,TablicaNaziv);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.TablicaItem item)
    	{
    	...
    	public Model.Data.Tablica InsertResult(Model.Data.Item.TablicaItem item)
        { 
             Model.Data.Tablica rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.TablicaItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.Tablica UpdateResult(Model.Data.Item.TablicaItem item)
        { 
             Model.Data.Tablica rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.TablicaItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.TablicaItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.Tablica> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.Tablica> rezultat;
