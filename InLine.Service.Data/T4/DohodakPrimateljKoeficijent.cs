...
namespace InLine.Service.Data
{
    ...
    public partial class DohodakPrimateljKoeficijent : IDohodakPrimateljKoeficijent
    {
    	#region Fields
    
    	Repository.Data.IDohodakPrimateljKoeficijent _repository;
        ...
        public DohodakPrimateljKoeficijent(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.DohodakPrimateljKoeficijent(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public DohodakPrimateljKoeficijent(Repository.Data.IDohodakPrimateljKoeficijent repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.DohodakPrimateljKoeficijent> SelectResult(long? ID_DohodakPrimateljKoeficijent)
        { 
            IEnumerable<Model.Data.DohodakPrimateljKoeficijent> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_DohodakPrimateljKoeficijent);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.DohodakPrimateljKoeficijentItem item)
    	{
    	...
    	public Model.Data.DohodakPrimateljKoeficijent InsertResult(Model.Data.Item.DohodakPrimateljKoeficijentItem item)
        { 
             Model.Data.DohodakPrimateljKoeficijent rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.DohodakPrimateljKoeficijentItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.DohodakPrimateljKoeficijent UpdateResult(Model.Data.Item.DohodakPrimateljKoeficijentItem item)
        { 
             Model.Data.DohodakPrimateljKoeficijent rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.DohodakPrimateljKoeficijentItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.DohodakPrimateljKoeficijentItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.DohodakPrimateljKoeficijent> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.DohodakPrimateljKoeficijent> rezultat;
