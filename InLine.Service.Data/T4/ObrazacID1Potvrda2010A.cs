...
namespace InLine.Service.Data
{
    ...
    public partial class ObrazacID1Potvrda2010A : IObrazacID1Potvrda2010A
    {
    	#region Fields
    
    	Repository.Data.IObrazacID1Potvrda2010A _repository;
        ...
        public ObrazacID1Potvrda2010A(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.ObrazacID1Potvrda2010A(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public ObrazacID1Potvrda2010A(Repository.Data.IObrazacID1Potvrda2010A repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.ObrazacID1Potvrda2010A> SelectResult(long? ID_ObrazacID1Potvrda2010A)
        { 
            IEnumerable<Model.Data.ObrazacID1Potvrda2010A> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_ObrazacID1Potvrda2010A);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.ObrazacID1Potvrda2010AItem item)
    	{
    	...
    	public Model.Data.ObrazacID1Potvrda2010A InsertResult(Model.Data.Item.ObrazacID1Potvrda2010AItem item)
        { 
             Model.Data.ObrazacID1Potvrda2010A rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.ObrazacID1Potvrda2010AItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.ObrazacID1Potvrda2010A UpdateResult(Model.Data.Item.ObrazacID1Potvrda2010AItem item)
        { 
             Model.Data.ObrazacID1Potvrda2010A rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.ObrazacID1Potvrda2010AItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.ObrazacID1Potvrda2010AItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.ObrazacID1Potvrda2010A> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.ObrazacID1Potvrda2010A> rezultat;
