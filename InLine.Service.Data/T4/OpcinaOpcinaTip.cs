...
namespace InLine.Service.Data
{
    ...
    public partial class OpcinaOpcinaTip : IOpcinaOpcinaTip
    {
    	#region Fields
    
    	Repository.Data.IOpcinaOpcinaTip _repository;
        ...
        public OpcinaOpcinaTip(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.OpcinaOpcinaTip(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public OpcinaOpcinaTip(Repository.Data.IOpcinaOpcinaTip repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.OpcinaOpcinaTip> SelectResult(long? ID_OpcinaOpcinaTip)
        { 
            IEnumerable<Model.Data.OpcinaOpcinaTip> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_OpcinaOpcinaTip);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.OpcinaOpcinaTipItem item)
    	{
    	...
    	public Model.Data.OpcinaOpcinaTip InsertResult(Model.Data.Item.OpcinaOpcinaTipItem item)
        { 
             Model.Data.OpcinaOpcinaTip rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.OpcinaOpcinaTipItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.OpcinaOpcinaTip UpdateResult(Model.Data.Item.OpcinaOpcinaTipItem item)
        { 
             Model.Data.OpcinaOpcinaTip rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.OpcinaOpcinaTipItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.OpcinaOpcinaTipItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.OpcinaOpcinaTip> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.OpcinaOpcinaTip> rezultat;
