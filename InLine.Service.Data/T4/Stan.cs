...
namespace InLine.Service.Data
{
    ...
    public partial class Stan : IStan
    {
    	#region Fields
    
    	Repository.Data.IStan _repository;
        ...
        public Stan(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.Stan(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public Stan(Repository.Data.IStan repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.Stan> SelectResult(long? ID_Stan)
        { 
            IEnumerable<Model.Data.Stan> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_Stan);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.StanItem item)
    	{
    	...
    	public Model.Data.Stan InsertResult(Model.Data.Item.StanItem item)
        { 
             Model.Data.Stan rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.StanItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.Stan UpdateResult(Model.Data.Item.StanItem item)
        { 
             Model.Data.Stan rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.StanItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.StanItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.Stan> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.Stan> rezultat;
