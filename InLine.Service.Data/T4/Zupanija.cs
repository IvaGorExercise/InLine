...
namespace InLine.Service.Data
{
    ...
    public partial class Zupanija : IZupanija
    {
    	#region Fields
    
    	Repository.Data.IZupanija _repository;
        ...
        public Zupanija(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.Zupanija(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public Zupanija(Repository.Data.IZupanija repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.Zupanija> SelectResult(long? ID_Zupanija)
        { 
            IEnumerable<Model.Data.Zupanija> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_Zupanija);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.ZupanijaItem item)
    	{
    	...
    	public Model.Data.Zupanija InsertResult(Model.Data.Item.ZupanijaItem item)
        { 
             Model.Data.Zupanija rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.ZupanijaItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.Zupanija UpdateResult(Model.Data.Item.ZupanijaItem item)
        { 
             Model.Data.Zupanija rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.ZupanijaItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.ZupanijaItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.Zupanija> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.Zupanija> rezultat;
