...
namespace InLine.Service.Data
{
    ...
    public partial class KnjigaOS : IKnjigaOS
    {
    	#region Fields
    
    	Repository.Data.IKnjigaOS _repository;
        ...
        public KnjigaOS(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.KnjigaOS(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public KnjigaOS(Repository.Data.IKnjigaOS repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.KnjigaOS> SelectResult(long? ID_KnjigaOS)
        { 
            IEnumerable<Model.Data.KnjigaOS> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_KnjigaOS);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.KnjigaOSItem item)
    	{
    	...
    	public Model.Data.KnjigaOS InsertResult(Model.Data.Item.KnjigaOSItem item)
        { 
             Model.Data.KnjigaOS rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.KnjigaOSItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.KnjigaOS UpdateResult(Model.Data.Item.KnjigaOSItem item)
        { 
             Model.Data.KnjigaOS rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.KnjigaOSItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.KnjigaOSItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.KnjigaOS> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.KnjigaOS> rezultat;
