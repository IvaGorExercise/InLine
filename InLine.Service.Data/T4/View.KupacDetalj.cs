...
namespace InLine.Service.Data.View
{
    ...
    public partial class KupacDetalj : View.IKupacDetalj
    {
    	#region Fields
    
    	Repository.Data.View.IKupacDetalj _repository;
        ...
        public KupacDetalj(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.View.KupacDetalj(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public KupacDetalj(Repository.Data.View.IKupacDetalj repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
        ...
        {
            Model.Data.View.KupacDetalj rezultat;
        ...
        //public IEnumerable<Model.Data.View.KupacDetalj> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.View.KupacDetalj> rezultat;
