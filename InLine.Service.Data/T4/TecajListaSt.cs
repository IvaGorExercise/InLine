...
namespace InLine.Service.Data
{
    ...
    public partial class TecajListaSt : ITecajListaSt
    {
    	#region Fields
    
    	Repository.Data.ITecajListaSt _repository;
        ...
        public TecajListaSt(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.TecajListaSt(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public TecajListaSt(Repository.Data.ITecajListaSt repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.TecajListaSt> SelectResult(long? ID_TecajListaSt)
        { 
            IEnumerable<Model.Data.TecajListaSt> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_TecajListaSt);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.TecajListaStItem item)
    	{
    	...
    	public Model.Data.TecajListaSt InsertResult(Model.Data.Item.TecajListaStItem item)
        { 
             Model.Data.TecajListaSt rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.TecajListaStItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.TecajListaSt UpdateResult(Model.Data.Item.TecajListaStItem item)
        { 
             Model.Data.TecajListaSt rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.TecajListaStItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.TecajListaStItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.TecajListaSt> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.TecajListaSt> rezultat;
