...
namespace InLine.Service.Data
{
    ...
    public partial class ZbrojniNalogHUB : IZbrojniNalogHUB
    {
    	#region Fields
    
    	Repository.Data.IZbrojniNalogHUB _repository;
        ...
        public ZbrojniNalogHUB(Repository.Data.IZbrojniNalogHUB repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.ZbrojniNalogHUB> SelectResult(long? ID_ZbrojniNalogHUB)
        { 
            IEnumerable<Model.Data.ZbrojniNalogHUB> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_ZbrojniNalogHUB);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.ZbrojniNalogHUBItem item)
    	{
    	...
    	public Model.Data.ZbrojniNalogHUB InsertResult(Model.Data.Item.ZbrojniNalogHUBItem item)
        { 
             Model.Data.ZbrojniNalogHUB rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.ZbrojniNalogHUBItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.ZbrojniNalogHUB UpdateResult(Model.Data.Item.ZbrojniNalogHUBItem item)
        { 
             Model.Data.ZbrojniNalogHUB rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.ZbrojniNalogHUBItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.ZbrojniNalogHUBItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.ZbrojniNalogHUB> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.ZbrojniNalogHUB> rezultat;
