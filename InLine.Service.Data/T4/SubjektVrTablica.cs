...
namespace InLine.Service.Data
{
    ...
    public partial class SubjektVrTablica : ISubjektVrTablica
    {
    	#region Fields
    
    	Repository.Data.ISubjektVrTablica _repository;
        ...
        public SubjektVrTablica(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.SubjektVrTablica(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public SubjektVrTablica(Repository.Data.ISubjektVrTablica repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.SubjektVrTablica> SelectResult(int? IDSubjektVr)
        { 
            IEnumerable<Model.Data.SubjektVrTablica> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(IDSubjektVr);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.SubjektVrTablicaItem item)
    	{
    	...
    	public Model.Data.SubjektVrTablica InsertResult(Model.Data.Item.SubjektVrTablicaItem item)
        { 
             Model.Data.SubjektVrTablica rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.SubjektVrTablicaItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.SubjektVrTablica UpdateResult(Model.Data.Item.SubjektVrTablicaItem item)
        { 
             Model.Data.SubjektVrTablica rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.SubjektVrTablicaItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.SubjektVrTablicaItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.SubjektVrTablica> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.SubjektVrTablica> rezultat;
