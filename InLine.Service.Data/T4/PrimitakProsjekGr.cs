...
namespace InLine.Service.Data
{
    ...
    public partial class PrimitakProsjekGr : IPrimitakProsjekGr
    {
    	#region Fields
    
    	Repository.Data.IPrimitakProsjekGr _repository;
        ...
        public PrimitakProsjekGr(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.PrimitakProsjekGr(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public PrimitakProsjekGr(Repository.Data.IPrimitakProsjekGr repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.PrimitakProsjekGr> SelectResult(long? ID_PrimitakProsjekGr)
        { 
            IEnumerable<Model.Data.PrimitakProsjekGr> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_PrimitakProsjekGr);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.PrimitakProsjekGrItem item)
    	{
    	...
    	public Model.Data.PrimitakProsjekGr InsertResult(Model.Data.Item.PrimitakProsjekGrItem item)
        { 
             Model.Data.PrimitakProsjekGr rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.PrimitakProsjekGrItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.PrimitakProsjekGr UpdateResult(Model.Data.Item.PrimitakProsjekGrItem item)
        { 
             Model.Data.PrimitakProsjekGr rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.PrimitakProsjekGrItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.PrimitakProsjekGrItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.PrimitakProsjekGr> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.PrimitakProsjekGr> rezultat;
