...
namespace InLine.Service.Data
{
    ...
    public partial class UgovorStanOtkupObrok : IUgovorStanOtkupObrok
    {
    	#region Fields
    
    	Repository.Data.IUgovorStanOtkupObrok _repository;
        ...
        public UgovorStanOtkupObrok(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.UgovorStanOtkupObrok(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public UgovorStanOtkupObrok(Repository.Data.IUgovorStanOtkupObrok repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.UgovorStanOtkupObrok> SelectResult(long? ID_UgovorStanOtkupObrok)
        { 
            IEnumerable<Model.Data.UgovorStanOtkupObrok> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_UgovorStanOtkupObrok);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.UgovorStanOtkupObrokItem item)
    	{
    	...
    	public Model.Data.UgovorStanOtkupObrok InsertResult(Model.Data.Item.UgovorStanOtkupObrokItem item)
        { 
             Model.Data.UgovorStanOtkupObrok rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.UgovorStanOtkupObrokItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.UgovorStanOtkupObrok UpdateResult(Model.Data.Item.UgovorStanOtkupObrokItem item)
        { 
             Model.Data.UgovorStanOtkupObrok rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.UgovorStanOtkupObrokItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.UgovorStanOtkupObrokItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.UgovorStanOtkupObrok> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.UgovorStanOtkupObrok> rezultat;
