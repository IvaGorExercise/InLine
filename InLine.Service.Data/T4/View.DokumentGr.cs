...
namespace InLine.Service.Data.View
{
    ...
    public partial class DokumentGr : View.IDokumentGr
    {
    	#region Fields
    
    	Repository.Data.View.IDokumentGr _repository;
        ...
        public DokumentGr(Repository.Data.View.IDokumentGr repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
        ...
        {
            Model.Data.View.DokumentGr rezultat;
        ...
        //public IEnumerable<Model.Data.View.DokumentGr> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.View.DokumentGr> rezultat;
