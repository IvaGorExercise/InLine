...
namespace InLine.Service.Data
{
    ...
    public partial class MjestoGrTip : IMjestoGrTip
    {
    	#region Fields
    
    	Repository.Data.IMjestoGrTip _repository;
        ...
        public MjestoGrTip(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.MjestoGrTip(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public MjestoGrTip(Repository.Data.IMjestoGrTip repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.MjestoGrTip> SelectResult(long? ID_MjestoGrTip)
        { 
            IEnumerable<Model.Data.MjestoGrTip> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_MjestoGrTip);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.MjestoGrTipItem item)
    	{
    	...
    	public Model.Data.MjestoGrTip InsertResult(Model.Data.Item.MjestoGrTipItem item)
        { 
             Model.Data.MjestoGrTip rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.MjestoGrTipItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.MjestoGrTip UpdateResult(Model.Data.Item.MjestoGrTipItem item)
        { 
             Model.Data.MjestoGrTip rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.MjestoGrTipItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.MjestoGrTipItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.MjestoGrTip> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.MjestoGrTip> rezultat;
