...
namespace InLine.Service.Data
{
    ...
    public partial class ZupanijaGrZupanija : IZupanijaGrZupanija
    {
    	#region Fields
    
    	Repository.Data.IZupanijaGrZupanija _repository;
        ...
        public ZupanijaGrZupanija(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.ZupanijaGrZupanija(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public ZupanijaGrZupanija(Repository.Data.IZupanijaGrZupanija repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.ZupanijaGrZupanija> SelectResult(long? ID_ZupanijaGrZupanija)
        { 
            IEnumerable<Model.Data.ZupanijaGrZupanija> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_ZupanijaGrZupanija);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.ZupanijaGrZupanijaItem item)
    	{
    	...
    	public Model.Data.ZupanijaGrZupanija InsertResult(Model.Data.Item.ZupanijaGrZupanijaItem item)
        { 
             Model.Data.ZupanijaGrZupanija rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.ZupanijaGrZupanijaItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.ZupanijaGrZupanija UpdateResult(Model.Data.Item.ZupanijaGrZupanijaItem item)
        { 
             Model.Data.ZupanijaGrZupanija rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.ZupanijaGrZupanijaItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.ZupanijaGrZupanijaItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.ZupanijaGrZupanija> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.ZupanijaGrZupanija> rezultat;
