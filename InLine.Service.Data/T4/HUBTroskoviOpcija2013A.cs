...
namespace InLine.Service.Data
{
    ...
    public partial class HUBTroskoviOpcija2013A : IHUBTroskoviOpcija2013A
    {
    	#region Fields
    
    	Repository.Data.IHUBTroskoviOpcija2013A _repository;
        ...
        public HUBTroskoviOpcija2013A(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.HUBTroskoviOpcija2013A(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public HUBTroskoviOpcija2013A(Repository.Data.IHUBTroskoviOpcija2013A repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.HUBTroskoviOpcija2013A> SelectResult(int? IDHUBTroskoviOpcija2013A)
        { 
            IEnumerable<Model.Data.HUBTroskoviOpcija2013A> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(IDHUBTroskoviOpcija2013A);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.HUBTroskoviOpcija2013AItem item)
    	{
    	...
    	public Model.Data.HUBTroskoviOpcija2013A InsertResult(Model.Data.Item.HUBTroskoviOpcija2013AItem item)
        { 
             Model.Data.HUBTroskoviOpcija2013A rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.HUBTroskoviOpcija2013AItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.HUBTroskoviOpcija2013A UpdateResult(Model.Data.Item.HUBTroskoviOpcija2013AItem item)
        { 
             Model.Data.HUBTroskoviOpcija2013A rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.HUBTroskoviOpcija2013AItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.HUBTroskoviOpcija2013AItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.HUBTroskoviOpcija2013A> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.HUBTroskoviOpcija2013A> rezultat;
