...
namespace InLine.Service.Data
{
    ...
    public partial class ObrazacID2011A : IObrazacID2011A
    {
    	#region Fields
    
    	Repository.Data.IObrazacID2011A _repository;
        ...
        public ObrazacID2011A(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.ObrazacID2011A(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public ObrazacID2011A(Repository.Data.IObrazacID2011A repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.ObrazacID2011A> SelectResult(long? ID_ObrazacID2011A)
        { 
            IEnumerable<Model.Data.ObrazacID2011A> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_ObrazacID2011A);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.ObrazacID2011AItem item)
    	{
    	...
    	public Model.Data.ObrazacID2011A InsertResult(Model.Data.Item.ObrazacID2011AItem item)
        { 
             Model.Data.ObrazacID2011A rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.ObrazacID2011AItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.ObrazacID2011A UpdateResult(Model.Data.Item.ObrazacID2011AItem item)
        { 
             Model.Data.ObrazacID2011A rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.ObrazacID2011AItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.ObrazacID2011AItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.ObrazacID2011A> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.ObrazacID2011A> rezultat;
