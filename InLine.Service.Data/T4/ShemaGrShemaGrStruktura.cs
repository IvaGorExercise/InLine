...
namespace InLine.Service.Data
{
    ...
    public partial class ShemaGrShemaGrStruktura : IShemaGrShemaGrStruktura
    {
    	#region Fields
    
    	Repository.Data.IShemaGrShemaGrStruktura _repository;
        ...
        public ShemaGrShemaGrStruktura(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.ShemaGrShemaGrStruktura(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public ShemaGrShemaGrStruktura(Repository.Data.IShemaGrShemaGrStruktura repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.ShemaGrShemaGrStruktura> SelectResult(long? ID_ShemaGrShemaGrStruktura)
        { 
            IEnumerable<Model.Data.ShemaGrShemaGrStruktura> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_ShemaGrShemaGrStruktura);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.ShemaGrShemaGrStrukturaItem item)
    	{
    	...
    	public Model.Data.ShemaGrShemaGrStruktura InsertResult(Model.Data.Item.ShemaGrShemaGrStrukturaItem item)
        { 
             Model.Data.ShemaGrShemaGrStruktura rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.ShemaGrShemaGrStrukturaItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.ShemaGrShemaGrStruktura UpdateResult(Model.Data.Item.ShemaGrShemaGrStrukturaItem item)
        { 
             Model.Data.ShemaGrShemaGrStruktura rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.ShemaGrShemaGrStrukturaItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.ShemaGrShemaGrStrukturaItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.ShemaGrShemaGrStruktura> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.ShemaGrShemaGrStruktura> rezultat;
