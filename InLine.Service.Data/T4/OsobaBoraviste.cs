...
namespace InLine.Service.Data
{
    ...
    public partial class OsobaBoraviste : IOsobaBoraviste
    {
    	#region Fields
    
    	Repository.Data.IOsobaBoraviste _repository;
        ...
        public OsobaBoraviste(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.OsobaBoraviste(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public OsobaBoraviste(Repository.Data.IOsobaBoraviste repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.OsobaBoraviste> SelectResult(long? ID_OsobaBoraviste)
        { 
            IEnumerable<Model.Data.OsobaBoraviste> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_OsobaBoraviste);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.OsobaBoravisteItem item)
    	{
    	...
    	public Model.Data.OsobaBoraviste InsertResult(Model.Data.Item.OsobaBoravisteItem item)
        { 
             Model.Data.OsobaBoraviste rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.OsobaBoravisteItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.OsobaBoraviste UpdateResult(Model.Data.Item.OsobaBoravisteItem item)
        { 
             Model.Data.OsobaBoraviste rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.OsobaBoravisteItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.OsobaBoravisteItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.OsobaBoraviste> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.OsobaBoraviste> rezultat;
