...
namespace InLine.Service.Data
{
    ...
    public partial class PoslovnaGodina : IPoslovnaGodina
    {
    	#region Fields
    
    	Repository.Data.IPoslovnaGodina _repository;
        ...
        public PoslovnaGodina(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.PoslovnaGodina(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public PoslovnaGodina(Repository.Data.IPoslovnaGodina repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.PoslovnaGodina> SelectResult(long? ID_PoslovnaGodina)
        { 
            IEnumerable<Model.Data.PoslovnaGodina> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_PoslovnaGodina);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.PoslovnaGodinaItem item)
    	{
    	...
    	public Model.Data.PoslovnaGodina InsertResult(Model.Data.Item.PoslovnaGodinaItem item)
        { 
             Model.Data.PoslovnaGodina rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.PoslovnaGodinaItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.PoslovnaGodina UpdateResult(Model.Data.Item.PoslovnaGodinaItem item)
        { 
             Model.Data.PoslovnaGodina rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.PoslovnaGodinaItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.PoslovnaGodinaItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.PoslovnaGodina> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.PoslovnaGodina> rezultat;
