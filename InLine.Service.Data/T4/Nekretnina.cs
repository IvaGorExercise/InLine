...
namespace InLine.Service.Data
{
    ...
    public partial class Nekretnina : INekretnina
    {
    	#region Fields
    
    	Repository.Data.INekretnina _repository;
        ...
        public Nekretnina(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.Nekretnina(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public Nekretnina(Repository.Data.INekretnina repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.Nekretnina> SelectResult(long? ID_Nekretnina)
        { 
            IEnumerable<Model.Data.Nekretnina> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_Nekretnina);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.NekretninaItem item)
    	{
    	...
    	public Model.Data.Nekretnina InsertResult(Model.Data.Item.NekretninaItem item)
        { 
             Model.Data.Nekretnina rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.NekretninaItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.Nekretnina UpdateResult(Model.Data.Item.NekretninaItem item)
        { 
             Model.Data.Nekretnina rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.NekretninaItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.NekretninaItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.Nekretnina> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.Nekretnina> rezultat;
