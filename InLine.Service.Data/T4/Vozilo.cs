...
namespace InLine.Service.Data
{
    ...
    public partial class Vozilo : IVozilo
    {
    	#region Fields
    
    	Repository.Data.IVozilo _repository;
        ...
        public Vozilo(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.Vozilo(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public Vozilo(Repository.Data.IVozilo repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.Vozilo> SelectResult(long? ID_Vozilo)
        { 
            IEnumerable<Model.Data.Vozilo> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_Vozilo);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.VoziloItem item)
    	{
    	...
    	public Model.Data.Vozilo InsertResult(Model.Data.Item.VoziloItem item)
        { 
             Model.Data.Vozilo rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.VoziloItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.Vozilo UpdateResult(Model.Data.Item.VoziloItem item)
        { 
             Model.Data.Vozilo rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.VoziloItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.VoziloItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.Vozilo> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.Vozilo> rezultat;
