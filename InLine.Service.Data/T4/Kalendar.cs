...
namespace InLine.Service.Data
{
    ...
    public partial class Kalendar : IKalendar
    {
    	#region Fields
    
    	Repository.Data.IKalendar _repository;
        ...
        public Kalendar(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.Kalendar(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public Kalendar(Repository.Data.IKalendar repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.Kalendar> SelectResult(int? IDDatum)
        { 
            IEnumerable<Model.Data.Kalendar> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(IDDatum);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.KalendarItem item)
    	{
    	...
    	public Model.Data.Kalendar InsertResult(Model.Data.Item.KalendarItem item)
        { 
             Model.Data.Kalendar rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.KalendarItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.Kalendar UpdateResult(Model.Data.Item.KalendarItem item)
        { 
             Model.Data.Kalendar rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.KalendarItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.KalendarItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.Kalendar> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.Kalendar> rezultat;
