...
namespace InLine.Service.Data
{
    ...
    public partial class ZbrojniNalog2013A : IZbrojniNalog2013A
    {
    	#region Fields
    
    	Repository.Data.IZbrojniNalog2013A _repository;
        ...
        public ZbrojniNalog2013A(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.ZbrojniNalog2013A(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public ZbrojniNalog2013A(Repository.Data.IZbrojniNalog2013A repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.ZbrojniNalog2013A> SelectResult(long? ID_ZbrojniNalog2013A)
        { 
            IEnumerable<Model.Data.ZbrojniNalog2013A> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_ZbrojniNalog2013A);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.ZbrojniNalog2013AItem item)
    	{
    	...
    	public Model.Data.ZbrojniNalog2013A InsertResult(Model.Data.Item.ZbrojniNalog2013AItem item)
        { 
             Model.Data.ZbrojniNalog2013A rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.ZbrojniNalog2013AItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.ZbrojniNalog2013A UpdateResult(Model.Data.Item.ZbrojniNalog2013AItem item)
        { 
             Model.Data.ZbrojniNalog2013A rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.ZbrojniNalog2013AItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.ZbrojniNalog2013AItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.ZbrojniNalog2013A> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.ZbrojniNalog2013A> rezultat;
