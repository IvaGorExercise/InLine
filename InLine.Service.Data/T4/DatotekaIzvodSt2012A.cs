...
namespace InLine.Service.Data
{
    ...
    public partial class DatotekaIzvodSt2012A : IDatotekaIzvodSt2012A
    {
    	#region Fields
    
    	Repository.Data.IDatotekaIzvodSt2012A _repository;
        ...
        public DatotekaIzvodSt2012A(Model.Admin.KorisnikData korisnik_data)
            : this(new Repository.Data.DatotekaIzvodSt2012A(korisnik_data.ConnString), new Repository.Admin.DozvoleZabranePoruke())
        { 
    	   _korisnik_data = korisnik_data;
    	}
    
        public DatotekaIzvodSt2012A(Repository.Data.IDatotekaIzvodSt2012A repository, Repository.Admin.IDozvoleZabranePoruke admin)
        {
    	...
    	public IEnumerable<Model.Data.DatotekaIzvodSt2012A> SelectResult(long? ID_DatotekaIzvodSt2012A)
        { 
            IEnumerable<Model.Data.DatotekaIzvodSt2012A> rezultat;
    
            try
            {
                rezultat = _repository.SelectResult(ID_DatotekaIzvodSt2012A);
            }
    	...
    	public IList<Model.Admin.StatusPoruka> Insert(Model.Data.Item.DatotekaIzvodSt2012AItem item)
    	{
    	...
    	public Model.Data.DatotekaIzvodSt2012A InsertResult(Model.Data.Item.DatotekaIzvodSt2012AItem item)
        { 
             Model.Data.DatotekaIzvodSt2012A rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Update(Model.Data.Item.DatotekaIzvodSt2012AItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public Model.Data.DatotekaIzvodSt2012A UpdateResult(Model.Data.Item.DatotekaIzvodSt2012AItem item)
        { 
             Model.Data.DatotekaIzvodSt2012A rezultat;
    	...
    	public IList<Model.Admin.StatusPoruka> Delete(Model.Data.Item.DatotekaIzvodSt2012AItem item)
    	{
    		IList<Model.Admin.StatusPoruka> poruke = new List<Model.Admin.StatusPoruka>();
    	...
    	public int DeleteResult(Model.Data.Item.DatotekaIzvodSt2012AItem item)
        { 
            int rezultat = 0;
        ...
        //public IEnumerable<Model.Data.DatotekaIzvodSt2012A> GetGridData(string filter, string sort, long? start, long? count, bool customserach = false)
        //{
          //  IEnumerable<Model.Data.DatotekaIzvodSt2012A> rezultat;
